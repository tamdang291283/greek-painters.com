...
<text>-----------&#10;</text>
<text align="left" />
<%if vvouchercode & "" <>"" then%><text>Discount code:&#9;&#9;&#9;-<%=CURRENCYSYMBOL%><%= FormatNumber((( objRds("SubTotal") * 100 )/(100- Cdbl(Replace(Replace(Replace(vvouchercodediscount,"-",""),"%","")," ",""))) - objRds("SubTotal") ),2) %>  &#10;</text>				
