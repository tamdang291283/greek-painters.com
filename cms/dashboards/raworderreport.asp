...
orders=0
				...
				<thead>
					...
					<th>
                        ...
                        <th><div align="center">Printed</div></th>
            ...
            <%
                ...
                Set objRds2 = Server.CreateObject("ADODB.Recordset") 
                        ...
                        %>
                       <tr>
					   <td> <% If objRds("OrderDate") & "" <> "" Then  Response.Write(formatDateTimeC(objRds("OrderDate")))  else  Response.Write(formatDateTimeC(objRds("CreationDate"))) End If %></td>
						<td>
...
<%=objRds("id")%>
                    ...
                    "where oi.OrderId = " & objRds("ID"), objCon
						...
						<div align="center"><%=Replace(objRds("paymenttype") & "","-Paid","") %></div>
                           ...
                           <td>
                               <% If Instr(LCase(objRds("paymenttype")),"paid") > 0 or objRds("Payment_Status") = "Paid" Then %>
						<div align="center"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div>
						        <% end If %>
						</td>
						<td align="center">                          
                            <% if trim( Lcase(objRds("printed"))) & ""  =  "1" then %>
                            <div align="center"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div>
                             <%end if %>
                        </td>
