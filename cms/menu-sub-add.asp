...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO MenuItemProperties (name,Price,IdMenuItem,allowtoppings) VALUES (?,?, ?, ?)" 
...
MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param8", 202, 1, -1, Request.Form("allowtoppings")) ' adVarWChar
