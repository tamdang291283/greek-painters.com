...
<% 
     ...
     If Session("MM_id") & "" <> "" AND Request.QueryString("printer") & "" <> "" Then
          ...
          objCon2.Execute " Update [Orders] set [printed] = 1 where [printed] = 0 and  (paymenttype='Stripe-Paid' or paymenttype='Paypal-Paid' or paymenttype='NoChex-Paid' or paymenttype='Worldpay-Paid'  or paymenttype='Cash on Delivery' or payment_status  = 'Paid' ) AND [IdBusinessDetail] = " & rID
          objCon2.Close()
          set objCon2 = nothing
          Response.Write("OK")
     Else 
