...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO vouchercodes (vouchercode, vouchercodediscount, vouchertype, startdate,enddate,IdBusinessDetail,minimumamount,MenuItemID,VoucherMainType,ApplyTo,ListID) VALUES (?,?,?,convert(varchar(10), ?, 105) ,convert(varchar(10), ?, 105),?,?,?,?,?,?)" 
...
<div class="row clearfix">
 ...
 <li>Edit Voucher</li>
  ...
  <div class="form-group">
    ...
    <input type="radio" name="VoucherMainType" value="Dishes" onclick="selectMainType();"> Dishes 
    <input type="radio" name="VoucherMainType" value="Categories" onclick="selectMainType();"> Categories   
  </div>
   ...
   <div class="form-group" style="margin-left:30px;" id="divpercentage">
    ...
    %>
 <div class="form-group" style="margin-left:30px;display:none;" id="divApplyto">
    <label for="vouchertype">Apply to</label><br/>
	<input type="radio" name="ApplyTo" value="Online"> Online&nbsp;&nbsp;
    <input type="radio" name="ApplyTo" value="Local"> Local&nbsp;&nbsp;
    <input type="radio" name="ApplyTo" value="Both" checked="checked"> Both 
