...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE MenuDishproperties SET [dishproperty] = ?, [dishpropertyprice]=?,[printingname]=?,s_ContainAllergen=?,s_MayContainAllergen=?,s_SuitableFor=? WHERE ID = ?" 
   ...
   MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param6", 202, 1, -1, MM_IIF(Request.Form("s_ContainAllergen"),Request.Form("s_ContainAllergen"),"") ) ' adVarWChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param7", 202, 1, -1, MM_IIF(Request.Form("s_MayContainAllergen"),Request.Form("s_MayContainAllergen"),"")) ' adVarWChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param8", 202, 1, -1, MM_IIF(Request.Form("s_SuitableFor"),Request.Form("s_SuitableFor"),"")) ' adVarWChar
...
sql = "SELECT ID,dishproperty,dishpropertyprice,IdBusinessDetail,dishpropertygroupid,printingname,i_displaySort,s_ContainAllergen,s_MayContainAllergen,s_SuitableFor "
sql = sql & " FROM MenuDishproperties with(nolock) where id=" & request.querystring("id")
