...
<div class="row clearfix">
  ...
  <li><a href="dishproperties.asp">Dish Properties</a></li>
		...
		<a href="dishproperties-add.asp"  class="btn btn-primary pull-right">ADD</a><h1>Dish Property Groups</h1>
		<p>To create a new group click "add" or select below to edit a current group.</p>
			<table class="table table-hover table-condensed table-striped">
				...
				<%  
				  ...
				  objCon.Open sConnStringcms
                    Set objRds = Server.CreateObject("ADODB.Recordset") 
                        objRds.Open "SELECT * FROM MenuDishpropertiesGroups where  IdBusinessDetail=" & Session("MM_id") & " order by i_displaysort,id" , objCon

                        Do While NOT objRds.Eof
                        %>
                       <tr id="<%=objRds("id") %>">
						<td><span class="glyphicon glyphicon-move" aria-hidden="true" style="float:left;margin-right:10px;"></span>
							 <p><%= objRds("dishpropertygroup") %></p>
			...
			<a class="btn btn-success btn"  href="dishproperties-items.asp?catid=<%=objRds("id")%>">
VIEW
</a>

			<a class="btn btn-primary btn"  href="dishproperties-edit.asp?id=<%=objRds("id")%>">
EDIT
</a>

<a href="dishproperties-del.asp?id=<%=objRds("id")%>" class="btn btn-danger confirm">DELETE</a>
