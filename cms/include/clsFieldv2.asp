...
' ------------------------------------------------------------------------------
    Public Sub SaveAs(ByRef pstrFileName)
        ...
        lobjStream.Type = 1 ' adTypeBinary
        ...
        Call lobjStream.SaveToFile(pstrFileName, 2) 'adSaveCreateOverWrite 2
...
' ------------------------------------------------------------------------------
    Private Function ASCII2Bytes(ByRef pbinBinaryData)
        ...
        Call lobjRs.Fields.Append("BinaryData", 205, llngLength) 'adLongVarBinary
