...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE MenuDishproperties SET [dishproperty] = ?, [dishpropertyprice]=? WHERE ID = ?" 
...
<li><a href="dishproperties.asp">Dish Properties</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="dishpropertyprice" name="dishpropertyprice" value="<%=(Recordset1.Fields.Item("dishpropertyprice").Value)%>" required>
  </div>
