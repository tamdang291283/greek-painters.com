...
MM_editCmd.CommandText = "UPDATE menuitems SET [code] = ?,[name] = ?,[description] = ?,[Vegetarian] = ?,[Spicyness] = ?,[price] = ?,[allowtoppings] = ?,[dishpropertygroupid]=?,[hidedish]=?,[printingname]=? WHERE ID = ?" 
...
<li><a href="menu.asp">Main Menu</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="Code" name="Code" value="<%= Recordset1.Fields.Item("code").Value %>">
  </div>
   <div class="form-group">
 ...
 <div class="form-group">
  ...
  <option value="0" <%if Recordset1.Fields.Item("Spicyness").Value=0 then%>SELECTED<%end if%>>not spicy</option>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="Price" name="Price" value="<%= Recordset1.Fields.Item("Price").Value %>" required title="Please note if you are setting options that determine the price please set this to zero">
  </div>
   <div class="form-group">
