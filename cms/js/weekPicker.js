...
var setWeekCalendar = function (settingElement) {
    ...
    $(settingElement).datepicker({
        ...
        onSelect: function (dateText, inst) {
            ...
            $('#fullday').val($.datepicker.formatDate(dateFormat, startDate, inst.settings));
            //var newDate = new Date(startDate);
            //newDate.setDate(newDate.getDate());
            //$('#fullday').val(newDate.toLocaleDateString());
            //newDate = new Date(endDate);
            //newDate.setDate(newDate.getDate() + 1);
            //$('.endDate').val(newDate.toLocaleDateString());
            //console.log(ywString);
            $(".clweek").val(weekNum);
            $(".clyear").val(weekYear);
            $(".lbyear").html(weekYear);
            $(".lbweek").html(weekNum);
        ...
        beforeShow: function () {
            $(this).datepicker("setDate", new Date($('#fullday').val()));
            selectCurrentWeek();
        },
    ...
    $('body').on('mouseclick', '.ui-weekpicker .ui-datepicker-calendar tr td a.ui-state-active', function () { $(this).find('td a').removeClass('ui-state-hover'); });
