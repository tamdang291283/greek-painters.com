...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO MenuDishproperties (dishproperty, dishpropertyprice, IdBusinessDetail,dishpropertygroupid) VALUES (?,?,?,?)" 
...
<li><a href="dishproperties.asp">Dish Properties</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="dishpropertyprice" name="dishpropertyprice" value="" required>
  </div>
