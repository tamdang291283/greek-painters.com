		...
		<div class="col-md-12 column">
			<div class="row clearfix">
				  ...
				  objCon.Open sConnStringcms
                       objRds.Open "SELECT * FROM ORDERS where (paymenttype='Paypal-Paid' or paymenttype='NoChex-Paid' or paymenttype='Worldpay-Paid' or paymenttype='Cash on Delivery') and IdBusinessDetail=" & Session("MM_id") & " and not(cancelled=-1 or outfordelivery=-1)  ORDER BY DeliveryTime  desc" , objCon
total=0
ordercnt=0
ordercancelled=0
pending=0
...
objRds.LockType = 1
                        objRds.Open "SELECT * FROM ORDERS where (paymenttype='Paypal-Paid' or paymenttype='NoChex-Paid' or paymenttype='Worldpay-Paid' or paymenttype='Cash on Delivery') and IdBusinessDetail=" & Session("MM_id") & " and (cancelled=-1 or outfordelivery=-1)  ORDER BY DeliveryTime  desc" , objCon
