...
sql="SELECT * FROM ORDERS where (paymenttype='Paypal-Paid' or paymenttype='NoChex-Paid' or paymenttype='Worldpay-Paid' or paymenttype='Cash on Delivery' or cancelled=-1) and IdBusinessDetail=" & Session("MM_id") 
...
startdate_sql=  startdate_year & "/" & startdate_month & "/" & startdate_day  
...
'enddate_sql=  enddate_month & "/" & enddate_day & "/" & enddate_year
 enddate_sql=  enddate_year & "/" & enddate_month & "/" & enddate_day 
'enddate_sql=DateAdd("d",1,enddate_sql) 
sql=sql & " AND  [OrderDate] - 1<=#" & enddate_sql & "#"
