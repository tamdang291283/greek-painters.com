...
xcnt=0
		...
		<a href="javascript:;"  class="magnifying-glass-icon foobox">
			<i class="fa fa-search"></i>
                  ...
                  <%if photo=0 then%>
				  <%if code=0 then%>
                         <div class="product70w desc">
						 <%else%>
						  <div class="product60w desc"><%end if%>
						 <%else%>
						 <%if code=0 and photo=1 then%>
						 <div class="product70w  desc">
						 <%else%>
						    <div class="product60w desc ">
						 <%end if%> <%end if%> 
                                <%= objRds("Name") %>
                    ...
                    <div  class="product40w1  bordertop">
					<%else%>
				 <div  class="product40w1  ">
					<%end if%>
                    ...
                    <div  class="product40w  bordertop">
					<%else%>
				 <div   class="product40w  ">
					<%end if%>
						 <%end if%>
                          <%= objRds("PropertyName")%>&nbsp;
...
dishpropertiestext = dishpropertiestext & "><option value=""0"">-- select --</option>"
        ...
        Loop 
                  ...
                  <%noprice=0%>
                            ...
                            <div align="right" class=""><b><%=CURRENCYSYMBOL%><%= FormatNumber(vMenuItemPrice, 2) %></b></div>
                            <% noprice=1
							End If %>
							
							<%if pricefrom<>0 then%>
								<div align="right" class=""><b>from <%=CURRENCYSYMBOL%><%=pricefrom%></b></div>
								<%noprice=1
								end if%>
                  ...
                  <div  class="product20w  bordertop">
					<%else%>
				        <div class="product20w">
					<%end if%>
        ...
        <fieldset class="gllpLatlonPicker" id="gllpLatlonPicker1">
		 ...
		 <div id="showdistance" align="center" style="clear:both;"></div>					
                    ...
                    <!--             <span id="DeliverySpan">&nbsp;</span> -->
                            ...
                            <div class="alert alert-danger" id="missingPostcodeAlert" style="display:none;"><span style="color:#49cb29;font-weight:bold;">Check</span> delivery is available, then click <span style="color:#49cb29;font-weight:bold;">Place Order</span> to continue</strong>
								<br>
</div>
...
<script>
   var tempBeforeOrderHTML = '';
    ...
    tempBeforeOrderHTML += '<button type="button" onclick="CheckOrder();" class="btn btn-success" style="width: 160px; padding: 8px; margin-left:48px;">Place Order</button>';
    ...
    if(dt1.getHours() < nextOpeningTime.getHours() || (dt1.getHours() == nextOpeningTime.getHours() && dt1.getMinutes() < nextOpeningTime.getMinutes())){
        ...
        if(newTime.getHours() < 12)
            ...
            timeString = (newTime.getHours()-12) + ":" + minStr + " PM";
         $('#rightaffix').before('<div id="" class="hidepanel alert alert-warning" style="text-align: center; padding: 7px; display: block;"><b>Opens at: '+ timeString + '</b></div>');
