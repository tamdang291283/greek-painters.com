...
<head>
  ...
  <meta name="author" content="">
    ...
    <link href="../css/product.css?v=1.9" rel="stylesheet">
	<link href="../css/datepicker.css" rel="stylesheet">
	<link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="../css/addtohomescreen.css">


    <link rel="stylesheet" type="text/css" href="../css/product-menu-demo.css">
...
<script>
 ...
 function resetCountDown(){
    if(pendingReload==1)
        window.location.href = "resetsession.asp?r=<%=session("restaurantid") %>";
			...
			<%if individualpostcodeschecking=0  then%>
                ...
                if(distance >= 0) 
                {
                    ...
                    if(miles > max_miles)
                    {
                        $('.delivery_info').hide();   
                        $("#missingPostcodeAlert").show();
                        $("#missingPostcodeAlert").html('This Store Only Offers <strong>Collection</strong> To Your Postcode');                       
                        $('input[name=distance]', form).val('');
						$('.delivery_info').addClass('alert-danger');
						$('.delivery_info').removeClass('alert-success'); 
                    }
