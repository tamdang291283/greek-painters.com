...
' ASPMaker configuration for Table VIEW_Paid_Orders
Dim VIEW_Paid_Orders

' Define table class
Class cVIEW_Paid_Orders
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "FromIP", FromIP)
		...
		Call ew_SetArObj(Fields, "Card_Debit", Card_Debit)
		Call ew_SetArObj(Fields, "Card_Credit", Card_Credit)
		Call ew_SetArObj(Fields, "SentEmail", SentEmail)
		Call ew_SetArObj(Fields, "deliverydelay", deliverydelay)
		Call ew_SetArObj(Fields, "collectiondelay", collectiondelay)
		Call ew_SetArObj(Fields, "lng_report", lng_report)
		Call ew_SetArObj(Fields, "lat_report", lat_report)
	...
	Public Property Get HighlightName()
		HighlightName = "VIEW_Paid_Orders_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[VIEW_Paid_Orders]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "VIEW_Paid_Orderslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "VIEW_Paid_Orderslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("VIEW_Paid_Ordersview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("VIEW_Paid_Ordersview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "VIEW_Paid_Ordersadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("VIEW_Paid_Ordersedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("VIEW_Paid_Ordersadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("VIEW_Paid_Ordersdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		...
		Card_Debit.DbValue = RsRow("Card_Debit")
		Card_Credit.DbValue = RsRow("Card_Credit")
		SentEmail.DbValue = RsRow("SentEmail")
		deliverydelay.DbValue = RsRow("deliverydelay")
		collectiondelay.DbValue = RsRow("collectiondelay")
		lng_report.DbValue = RsRow("lng_report")
		lat_report.DbValue = RsRow("lat_report")
	...
	Sub RenderListRow()
		...
		' FromIP
		FromIP.ViewValue = FromIP.CurrentValue
		FromIP.ViewCustomAttributes = ""
		...
		' Card_Debit
		Card_Debit.ViewValue = Card_Debit.CurrentValue
		Card_Debit.ViewCustomAttributes = ""

		' Card_Credit
		Card_Credit.ViewValue = Card_Credit.CurrentValue
		Card_Credit.ViewCustomAttributes = ""

		' SentEmail
		SentEmail.ViewValue = SentEmail.CurrentValue
		SentEmail.ViewCustomAttributes = ""

		' deliverydelay
		deliverydelay.ViewValue = deliverydelay.CurrentValue
		deliverydelay.ViewCustomAttributes = ""

		' collectiondelay
		collectiondelay.ViewValue = collectiondelay.CurrentValue
		collectiondelay.ViewCustomAttributes = ""

		' lng_report
		lng_report.ViewValue = lng_report.CurrentValue
		lng_report.ViewCustomAttributes = ""

		' lat_report
		lat_report.ViewValue = lat_report.CurrentValue
		lat_report.ViewCustomAttributes = ""
		...
		' Card_Debit
		Card_Debit.LinkCustomAttributes = ""
		Card_Debit.HrefValue = ""
		Card_Debit.TooltipValue = ""

		' Card_Credit
		Card_Credit.LinkCustomAttributes = ""
		Card_Credit.HrefValue = ""
		Card_Credit.TooltipValue = ""

		' SentEmail
		SentEmail.LinkCustomAttributes = ""
		SentEmail.HrefValue = ""
		SentEmail.TooltipValue = ""

		' deliverydelay
		deliverydelay.LinkCustomAttributes = ""
		deliverydelay.HrefValue = ""
		deliverydelay.TooltipValue = ""

		' collectiondelay
		collectiondelay.LinkCustomAttributes = ""
		collectiondelay.HrefValue = ""
		collectiondelay.TooltipValue = ""

		' lng_report
		lng_report.LinkCustomAttributes = ""
		lng_report.HrefValue = ""
		lng_report.TooltipValue = ""

		' lat_report
		lat_report.LinkCustomAttributes = ""
		lat_report.HrefValue = ""
		lat_report.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' FromIP
		FromIP.EditAttrs.UpdateAttribute "class", "form-control"
		FromIP.EditCustomAttributes = ""
		FromIP.EditValue = FromIP.CurrentValue
		FromIP.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(FromIP.FldCaption))
		...
		' Card_Debit
		Card_Debit.EditAttrs.UpdateAttribute "class", "form-control"
		Card_Debit.EditCustomAttributes = ""
		Card_Debit.EditValue = Card_Debit.CurrentValue
		Card_Debit.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Card_Debit.FldCaption))

		' Card_Credit
		Card_Credit.EditAttrs.UpdateAttribute "class", "form-control"
		Card_Credit.EditCustomAttributes = ""
		Card_Credit.EditValue = Card_Credit.CurrentValue
		Card_Credit.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Card_Credit.FldCaption))

		' SentEmail
		SentEmail.EditAttrs.UpdateAttribute "class", "form-control"
		SentEmail.EditCustomAttributes = ""
		SentEmail.EditValue = SentEmail.CurrentValue
		SentEmail.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(SentEmail.FldCaption))

		' deliverydelay
		deliverydelay.EditAttrs.UpdateAttribute "class", "form-control"
		deliverydelay.EditCustomAttributes = ""
		deliverydelay.EditValue = deliverydelay.CurrentValue
		deliverydelay.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(deliverydelay.FldCaption))

		' collectiondelay
		collectiondelay.EditAttrs.UpdateAttribute "class", "form-control"
		collectiondelay.EditCustomAttributes = ""
		collectiondelay.EditValue = collectiondelay.CurrentValue
		collectiondelay.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(collectiondelay.FldCaption))

		' lng_report
		lng_report.EditAttrs.UpdateAttribute "class", "form-control"
		lng_report.EditCustomAttributes = ""
		lng_report.EditValue = lng_report.CurrentValue
		lng_report.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(lng_report.FldCaption))

		' lat_report
		lat_report.EditAttrs.UpdateAttribute "class", "form-control"
		lat_report.EditCustomAttributes = ""
		lat_report.EditValue = lat_report.CurrentValue
		lat_report.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(lat_report.FldCaption))
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("FromIP", FromIP.ExportValue(Export))
					...
					Call XmlDoc.AddField("Card_Debit", Card_Debit.ExportValue(Export))
					Call XmlDoc.AddField("Card_Credit", Card_Credit.ExportValue(Export))
					Call XmlDoc.AddField("SentEmail", SentEmail.ExportValue(Export))
					Call XmlDoc.AddField("deliverydelay", deliverydelay.ExportValue(Export))
					Call XmlDoc.AddField("collectiondelay", collectiondelay.ExportValue(Export))
					Call XmlDoc.AddField("lng_report", lng_report.ExportValue(Export))
					Call XmlDoc.AddField("lat_report", lat_report.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If FromIP.Exportable Then Call Doc.ExportCaption(FromIP)
					...
					If Card_Debit.Exportable Then Call Doc.ExportCaption(Card_Debit)
					If Card_Credit.Exportable Then Call Doc.ExportCaption(Card_Credit)
					If SentEmail.Exportable Then Call Doc.ExportCaption(SentEmail)
					If deliverydelay.Exportable Then Call Doc.ExportCaption(deliverydelay)
					If collectiondelay.Exportable Then Call Doc.ExportCaption(collectiondelay)
					If lng_report.Exportable Then Call Doc.ExportCaption(lng_report)
					If lat_report.Exportable Then Call Doc.ExportCaption(lat_report)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If FromIP.Exportable Then Call Doc.ExportField(FromIP)
						...
						If Card_Debit.Exportable Then Call Doc.ExportField(Card_Debit)
						If Card_Credit.Exportable Then Call Doc.ExportField(Card_Credit)
						If SentEmail.Exportable Then Call Doc.ExportField(SentEmail)
						If deliverydelay.Exportable Then Call Doc.ExportField(deliverydelay)
						If collectiondelay.Exportable Then Call Doc.ExportField(collectiondelay)
						If lng_report.Exportable Then Call Doc.ExportField(lng_report)
						If lat_report.Exportable Then Call Doc.ExportField(lat_report)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get CreationDate()
		If Not IsObject(m_CreationDate) Then
			Set m_CreationDate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_CreationDate", "CreationDate", "[CreationDate]", "(STR(YEAR([CreationDate]),4,0) + '/' + REPLACE(STR(MONTH([CreationDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([CreationDate]),2,0),' ','0'))", 135, 9, "[CreationDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get OrderDate()
		If Not IsObject(m_OrderDate) Then
			Set m_OrderDate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_OrderDate", "OrderDate", "[OrderDate]", "(STR(YEAR([OrderDate]),4,0) + '/' + REPLACE(STR(MONTH([OrderDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([OrderDate]),2,0),' ','0'))", 135, 9, "[OrderDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryType()
		If Not IsObject(m_DeliveryType) Then
			Set m_DeliveryType = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_DeliveryType", "DeliveryType", "[DeliveryType]", "[DeliveryType]", 202, 0, "[DeliveryType]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryTime()
		If Not IsObject(m_DeliveryTime) Then
			Set m_DeliveryTime = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_DeliveryTime", "DeliveryTime", "[DeliveryTime]", "(STR(YEAR([DeliveryTime]),4,0) + '/' + REPLACE(STR(MONTH([DeliveryTime]),2,0),' ','0') + '/' + REPLACE(STR(DAY([DeliveryTime]),2,0),' ','0'))", 135, 9, "[DeliveryTime]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get PaymentType()
		If Not IsObject(m_PaymentType) Then
			Set m_PaymentType = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_PaymentType", "PaymentType", "[PaymentType]", "[PaymentType]", 202, 0, "[PaymentType]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get SubTotal()
		If Not IsObject(m_SubTotal) Then
			Set m_SubTotal = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_SubTotal", "SubTotal", "[SubTotal]", "CAST([SubTotal] AS NVARCHAR)", 6, 0, "[SubTotal]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get ShippingFee()
		If Not IsObject(m_ShippingFee) Then
			Set m_ShippingFee = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_ShippingFee", "ShippingFee", "[ShippingFee]", "CAST([ShippingFee] AS NVARCHAR)", 6, 0, "[ShippingFee]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get OrderTotal()
		If Not IsObject(m_OrderTotal) Then
			Set m_OrderTotal = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_OrderTotal", "OrderTotal", "[OrderTotal]", "CAST([OrderTotal] AS NVARCHAR)", 6, 0, "[OrderTotal]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get SessionId()
		If Not IsObject(m_SessionId) Then
			Set m_SessionId = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_SessionId", "SessionId", "[SessionId]", "[SessionId]", 202, 0, "[SessionId]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get FirstName()
		If Not IsObject(m_FirstName) Then
			Set m_FirstName = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_FirstName", "FirstName", "[FirstName]", "[FirstName]", 202, 0, "[FirstName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get LastName()
		If Not IsObject(m_LastName) Then
			Set m_LastName = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_LastName", "LastName", "[LastName]", "[LastName]", 202, 0, "[LastName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get zEmail()
		If Not IsObject(m_zEmail) Then
			Set m_zEmail = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_zEmail", "Email", "[Email]", "[Email]", 202, 0, "[Email]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set zEmail = m_zEmail
	End Property
	...
	Public Property Get Phone()
		If Not IsObject(m_Phone) Then
			Set m_Phone = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Phone", "Phone", "[Phone]", "[Phone]", 202, 0, "[Phone]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Phone = m_Phone
	End Property
	...
	Public Property Get Address()
		If Not IsObject(m_Address) Then
			Set m_Address = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Address", "Address", "[Address]", "[Address]", 202, 0, "[Address]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get PostalCode()
		If Not IsObject(m_PostalCode) Then
			Set m_PostalCode = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_PostalCode", "PostalCode", "[PostalCode]", "[PostalCode]", 202, 0, "[PostalCode]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Notes()
		If Not IsObject(m_Notes) Then
			Set m_Notes = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Notes", "Notes", "[Notes]", "[Notes]", 203, 0, "[Notes]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Notes = m_Notes
	End Property
	...
	Public Property Get ttest()
		If Not IsObject(m_ttest) Then
			Set m_ttest = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_ttest", "ttest", "[ttest]", "[ttest]", 202, 0, "[ttest]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set ttest = m_ttest
	End Property
	...
	Public Property Get cancelleddate()
		If Not IsObject(m_cancelleddate) Then
			Set m_cancelleddate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_cancelleddate", "cancelleddate", "[cancelleddate]", "(STR(YEAR([cancelleddate]),4,0) + '/' + REPLACE(STR(MONTH([cancelleddate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([cancelleddate]),2,0),' ','0'))", 135, 9, "[cancelleddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelledby()
		If Not IsObject(m_cancelledby) Then
			Set m_cancelledby = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_cancelledby", "cancelledby", "[cancelledby]", "[cancelledby]", 202, 0, "[cancelledby]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelledreason()
		If Not IsObject(m_cancelledreason) Then
			Set m_cancelledreason = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_cancelledreason", "cancelledreason", "[cancelledreason]", "[cancelledreason]", 202, 0, "[cancelledreason]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get acknowledgeddate()
		If Not IsObject(m_acknowledgeddate) Then
			Set m_acknowledgeddate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_acknowledgeddate", "acknowledgeddate", "[acknowledgeddate]", "(STR(YEAR([acknowledgeddate]),4,0) + '/' + REPLACE(STR(MONTH([acknowledgeddate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([acknowledgeddate]),2,0),' ','0'))", 135, 9, "[acknowledgeddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get delivereddate()
		If Not IsObject(m_delivereddate) Then
			Set m_delivereddate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_delivereddate", "delivereddate", "[delivereddate]", "[delivereddate]", 202, 0, "[delivereddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelled()
		If Not IsObject(m_cancelled) Then
			Set m_cancelled = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_cancelled", "cancelled", "[cancelled]", "CAST([cancelled] AS NVARCHAR)", 3, 0, "[cancelled]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get acknowledged()
		If Not IsObject(m_acknowledged) Then
			Set m_acknowledged = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_acknowledged", "acknowledged", "[acknowledged]", "CAST([acknowledged] AS NVARCHAR)", 3, 0, "[acknowledged]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get outfordelivery()
		If Not IsObject(m_outfordelivery) Then
			Set m_outfordelivery = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_outfordelivery", "outfordelivery", "[outfordelivery]", "CAST([outfordelivery] AS NVARCHAR)", 3, 0, "[outfordelivery]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vouchercodediscount()
		If Not IsObject(m_vouchercodediscount) Then
			Set m_vouchercodediscount = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_vouchercodediscount", "vouchercodediscount", "[vouchercodediscount]", "CAST([vouchercodediscount] AS NVARCHAR)", 3, 0, "[vouchercodediscount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vouchercode()
		If Not IsObject(m_vouchercode) Then
			Set m_vouchercode = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_vouchercode", "vouchercode", "[vouchercode]", "[vouchercode]", 202, 0, "[vouchercode]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get printed()
		If Not IsObject(m_printed) Then
			Set m_printed = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_printed", "printed", "[printed]", "CAST([printed] AS NVARCHAR)", 3, 0, "[printed]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get deliverydistance()
		If Not IsObject(m_deliverydistance) Then
			Set m_deliverydistance = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_deliverydistance", "deliverydistance", "[deliverydistance]", "[deliverydistance]", 202, 0, "[deliverydistance]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get asaporder()
		If Not IsObject(m_asaporder) Then
			Set m_asaporder = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_asaporder", "asaporder", "[asaporder]", "[asaporder]", 202, 0, "[asaporder]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryLat()
		If Not IsObject(m_DeliveryLat) Then
			Set m_DeliveryLat = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_DeliveryLat", "DeliveryLat", "[DeliveryLat]", "[DeliveryLat]", 202, 0, "[DeliveryLat]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryLng()
		If Not IsObject(m_DeliveryLng) Then
			Set m_DeliveryLng = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_DeliveryLng", "DeliveryLng", "[DeliveryLng]", "[DeliveryLng]", 202, 0, "[DeliveryLng]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get ServiceCharge()
		If Not IsObject(m_ServiceCharge) Then
			Set m_ServiceCharge = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_ServiceCharge", "ServiceCharge", "[ServiceCharge]", "CAST([ServiceCharge] AS NVARCHAR)", 6, 0, "[ServiceCharge]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get PaymentSurcharge()
		If Not IsObject(m_PaymentSurcharge) Then
			Set m_PaymentSurcharge = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_PaymentSurcharge", "PaymentSurcharge", "[PaymentSurcharge]", "CAST([PaymentSurcharge] AS NVARCHAR)", 6, 0, "[PaymentSurcharge]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get FromIP()
		If Not IsObject(m_FromIP) Then
			Set m_FromIP = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_FromIP", "FromIP", "[FromIP]", "[FromIP]", 202, 0, "[FromIP]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set FromIP = m_FromIP
	End Property
	...
	Public Property Get Tax_Rate()
		If Not IsObject(m_Tax_Rate) Then
			Set m_Tax_Rate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Tax_Rate", "Tax_Rate", "[Tax_Rate]", "CAST([Tax_Rate] AS NVARCHAR)", 3, 0, "[Tax_Rate]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tax_Amount()
		If Not IsObject(m_Tax_Amount) Then
			Set m_Tax_Amount = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Tax_Amount", "Tax_Amount", "[Tax_Amount]", "CAST([Tax_Amount] AS NVARCHAR)", 6, 0, "[Tax_Amount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tip_Rate()
		If Not IsObject(m_Tip_Rate) Then
			Set m_Tip_Rate = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Tip_Rate", "Tip_Rate", "[Tip_Rate]", "[Tip_Rate]", 202, 0, "[Tip_Rate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Tip_Amount()
		If Not IsObject(m_Tip_Amount) Then
			Set m_Tip_Amount = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Tip_Amount", "Tip_Amount", "[Tip_Amount]", "CAST([Tip_Amount] AS NVARCHAR)", 6, 0, "[Tip_Amount]", False, False, FALSE, "FORMATTED TEXT")
	...
	' Field Card_Debit
	Private m_Card_Debit

	Public Property Get Card_Debit()
		If Not IsObject(m_Card_Debit) Then
			Set m_Card_Debit = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Card_Debit", "Card_Debit", "[Card_Debit]", "CAST([Card_Debit] AS NVARCHAR)", 3, 0, "[Card_Debit]", False, False, FALSE, "FORMATTED TEXT")
			m_Card_Debit.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set Card_Debit = m_Card_Debit
	End Property

	' Field Card_Credit
	Private m_Card_Credit

	Public Property Get Card_Credit()
		If Not IsObject(m_Card_Credit) Then
			Set m_Card_Credit = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Card_Credit", "Card_Credit", "[Card_Credit]", "CAST([Card_Credit] AS NVARCHAR)", 3, 0, "[Card_Credit]", False, False, FALSE, "FORMATTED TEXT")
			m_Card_Credit.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set Card_Credit = m_Card_Credit
	End Property

	' Field SentEmail
	Private m_SentEmail

	Public Property Get SentEmail()
		If Not IsObject(m_SentEmail) Then
			Set m_SentEmail = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_SentEmail", "SentEmail", "[SentEmail]", "[SentEmail]", 202, 0, "[SentEmail]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set SentEmail = m_SentEmail
	End Property

	' Field deliverydelay
	Private m_deliverydelay

	Public Property Get deliverydelay()
		If Not IsObject(m_deliverydelay) Then
			Set m_deliverydelay = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_deliverydelay", "deliverydelay", "[deliverydelay]", "CAST([deliverydelay] AS NVARCHAR)", 3, 0, "[deliverydelay]", False, False, FALSE, "FORMATTED TEXT")
			m_deliverydelay.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set deliverydelay = m_deliverydelay
	End Property

	' Field collectiondelay
	Private m_collectiondelay

	Public Property Get collectiondelay()
		If Not IsObject(m_collectiondelay) Then
			Set m_collectiondelay = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_collectiondelay", "collectiondelay", "[collectiondelay]", "CAST([collectiondelay] AS NVARCHAR)", 3, 0, "[collectiondelay]", False, False, FALSE, "FORMATTED TEXT")
			m_collectiondelay.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set collectiondelay = m_collectiondelay
	End Property

	' Field lng_report
	Private m_lng_report

	Public Property Get lng_report()
		If Not IsObject(m_lng_report) Then
			Set m_lng_report = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_lng_report", "lng_report", "[lng_report]", "[lng_report]", 202, 0, "[lng_report]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set lng_report = m_lng_report
	End Property

	' Field lat_report
	Private m_lat_report

	Public Property Get lat_report()
		If Not IsObject(m_lat_report) Then
			Set m_lat_report = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_lat_report", "lat_report", "[lat_report]", "[lat_report]", 202, 0, "[lat_report]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set lat_report = m_lat_report
	End Property
	...
	Public Property Get Payment_status()
		If Not IsObject(m_Payment_status) Then
			Set m_Payment_status = NewFldObj("VIEW_Paid_Orders", "VIEW_Paid_Orders", "x_Payment_status", "Payment_status", "[Payment_status]", "[Payment_status]", 202, 0, "[Payment_status]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_FromIP) Then Set m_FromIP = Nothing
		...
		If IsObject(m_Card_Debit) Then Set m_Card_Debit = Nothing
		If IsObject(m_Card_Credit) Then Set m_Card_Credit = Nothing
		If IsObject(m_SentEmail) Then Set m_SentEmail = Nothing
		If IsObject(m_deliverydelay) Then Set m_deliverydelay = Nothing
		If IsObject(m_collectiondelay) Then Set m_collectiondelay = Nothing
		If IsObject(m_lng_report) Then Set m_lng_report = Nothing
		If IsObject(m_lat_report) Then Set m_lat_report = Nothing
