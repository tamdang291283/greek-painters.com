...
' Define page object
Dim Customer_Book_Table_edit
Set Customer_Book_Table_edit = New cCustomer_Book_Table_edit
Set Page = Customer_Book_Table_edit

' Page init processing
Customer_Book_Table_edit.Page_Init()

' Page main processing
Customer_Book_Table_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
Customer_Book_Table_edit.Page_Render()
%>
<!--#include file="header.asp"-->
<script type="text/javascript">
// Page object
var Customer_Book_Table_edit = new ew_Page("Customer_Book_Table_edit");
Customer_Book_Table_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = Customer_Book_Table_edit.PageID; // For backward compatibility
// Form object
var fCustomer_Book_Tableedit = new ew_Form("fCustomer_Book_Tableedit");
// Validate form
fCustomer_Book_Tableedit.Validate = function() {
...
fCustomer_Book_Tableedit.Form_CustomValidate = 
...
fCustomer_Book_Tableedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fCustomer_Book_Tableedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Customer_Book_Table_edit.ShowPageHeader() %>
<% Customer_Book_Table_edit.ShowMessage %>
<form name="fCustomer_Book_Tableedit" id="fCustomer_Book_Tableedit" class="form-horizontal ewForm ewEditForm" action="<%= ew_CurrentPage %>" method="post">
<% If Customer_Book_Table_edit.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= Customer_Book_Table_edit.Token %>">
<% End If %>
<input type="hidden" name="a_table" id="a_table" value="Customer_Book_Table">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<div>
<% If Customer_Book_Table.ID.Visible Then ' ID %>
	<div id="r_ID" class="form-group">
		<label id="elh_Customer_Book_Table_ID" class="col-sm-2 control-label ewLabel"><%= Customer_Book_Table.ID.FldCaption %></label>
		<div class="col-sm-10"><div<%= Customer_Book_Table.ID.CellAttributes %>>
<span id="el_Customer_Book_Table_ID">
<span<%= Customer_Book_Table.ID.ViewAttributes %>>
<p class="form-control-static"><%= Customer_Book_Table.ID.EditValue %></p>
</span>
</span>
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<%= Server.HTMLEncode(Customer_Book_Table.ID.CurrentValue&"") %>">
<%= Customer_Book_Table.ID.CustomMsg %></div></div>
	</div>
<% End If %>
...
<script type="text/javascript">
fCustomer_Book_Tableedit.Init();
</script>
<%
Customer_Book_Table_edit.ShowPageFooter()
...
' Drop page object
Set Customer_Book_Table_edit = Nothing
%>
<%
...
' Page Class
'
Class cCustomer_Book_Table_edit
	...
	Public Property Get PageObjName()
		PageObjName = "Customer_Book_Table_edit"
	End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			Customer_Book_Table.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			Customer_Book_Table.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If Customer_Book_Table.ID.CurrentValue = "" Then Call Page_Terminate("Customer_Book_Tablelist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				Customer_Book_Table.CurrentAction = "" ' Form error, reset action
		...
		Select Case Customer_Book_Table.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				Customer_Book_Table.SendEmail = True ' Send email on update success
		...
		' Render the record
		Customer_Book_Table.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Sub RenderRow()
		...
		ElseIf Customer_Book_Table.RowType = EW_ROWTYPE_EDIT Then ' Edit row
			...
			Customer_Book_Table.ID.EditValue = Customer_Book_Table.ID.CurrentValue
			Customer_Book_Table.ID.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			' Field Name
			Call Customer_Book_Table.Name.SetDbValue(Rs, Customer_Book_Table.Name.CurrentValue, Null, Customer_Book_Table.Name.ReadOnly)

			' Field Phone
			Call Customer_Book_Table.Phone.SetDbValue(Rs, Customer_Book_Table.Phone.CurrentValue, Null, Customer_Book_Table.Phone.ReadOnly)

			' Field bookdate
			Call Customer_Book_Table.bookdate.SetDbValue(Rs, Customer_Book_Table.bookdate.CurrentValue, Null, Customer_Book_Table.bookdate.ReadOnly)

			' Field IdBusinessDetail
			Call Customer_Book_Table.IdBusinessDetail.SetDbValue(Rs, Customer_Book_Table.IdBusinessDetail.CurrentValue, Null, Customer_Book_Table.IdBusinessDetail.ReadOnly)

			' Field comment
			Call Customer_Book_Table.comment.SetDbValue(Rs, Customer_Book_Table.comment.CurrentValue, Null, Customer_Book_Table.comment.ReadOnly)

			' Field s_contentemail
			Call Customer_Book_Table.s_contentemail.SetDbValue(Rs, Customer_Book_Table.s_contentemail.CurrentValue, Null, Customer_Book_Table.s_contentemail.ReadOnly)

			' Field numberpeople
			Call Customer_Book_Table.numberpeople.SetDbValue(Rs, Customer_Book_Table.numberpeople.CurrentValue, Null, Customer_Book_Table.numberpeople.ReadOnly)

			' Field createddate
			Call Customer_Book_Table.createddate.SetDbValue(Rs, Customer_Book_Table.createddate.CurrentValue, Null, Customer_Book_Table.createddate.ReadOnly)

			' Field Email
			Call Customer_Book_Table.zEmail.SetDbValue(Rs, Customer_Book_Table.zEmail.CurrentValue, Null, Customer_Book_Table.zEmail.ReadOnly)
