...
' Define page object
Dim sysadmin_add
Set sysadmin_add = New csysadmin_add
Set Page = sysadmin_add

' Page init processing
sysadmin_add.Page_Init()

' Page main processing
sysadmin_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
sysadmin_add.Page_Render()
%>
<!--#include file="header.asp"-->
<script type="text/javascript">
// Page object
var sysadmin_add = new ew_Page("sysadmin_add");
sysadmin_add.PageID = "add"; // Page ID
var EW_PAGE_ID = sysadmin_add.PageID; // For backward compatibility
// Form object
var fsysadminadd = new ew_Form("fsysadminadd");
// Validate form
fsysadminadd.Validate = function() {
...
fsysadminadd.Form_CustomValidate = 
...
fsysadminadd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fsysadminadd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% sysadmin_add.ShowPageHeader() %>
<% sysadmin_add.ShowMessage %>
<form name="fsysadminadd" id="fsysadminadd" class="form-horizontal ewForm ewAddForm" action="<%= ew_CurrentPage() %>" method="post">
<% If sysadmin_add.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= sysadmin_add.Token %>">
<% End If %>
...
Class csysadmin_add
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			sysadmin.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			End If
			If CopyRecord Then
				sysadmin.CurrentAction = "C" ' Copy Record
			Else
				sysadmin.CurrentAction = "I" ' Display Blank Record
		...
		Select Case sysadmin.CurrentAction
			...
			Case "A" ' Add new record
				...
				If AddRow(OldRecordset) Then ' Add successful
					...
					If ew_GetPageName(sReturnUrl) = "sysadminview.asp" Then sReturnUrl = sysadmin.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		sysadmin.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(sysadmin.CurrentAction = "C", "Copy", "Add")
