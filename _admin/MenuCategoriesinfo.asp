...
' ASPMaker configuration for Table MenuCategories
Dim MenuCategories

' Define table class
Class cMenuCategories
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "displayorder", displayorder)
	...
	Public Property Get HighlightName()
		HighlightName = "MenuCategories_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[MenuCategories]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "MenuCategorieslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "MenuCategorieslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("MenuCategoriesview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("MenuCategoriesview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "MenuCategoriesadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("MenuCategoriesedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("MenuCategoriesadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("MenuCategoriesdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		...
		displayorder.DbValue = RsRow("displayorder")
	...
	Sub RenderListRow()
		...
		displayorder.ViewCustomAttributes = ""
		...
		' displayorder
		displayorder.LinkCustomAttributes = ""
	...
	Public Sub RenderEditRow()
		...
		' displayorder
		displayorder.EditAttrs.UpdateAttribute "class", "form-control"
		displayorder.EditCustomAttributes = ""
		displayorder.EditValue = displayorder.CurrentValue
		displayorder.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(displayorder.FldCaption))
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("displayorder", displayorder.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If displayorder.Exportable Then Call Doc.ExportCaption(displayorder)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If displayorder.Exportable Then Call Doc.ExportField(displayorder)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("MenuCategories", "MenuCategories", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Name()
		If Not IsObject(m_Name) Then
			Set m_Name = NewFldObj("MenuCategories", "MenuCategories", "x_Name", "Name", "[Name]", "[Name]", 202, 0, "[Name]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Name = m_Name
	End Property
	...
	Public Property Get Description()
		If Not IsObject(m_Description) Then
			Set m_Description = NewFldObj("MenuCategories", "MenuCategories", "x_Description", "Description", "[Description]", "[Description]", 202, 0, "[Description]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get displayorder()
		If Not IsObject(m_displayorder) Then
			Set m_displayorder = NewFldObj("MenuCategories", "MenuCategories", "x_displayorder", "displayorder", "[displayorder]", "CAST([displayorder] AS NVARCHAR)", 3, 0, "[displayorder]", False, False, FALSE, "FORMATTED TEXT")
			m_displayorder.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set displayorder = m_displayorder
	End Property
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("MenuCategories", "MenuCategories", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_displayorder) Then Set m_displayorder = Nothing
