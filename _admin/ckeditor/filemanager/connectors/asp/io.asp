...
Sub SendCKEditorResults( errorNumber, CKECallback, fileUrl, fileName, customMsg )
	Response.Clear
	Response.Write "<script type=""text/javascript"">"
	' Minified version of the document.domain automatic fix script (#1919).
	' The original script can be found at _dev/domain_fix_template.js
	...
	If errorNumber <> "0" And errorNumber <> "201" Then
		fileUrl = ""
		fileName= ""
	End If
	...
	Response.Write "window.parent.CKEDITOR.tools.callFunction(""" & CKECallback & """,""" & fileUrl & """, """ & msg & """);"
	Response.Write "</script>"
	Response.End
End Sub
