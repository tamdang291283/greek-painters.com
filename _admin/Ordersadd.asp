...
' Define page object
Dim Orders_add
Set Orders_add = New cOrders_add
Set Page = Orders_add
...
// Form object
var fOrdersadd = new ew_Form("fOrdersadd");
// Validate form
...
fOrdersadd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fOrdersadd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Orders_add.ShowPageHeader() %>
<% Orders_add.ShowMessage %>
<form name="fOrdersadd" id="fOrdersadd" class="form-horizontal ewForm ewAddForm" action="<%= ew_CurrentPage() %>" method="post">
<% If Orders_add.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= Orders_add.Token %>">
<% End If %>
...
Class cOrders_add
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			Orders.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("ID").Count > 0 Then
				...
				Call Orders.SetKey("ID", Orders.ID.CurrentValue) ' Set up key
			Else
				Call Orders.SetKey("ID", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
		...
		Select Case Orders.CurrentAction
			...
			Case "A" ' Add new record
				...
				If AddRow(OldRecordset) Then ' Add successful
					...
					If ew_GetPageName(sReturnUrl) = "Ordersview.asp" Then sReturnUrl = Orders.ViewUrl("") ' View paging, return to view page with keyurl directly
	...
	Function LoadDefaultValues()
		...
		Orders.CreationDate.OldValue = Orders.CreationDate.CurrentValue
		Orders.OrderDate.CurrentValue = Null
		Orders.OrderDate.OldValue = Orders.OrderDate.CurrentValue
		Orders.DeliveryType.CurrentValue = Null
		Orders.DeliveryType.OldValue = Orders.DeliveryType.CurrentValue
		Orders.DeliveryTime.CurrentValue = Null
		Orders.DeliveryTime.OldValue = Orders.DeliveryTime.CurrentValue
		Orders.PaymentType.CurrentValue = Null
		Orders.PaymentType.OldValue = Orders.PaymentType.CurrentValue
		Orders.SubTotal.CurrentValue = Null
		Orders.SubTotal.OldValue = Orders.SubTotal.CurrentValue
		Orders.ShippingFee.CurrentValue = Null
		Orders.ShippingFee.OldValue = Orders.ShippingFee.CurrentValue
		Orders.OrderTotal.CurrentValue = Null
		Orders.OrderTotal.OldValue = Orders.OrderTotal.CurrentValue
		Orders.IdBusinessDetail.CurrentValue = Null
		Orders.IdBusinessDetail.OldValue = Orders.IdBusinessDetail.CurrentValue
		Orders.SessionId.CurrentValue = Null
		Orders.SessionId.OldValue = Orders.SessionId.CurrentValue
		Orders.FirstName.CurrentValue = Null
		Orders.FirstName.OldValue = Orders.FirstName.CurrentValue
		Orders.LastName.CurrentValue = Null
		Orders.LastName.OldValue = Orders.LastName.CurrentValue
		Orders.zEmail.CurrentValue = Null
		Orders.zEmail.OldValue = Orders.zEmail.CurrentValue
		Orders.Phone.CurrentValue = Null
		Orders.Phone.OldValue = Orders.Phone.CurrentValue
		Orders.Address.CurrentValue = Null
		Orders.Address.OldValue = Orders.Address.CurrentValue
		Orders.PostalCode.CurrentValue = Null
		Orders.PostalCode.OldValue = Orders.PostalCode.CurrentValue
		Orders.Notes.CurrentValue = Null
		Orders.Notes.OldValue = Orders.Notes.CurrentValue
		Orders.ttest.CurrentValue = Null
		Orders.ttest.OldValue = Orders.ttest.CurrentValue
		Orders.cancelleddate.CurrentValue = Null
		Orders.cancelleddate.OldValue = Orders.cancelleddate.CurrentValue
		Orders.cancelledby.CurrentValue = Null
		Orders.cancelledby.OldValue = Orders.cancelledby.CurrentValue
		Orders.cancelledreason.CurrentValue = Null
		Orders.cancelledreason.OldValue = Orders.cancelledreason.CurrentValue
		Orders.acknowledgeddate.CurrentValue = Null
		Orders.acknowledgeddate.OldValue = Orders.acknowledgeddate.CurrentValue
		Orders.delivereddate.CurrentValue = Null
		Orders.delivereddate.OldValue = Orders.delivereddate.CurrentValue
		Orders.cancelled.CurrentValue = Null
		Orders.cancelled.OldValue = Orders.cancelled.CurrentValue
		Orders.acknowledged.CurrentValue = Null
		Orders.acknowledged.OldValue = Orders.acknowledged.CurrentValue
		Orders.outfordelivery.CurrentValue = Null
		Orders.outfordelivery.OldValue = Orders.outfordelivery.CurrentValue
		Orders.vouchercodediscount.CurrentValue = Null
		Orders.vouchercodediscount.OldValue = Orders.vouchercodediscount.CurrentValue
		Orders.vouchercode.CurrentValue = Null
		Orders.vouchercode.OldValue = Orders.vouchercode.CurrentValue
		Orders.printed.CurrentValue = Null
		Orders.printed.OldValue = Orders.printed.CurrentValue
		Orders.deliverydistance.CurrentValue = Null
		Orders.deliverydistance.OldValue = Orders.deliverydistance.CurrentValue
		Orders.asaporder.CurrentValue = Null
		Orders.asaporder.OldValue = Orders.asaporder.CurrentValue
		Orders.DeliveryLat.CurrentValue = Null
		Orders.DeliveryLat.OldValue = Orders.DeliveryLat.CurrentValue
		Orders.DeliveryLng.CurrentValue = Null
		Orders.DeliveryLng.OldValue = Orders.DeliveryLng.CurrentValue
		Orders.ServiceCharge.CurrentValue = Null
		Orders.ServiceCharge.OldValue = Orders.ServiceCharge.CurrentValue
		Orders.PaymentSurcharge.CurrentValue = Null
		Orders.PaymentSurcharge.OldValue = Orders.PaymentSurcharge.CurrentValue
		Orders.FromIP.CurrentValue = Null
		Orders.FromIP.OldValue = Orders.FromIP.CurrentValue
		Orders.SentEmail.CurrentValue = Null
		Orders.SentEmail.OldValue = Orders.SentEmail.CurrentValue
		Orders.Tax_Rate.CurrentValue = Null
		Orders.Tax_Rate.OldValue = Orders.Tax_Rate.CurrentValue
		Orders.Tax_Amount.CurrentValue = Null
		Orders.Tax_Amount.OldValue = Orders.Tax_Amount.CurrentValue
		Orders.Tip_Rate.CurrentValue = Null
		Orders.Tip_Rate.OldValue = Orders.Tip_Rate.CurrentValue
		Orders.Tip_Amount.CurrentValue = Null
		Orders.Tip_Amount.OldValue = Orders.Tip_Amount.CurrentValue
		Orders.Card_Debit.CurrentValue = Null
		Orders.Card_Debit.OldValue = Orders.Card_Debit.CurrentValue
		Orders.Card_Credit.CurrentValue = Null
		Orders.Card_Credit.OldValue = Orders.Card_Credit.CurrentValue
		Orders.deliverydelay.CurrentValue = Null
		Orders.deliverydelay.OldValue = Orders.deliverydelay.CurrentValue
		Orders.collectiondelay.CurrentValue = Null
		Orders.collectiondelay.OldValue = Orders.collectiondelay.CurrentValue
		Orders.lng_report.CurrentValue = Null
		Orders.lng_report.OldValue = Orders.lng_report.CurrentValue
		Orders.lat_report.CurrentValue = Null
		Orders.lat_report.OldValue = Orders.lat_report.CurrentValue
	...
	Function AddRow(RsOld)
		...
		' Field CreationDate
		Call Orders.CreationDate.SetDbValue(Rs, Orders.CreationDate.CurrentValue, Null, False)

		' Field OrderDate
		Call Orders.OrderDate.SetDbValue(Rs, Orders.OrderDate.CurrentValue, Null, False)

		' Field DeliveryType
		Call Orders.DeliveryType.SetDbValue(Rs, Orders.DeliveryType.CurrentValue, Null, False)

		' Field DeliveryTime
		Call Orders.DeliveryTime.SetDbValue(Rs, Orders.DeliveryTime.CurrentValue, Null, False)

		' Field PaymentType
		Call Orders.PaymentType.SetDbValue(Rs, Orders.PaymentType.CurrentValue, Null, False)

		' Field SubTotal
		Call Orders.SubTotal.SetDbValue(Rs, Orders.SubTotal.CurrentValue, Null, False)

		' Field ShippingFee
		Call Orders.ShippingFee.SetDbValue(Rs, Orders.ShippingFee.CurrentValue, Null, False)

		' Field OrderTotal
		Call Orders.OrderTotal.SetDbValue(Rs, Orders.OrderTotal.CurrentValue, Null, False)

		' Field IdBusinessDetail
		Call Orders.IdBusinessDetail.SetDbValue(Rs, Orders.IdBusinessDetail.CurrentValue, Null, False)

		' Field SessionId
		Call Orders.SessionId.SetDbValue(Rs, Orders.SessionId.CurrentValue, Null, False)

		' Field FirstName
		Call Orders.FirstName.SetDbValue(Rs, Orders.FirstName.CurrentValue, Null, False)

		' Field LastName
		Call Orders.LastName.SetDbValue(Rs, Orders.LastName.CurrentValue, Null, False)

		' Field Email
		Call Orders.zEmail.SetDbValue(Rs, Orders.zEmail.CurrentValue, Null, False)

		' Field Phone
		Call Orders.Phone.SetDbValue(Rs, Orders.Phone.CurrentValue, Null, False)

		' Field Address
		Call Orders.Address.SetDbValue(Rs, Orders.Address.CurrentValue, Null, False)

		' Field PostalCode
		Call Orders.PostalCode.SetDbValue(Rs, Orders.PostalCode.CurrentValue, Null, False)

		' Field Notes
		Call Orders.Notes.SetDbValue(Rs, Orders.Notes.CurrentValue, Null, False)

		' Field ttest
		Call Orders.ttest.SetDbValue(Rs, Orders.ttest.CurrentValue, Null, False)

		' Field cancelleddate
		Call Orders.cancelleddate.SetDbValue(Rs, Orders.cancelleddate.CurrentValue, Null, False)

		' Field cancelledby
		Call Orders.cancelledby.SetDbValue(Rs, Orders.cancelledby.CurrentValue, Null, False)

		' Field cancelledreason
		Call Orders.cancelledreason.SetDbValue(Rs, Orders.cancelledreason.CurrentValue, Null, False)

		' Field acknowledgeddate
		Call Orders.acknowledgeddate.SetDbValue(Rs, Orders.acknowledgeddate.CurrentValue, Null, False)

		' Field delivereddate
		Call Orders.delivereddate.SetDbValue(Rs, Orders.delivereddate.CurrentValue, Null, False)

		' Field cancelled
		Call Orders.cancelled.SetDbValue(Rs, Orders.cancelled.CurrentValue, Null, False)

		' Field acknowledged
		Call Orders.acknowledged.SetDbValue(Rs, Orders.acknowledged.CurrentValue, Null, False)

		' Field outfordelivery
		Call Orders.outfordelivery.SetDbValue(Rs, Orders.outfordelivery.CurrentValue, Null, False)

		' Field vouchercodediscount
		Call Orders.vouchercodediscount.SetDbValue(Rs, Orders.vouchercodediscount.CurrentValue, Null, False)

		' Field vouchercode
		Call Orders.vouchercode.SetDbValue(Rs, Orders.vouchercode.CurrentValue, Null, False)

		' Field printed
		Call Orders.printed.SetDbValue(Rs, Orders.printed.CurrentValue, Null, False)

		' Field deliverydistance
		Call Orders.deliverydistance.SetDbValue(Rs, Orders.deliverydistance.CurrentValue, Null, False)

		' Field asaporder
		Call Orders.asaporder.SetDbValue(Rs, Orders.asaporder.CurrentValue, Null, False)

		' Field DeliveryLat
		Call Orders.DeliveryLat.SetDbValue(Rs, Orders.DeliveryLat.CurrentValue, Null, False)

		' Field DeliveryLng
		Call Orders.DeliveryLng.SetDbValue(Rs, Orders.DeliveryLng.CurrentValue, Null, False)

		' Field ServiceCharge
		Call Orders.ServiceCharge.SetDbValue(Rs, Orders.ServiceCharge.CurrentValue, Null, False)

		' Field PaymentSurcharge
		Call Orders.PaymentSurcharge.SetDbValue(Rs, Orders.PaymentSurcharge.CurrentValue, Null, False)

		' Field FromIP
		Call Orders.FromIP.SetDbValue(Rs, Orders.FromIP.CurrentValue, Null, False)

		' Field SentEmail
		Call Orders.SentEmail.SetDbValue(Rs, Orders.SentEmail.CurrentValue, Null, False)

		' Field Tax_Rate
		Call Orders.Tax_Rate.SetDbValue(Rs, Orders.Tax_Rate.CurrentValue, Null, False)

		' Field Tax_Amount
		Call Orders.Tax_Amount.SetDbValue(Rs, Orders.Tax_Amount.CurrentValue, Null, False)

		' Field Tip_Rate
		Call Orders.Tip_Rate.SetDbValue(Rs, Orders.Tip_Rate.CurrentValue, Null, False)

		' Field Tip_Amount
		Call Orders.Tip_Amount.SetDbValue(Rs, Orders.Tip_Amount.CurrentValue, Null, False)

		' Field Card_Debit
		Call Orders.Card_Debit.SetDbValue(Rs, Orders.Card_Debit.CurrentValue, Null, False)

		' Field Card_Credit
		Call Orders.Card_Credit.SetDbValue(Rs, Orders.Card_Credit.CurrentValue, Null, False)

		' Field deliverydelay
		Call Orders.deliverydelay.SetDbValue(Rs, Orders.deliverydelay.CurrentValue, Null, False)

		' Field collectiondelay
		Call Orders.collectiondelay.SetDbValue(Rs, Orders.collectiondelay.CurrentValue, Null, False)

		' Field lng_report
		Call Orders.lng_report.SetDbValue(Rs, Orders.lng_report.CurrentValue, Null, False)

		' Field lat_report
		Call Orders.lat_report.SetDbValue(Rs, Orders.lat_report.CurrentValue, Null, False)

		' Field Payment_status
		Call Orders.Payment_status.SetDbValue(Rs, Orders.Payment_status.CurrentValue, Null, False)
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(Orders.CurrentAction = "C", "Copy", "Add")
