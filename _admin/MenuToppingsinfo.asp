...
' ASPMaker configuration for Table MenuToppings
Dim MenuToppings
...
Class cMenuToppings
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "topping", topping)
		Call ew_SetArObj(Fields, "toppingprice", toppingprice)
		Call ew_SetArObj(Fields, "IdBusinessDetail", IdBusinessDetail)
		Call ew_SetArObj(Fields, "toppinggroupid", toppinggroupid)
	...
	Public Property Get HighlightName()
		HighlightName = "MenuToppings_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[MenuToppings]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "MenuToppingslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "MenuToppingslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("MenuToppingsview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("MenuToppingsview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "MenuToppingsadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("MenuToppingsedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("MenuToppingsadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("MenuToppingsdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		ID.DbValue = RsRow("ID")
		topping.DbValue = RsRow("topping")
		toppingprice.DbValue = RsRow("toppingprice")
		IdBusinessDetail.DbValue = RsRow("IdBusinessDetail")
		toppinggroupid.DbValue = RsRow("toppinggroupid")
	...
	Sub RenderListRow()
		...
		' topping
		topping.ViewValue = topping.CurrentValue
		topping.ViewCustomAttributes = ""

		' toppingprice
		toppingprice.ViewValue = toppingprice.CurrentValue
		toppingprice.ViewCustomAttributes = ""
		...
		' toppinggroupid
		toppinggroupid.ViewValue = toppinggroupid.CurrentValue
		toppinggroupid.ViewCustomAttributes = ""
		...
		' topping
		topping.LinkCustomAttributes = ""
		topping.HrefValue = ""
		topping.TooltipValue = ""

		' toppingprice
		toppingprice.LinkCustomAttributes = ""
		toppingprice.HrefValue = ""
		toppingprice.TooltipValue = ""
		...
		' toppinggroupid
		toppinggroupid.LinkCustomAttributes = ""
		toppinggroupid.HrefValue = ""
		toppinggroupid.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' topping
		topping.EditAttrs.UpdateAttribute "class", "form-control"
		topping.EditCustomAttributes = ""
		topping.EditValue = topping.CurrentValue
		topping.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(topping.FldCaption))

		' toppingprice
		toppingprice.EditAttrs.UpdateAttribute "class", "form-control"
		toppingprice.EditCustomAttributes = ""
		toppingprice.EditValue = toppingprice.CurrentValue
		toppingprice.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(toppingprice.FldCaption))
		If toppingprice.EditValue&"" <> "" And IsNumeric(toppingprice.EditValue) Then toppingprice.EditValue = ew_FormatNumber2(toppingprice.EditValue, -2)
		...
		' toppinggroupid
		toppinggroupid.EditAttrs.UpdateAttribute "class", "form-control"
		toppinggroupid.EditCustomAttributes = ""
		toppinggroupid.EditValue = toppinggroupid.CurrentValue
		toppinggroupid.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(toppinggroupid.FldCaption))
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("topping", topping.ExportValue(Export))
					Call XmlDoc.AddField("toppingprice", toppingprice.ExportValue(Export))
					Call XmlDoc.AddField("IdBusinessDetail", IdBusinessDetail.ExportValue(Export))
					Call XmlDoc.AddField("toppinggroupid", toppinggroupid.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If topping.Exportable Then Call Doc.ExportCaption(topping)
					If toppingprice.Exportable Then Call Doc.ExportCaption(toppingprice)
					If IdBusinessDetail.Exportable Then Call Doc.ExportCaption(IdBusinessDetail)
					If toppinggroupid.Exportable Then Call Doc.ExportCaption(toppinggroupid)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If topping.Exportable Then Call Doc.ExportField(topping)
						If toppingprice.Exportable Then Call Doc.ExportField(toppingprice)
						If IdBusinessDetail.Exportable Then Call Doc.ExportField(IdBusinessDetail)
						If toppinggroupid.Exportable Then Call Doc.ExportField(toppinggroupid)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("MenuToppings", "MenuToppings", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get topping()
		If Not IsObject(m_topping) Then
			Set m_topping = NewFldObj("MenuToppings", "MenuToppings", "x_topping", "topping", "[topping]", "[topping]", 202, 0, "[topping]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set topping = m_topping
	End Property

	' Field toppingprice
	Private m_toppingprice

	Public Property Get toppingprice()
		If Not IsObject(m_toppingprice) Then
			Set m_toppingprice = NewFldObj("MenuToppings", "MenuToppings", "x_toppingprice", "toppingprice", "[toppingprice]", "CAST([toppingprice] AS NVARCHAR)", 5, 0, "[toppingprice]", False, False, FALSE, "FORMATTED TEXT")
			m_toppingprice.FldDefaultErrMsg = Language.Phrase("IncorrectFloat")
		End If
		Set toppingprice = m_toppingprice
	End Property
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("MenuToppings", "MenuToppings", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_toppinggroupid

	Public Property Get toppinggroupid()
		If Not IsObject(m_toppinggroupid) Then
			Set m_toppinggroupid = NewFldObj("MenuToppings", "MenuToppings", "x_toppinggroupid", "toppinggroupid", "[toppinggroupid]", "CAST([toppinggroupid] AS NVARCHAR)", 3, 0, "[toppinggroupid]", False, False, FALSE, "FORMATTED TEXT")
			m_toppinggroupid.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set toppinggroupid = m_toppinggroupid
	End Property
	...
	Public Property Get printingname()
		If Not IsObject(m_printingname) Then
			Set m_printingname = NewFldObj("MenuToppings", "MenuToppings", "x_printingname", "printingname", "[printingname]", "[printingname]", 202, 0, "[printingname]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get i_displaySort()
		If Not IsObject(m_i_displaySort) Then
			Set m_i_displaySort = NewFldObj("MenuToppings", "MenuToppings", "x_i_displaySort", "i_displaySort", "[i_displaySort]", "CAST([i_displaySort] AS NVARCHAR)", 3, 0, "[i_displaySort]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_topping) Then Set m_topping = Nothing
		If IsObject(m_toppingprice) Then Set m_toppingprice = Nothing
		If IsObject(m_IdBusinessDetail) Then Set m_IdBusinessDetail = Nothing
		If IsObject(m_toppinggroupid) Then Set m_toppinggroupid = Nothing
