...
' ASPMaker configuration for Table OrderItems
Dim OrderItems
...
Class cOrderItems
	...
	Public Property Get HighlightName()
		HighlightName = "OrderItems_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[OrderItems]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "OrderItemslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "OrderItemslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("OrderItemsview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("OrderItemsview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "OrderItemsadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("OrderItemsedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("OrderItemsadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("OrderItemsdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		...
		Total.DbValue = ew_Conv(RsRow("Total"), 131)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("OrderItems", "OrderItems", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get OrderId()
		If Not IsObject(m_OrderId) Then
			Set m_OrderId = NewFldObj("OrderItems", "OrderItems", "x_OrderId", "OrderId", "[OrderId]", "CAST([OrderId] AS NVARCHAR)", 3, 0, "[OrderId]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get MenuItemId()
		If Not IsObject(m_MenuItemId) Then
			Set m_MenuItemId = NewFldObj("OrderItems", "OrderItems", "x_MenuItemId", "MenuItemId", "[MenuItemId]", "CAST([MenuItemId] AS NVARCHAR)", 3, 0, "[MenuItemId]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get MenuItemPropertyId()
		If Not IsObject(m_MenuItemPropertyId) Then
			Set m_MenuItemPropertyId = NewFldObj("OrderItems", "OrderItems", "x_MenuItemPropertyId", "MenuItemPropertyId", "[MenuItemPropertyId]", "CAST([MenuItemPropertyId] AS NVARCHAR)", 3, 0, "[MenuItemPropertyId]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Qta()
		If Not IsObject(m_Qta) Then
			Set m_Qta = NewFldObj("OrderItems", "OrderItems", "x_Qta", "Qta", "[Qta]", "CAST([Qta] AS NVARCHAR)", 3, 0, "[Qta]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Price()
		If Not IsObject(m_Price) Then
			Set m_Price = NewFldObj("OrderItems", "OrderItems", "x_Price", "Price", "[Price]", "CAST([Price] AS NVARCHAR)", 131, 0, "[Price]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Total()
		If Not IsObject(m_Total) Then
			Set m_Total = NewFldObj("OrderItems", "OrderItems", "x_Total", "Total", "[Total]", "CAST([Total] AS NVARCHAR)", 131, 0, "[Total]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get toppingids()
		If Not IsObject(m_toppingids) Then
			Set m_toppingids = NewFldObj("OrderItems", "OrderItems", "x_toppingids", "toppingids", "[toppingids]", "[toppingids]", 202, 0, "[toppingids]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get dishpropertiesids()
		If Not IsObject(m_dishpropertiesids) Then
			Set m_dishpropertiesids = NewFldObj("OrderItems", "OrderItems", "x_dishpropertiesids", "dishpropertiesids", "[dishpropertiesids]", "[dishpropertiesids]", 202, 0, "[dishpropertiesids]", False, False, FALSE, "FORMATTED TEXT")
		End If
