...
' ASPMaker configuration for Table OrdersLocal
Dim OrdersLocal
...
Class cOrdersLocal
	...
	Public Property Get HighlightName()
		HighlightName = "OrdersLocal_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[OrdersLocal]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "OrdersLocallist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "OrdersLocallist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("OrdersLocalview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("OrdersLocalview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "OrdersLocaladd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("OrdersLocaledit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("OrdersLocaladd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("OrdersLocaldelete.asp", UrlParm(""))
	End Function
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("OrdersLocal", "OrdersLocal", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get CreationDate()
		If Not IsObject(m_CreationDate) Then
			Set m_CreationDate = NewFldObj("OrdersLocal", "OrdersLocal", "x_CreationDate", "CreationDate", "[CreationDate]", "(STR(YEAR([CreationDate]),4,0) + '/' + REPLACE(STR(MONTH([CreationDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([CreationDate]),2,0),' ','0'))", 135, 9, "[CreationDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get OrderDate()
		If Not IsObject(m_OrderDate) Then
			Set m_OrderDate = NewFldObj("OrdersLocal", "OrdersLocal", "x_OrderDate", "OrderDate", "[OrderDate]", "(STR(YEAR([OrderDate]),4,0) + '/' + REPLACE(STR(MONTH([OrderDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([OrderDate]),2,0),' ','0'))", 135, 9, "[OrderDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryType()
		If Not IsObject(m_DeliveryType) Then
			Set m_DeliveryType = NewFldObj("OrdersLocal", "OrdersLocal", "x_DeliveryType", "DeliveryType", "[DeliveryType]", "[DeliveryType]", 202, 0, "[DeliveryType]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryTime()
		If Not IsObject(m_DeliveryTime) Then
			Set m_DeliveryTime = NewFldObj("OrdersLocal", "OrdersLocal", "x_DeliveryTime", "DeliveryTime", "[DeliveryTime]", "(STR(YEAR([DeliveryTime]),4,0) + '/' + REPLACE(STR(MONTH([DeliveryTime]),2,0),' ','0') + '/' + REPLACE(STR(DAY([DeliveryTime]),2,0),' ','0'))", 135, 9, "[DeliveryTime]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get PaymentType()
		If Not IsObject(m_PaymentType) Then
			Set m_PaymentType = NewFldObj("OrdersLocal", "OrdersLocal", "x_PaymentType", "PaymentType", "[PaymentType]", "[PaymentType]", 202, 0, "[PaymentType]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get SubTotal()
		If Not IsObject(m_SubTotal) Then
			Set m_SubTotal = NewFldObj("OrdersLocal", "OrdersLocal", "x_SubTotal", "SubTotal", "[SubTotal]", "CAST([SubTotal] AS NVARCHAR)", 6, 0, "[SubTotal]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get ShippingFee()
		If Not IsObject(m_ShippingFee) Then
			Set m_ShippingFee = NewFldObj("OrdersLocal", "OrdersLocal", "x_ShippingFee", "ShippingFee", "[ShippingFee]", "CAST([ShippingFee] AS NVARCHAR)", 6, 0, "[ShippingFee]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get OrderTotal()
		If Not IsObject(m_OrderTotal) Then
			Set m_OrderTotal = NewFldObj("OrdersLocal", "OrdersLocal", "x_OrderTotal", "OrderTotal", "[OrderTotal]", "CAST([OrderTotal] AS NVARCHAR)", 6, 0, "[OrderTotal]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("OrdersLocal", "OrdersLocal", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get SessionId()
		If Not IsObject(m_SessionId) Then
			Set m_SessionId = NewFldObj("OrdersLocal", "OrdersLocal", "x_SessionId", "SessionId", "[SessionId]", "[SessionId]", 202, 0, "[SessionId]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get FirstName()
		If Not IsObject(m_FirstName) Then
			Set m_FirstName = NewFldObj("OrdersLocal", "OrdersLocal", "x_FirstName", "FirstName", "[FirstName]", "[FirstName]", 202, 0, "[FirstName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get LastName()
		If Not IsObject(m_LastName) Then
			Set m_LastName = NewFldObj("OrdersLocal", "OrdersLocal", "x_LastName", "LastName", "[LastName]", "[LastName]", 202, 0, "[LastName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get zEmail()
		If Not IsObject(m_zEmail) Then
			Set m_zEmail = NewFldObj("OrdersLocal", "OrdersLocal", "x_zEmail", "Email", "[Email]", "[Email]", 202, 0, "[Email]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set zEmail = m_zEmail
	End Property
	...
	Public Property Get Phone()
		If Not IsObject(m_Phone) Then
			Set m_Phone = NewFldObj("OrdersLocal", "OrdersLocal", "x_Phone", "Phone", "[Phone]", "[Phone]", 202, 0, "[Phone]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Phone = m_Phone
	End Property
	...
	Public Property Get Address()
		If Not IsObject(m_Address) Then
			Set m_Address = NewFldObj("OrdersLocal", "OrdersLocal", "x_Address", "Address", "[Address]", "[Address]", 202, 0, "[Address]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get PostalCode()
		If Not IsObject(m_PostalCode) Then
			Set m_PostalCode = NewFldObj("OrdersLocal", "OrdersLocal", "x_PostalCode", "PostalCode", "[PostalCode]", "[PostalCode]", 202, 0, "[PostalCode]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Notes()
		If Not IsObject(m_Notes) Then
			Set m_Notes = NewFldObj("OrdersLocal", "OrdersLocal", "x_Notes", "Notes", "[Notes]", "[Notes]", 202, 0, "[Notes]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Notes = m_Notes
	End Property
	...
	Public Property Get ttest()
		If Not IsObject(m_ttest) Then
			Set m_ttest = NewFldObj("OrdersLocal", "OrdersLocal", "x_ttest", "ttest", "[ttest]", "[ttest]", 202, 0, "[ttest]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set ttest = m_ttest
	End Property
	...
	Public Property Get cancelleddate()
		If Not IsObject(m_cancelleddate) Then
			Set m_cancelleddate = NewFldObj("OrdersLocal", "OrdersLocal", "x_cancelleddate", "cancelleddate", "[cancelleddate]", "(STR(YEAR([cancelleddate]),4,0) + '/' + REPLACE(STR(MONTH([cancelleddate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([cancelleddate]),2,0),' ','0'))", 135, 9, "[cancelleddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelledby()
		If Not IsObject(m_cancelledby) Then
			Set m_cancelledby = NewFldObj("OrdersLocal", "OrdersLocal", "x_cancelledby", "cancelledby", "[cancelledby]", "[cancelledby]", 202, 0, "[cancelledby]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelledreason()
		If Not IsObject(m_cancelledreason) Then
			Set m_cancelledreason = NewFldObj("OrdersLocal", "OrdersLocal", "x_cancelledreason", "cancelledreason", "[cancelledreason]", "[cancelledreason]", 202, 0, "[cancelledreason]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get acknowledgeddate()
		If Not IsObject(m_acknowledgeddate) Then
			Set m_acknowledgeddate = NewFldObj("OrdersLocal", "OrdersLocal", "x_acknowledgeddate", "acknowledgeddate", "[acknowledgeddate]", "(STR(YEAR([acknowledgeddate]),4,0) + '/' + REPLACE(STR(MONTH([acknowledgeddate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([acknowledgeddate]),2,0),' ','0'))", 135, 9, "[acknowledgeddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get delivereddate()
		If Not IsObject(m_delivereddate) Then
			Set m_delivereddate = NewFldObj("OrdersLocal", "OrdersLocal", "x_delivereddate", "delivereddate", "[delivereddate]", "[delivereddate]", 202, 0, "[delivereddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelled()
		If Not IsObject(m_cancelled) Then
			Set m_cancelled = NewFldObj("OrdersLocal", "OrdersLocal", "x_cancelled", "cancelled", "[cancelled]", "CAST([cancelled] AS NVARCHAR)", 3, 0, "[cancelled]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get acknowledged()
		If Not IsObject(m_acknowledged) Then
			Set m_acknowledged = NewFldObj("OrdersLocal", "OrdersLocal", "x_acknowledged", "acknowledged", "[acknowledged]", "CAST([acknowledged] AS NVARCHAR)", 3, 0, "[acknowledged]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get outfordelivery()
		If Not IsObject(m_outfordelivery) Then
			Set m_outfordelivery = NewFldObj("OrdersLocal", "OrdersLocal", "x_outfordelivery", "outfordelivery", "[outfordelivery]", "CAST([outfordelivery] AS NVARCHAR)", 3, 0, "[outfordelivery]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vouchercodediscount()
		If Not IsObject(m_vouchercodediscount) Then
			Set m_vouchercodediscount = NewFldObj("OrdersLocal", "OrdersLocal", "x_vouchercodediscount", "vouchercodediscount", "[vouchercodediscount]", "CAST([vouchercodediscount] AS NVARCHAR)", 3, 0, "[vouchercodediscount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vouchercode()
		If Not IsObject(m_vouchercode) Then
			Set m_vouchercode = NewFldObj("OrdersLocal", "OrdersLocal", "x_vouchercode", "vouchercode", "[vouchercode]", "[vouchercode]", 202, 0, "[vouchercode]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get printed()
		If Not IsObject(m_printed) Then
			Set m_printed = NewFldObj("OrdersLocal", "OrdersLocal", "x_printed", "printed", "[printed]", "CAST([printed] AS NVARCHAR)", 3, 0, "[printed]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get deliverydistance()
		If Not IsObject(m_deliverydistance) Then
			Set m_deliverydistance = NewFldObj("OrdersLocal", "OrdersLocal", "x_deliverydistance", "deliverydistance", "[deliverydistance]", "[deliverydistance]", 202, 0, "[deliverydistance]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get asaporder()
		If Not IsObject(m_asaporder) Then
			Set m_asaporder = NewFldObj("OrdersLocal", "OrdersLocal", "x_asaporder", "asaporder", "[asaporder]", "[asaporder]", 202, 0, "[asaporder]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryLat()
		If Not IsObject(m_DeliveryLat) Then
			Set m_DeliveryLat = NewFldObj("OrdersLocal", "OrdersLocal", "x_DeliveryLat", "DeliveryLat", "[DeliveryLat]", "[DeliveryLat]", 202, 0, "[DeliveryLat]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryLng()
		If Not IsObject(m_DeliveryLng) Then
			Set m_DeliveryLng = NewFldObj("OrdersLocal", "OrdersLocal", "x_DeliveryLng", "DeliveryLng", "[DeliveryLng]", "[DeliveryLng]", 202, 0, "[DeliveryLng]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get ServiceCharge()
		If Not IsObject(m_ServiceCharge) Then
			Set m_ServiceCharge = NewFldObj("OrdersLocal", "OrdersLocal", "x_ServiceCharge", "ServiceCharge", "[ServiceCharge]", "CAST([ServiceCharge] AS NVARCHAR)", 5, 0, "[ServiceCharge]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get PaymentSurcharge()
		If Not IsObject(m_PaymentSurcharge) Then
			Set m_PaymentSurcharge = NewFldObj("OrdersLocal", "OrdersLocal", "x_PaymentSurcharge", "PaymentSurcharge", "[PaymentSurcharge]", "CAST([PaymentSurcharge] AS NVARCHAR)", 5, 0, "[PaymentSurcharge]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tax_Rate()
		If Not IsObject(m_Tax_Rate) Then
			Set m_Tax_Rate = NewFldObj("OrdersLocal", "OrdersLocal", "x_Tax_Rate", "Tax_Rate", "[Tax_Rate]", "CAST([Tax_Rate] AS NVARCHAR)", 3, 0, "[Tax_Rate]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tax_Amount()
		If Not IsObject(m_Tax_Amount) Then
			Set m_Tax_Amount = NewFldObj("OrdersLocal", "OrdersLocal", "x_Tax_Amount", "Tax_Amount", "[Tax_Amount]", "CAST([Tax_Amount] AS NVARCHAR)", 6, 0, "[Tax_Amount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tip_Rate()
		If Not IsObject(m_Tip_Rate) Then
			Set m_Tip_Rate = NewFldObj("OrdersLocal", "OrdersLocal", "x_Tip_Rate", "Tip_Rate", "[Tip_Rate]", "[Tip_Rate]", 202, 0, "[Tip_Rate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Tip_Amount()
		If Not IsObject(m_Tip_Amount) Then
			Set m_Tip_Amount = NewFldObj("OrdersLocal", "OrdersLocal", "x_Tip_Amount", "Tip_Amount", "[Tip_Amount]", "CAST([Tip_Amount] AS NVARCHAR)", 6, 0, "[Tip_Amount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Payment_status()
		If Not IsObject(m_Payment_status) Then
			Set m_Payment_status = NewFldObj("OrdersLocal", "OrdersLocal", "x_Payment_status", "Payment_status", "[Payment_status]", "[Payment_status]", 202, 0, "[Payment_status]", False, False, FALSE, "FORMATTED TEXT")
		End If
