...
' ASPMaker configuration for Table OpeningTimes
Dim OpeningTimes
...
Class cOpeningTimes
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "DayOfWeek", DayOfWeek)
		Call ew_SetArObj(Fields, "Hour_From", Hour_From)
		Call ew_SetArObj(Fields, "Hour_To", Hour_To)
		Call ew_SetArObj(Fields, "IdBusinessDetail", IdBusinessDetail)
		Call ew_SetArObj(Fields, "delivery", delivery)
		Call ew_SetArObj(Fields, "collection", collection)
		Call ew_SetArObj(Fields, "MinAcceptOrderBeforeClose", MinAcceptOrderBeforeClose)
	End Sub
	...
	Public Property Get HighlightName()
		HighlightName = "OpeningTimes_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[OpeningTimes]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "OpeningTimeslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "OpeningTimeslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("OpeningTimesview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("OpeningTimesview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "OpeningTimesadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("OpeningTimesedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("OpeningTimesadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("OpeningTimesdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		ID.DbValue = RsRow("ID")
		DayOfWeek.DbValue = RsRow("DayOfWeek")
		Hour_From.DbValue = RsRow("Hour_From")
		Hour_To.DbValue = RsRow("Hour_To")
		IdBusinessDetail.DbValue = RsRow("IdBusinessDetail")
		delivery.DbValue = RsRow("delivery")
		collection.DbValue = RsRow("collection")
		MinAcceptOrderBeforeClose.DbValue = ew_Conv(RsRow("MinAcceptOrderBeforeClose"), 131)
	End Sub
	...
	Sub RenderListRow()
		...
		' DayOfWeek
		DayOfWeek.ViewValue = DayOfWeek.CurrentValue
		DayOfWeek.ViewCustomAttributes = ""

		' Hour_From
		Hour_From.ViewValue = Hour_From.CurrentValue
		Hour_From.ViewCustomAttributes = ""

		' Hour_To
		Hour_To.ViewValue = Hour_To.CurrentValue
		Hour_To.ViewCustomAttributes = ""
		...
		' delivery
		delivery.ViewValue = delivery.CurrentValue
		delivery.ViewCustomAttributes = ""

		' collection
		collection.ViewValue = collection.CurrentValue
		collection.ViewCustomAttributes = ""

		' MinAcceptOrderBeforeClose
		MinAcceptOrderBeforeClose.ViewValue = MinAcceptOrderBeforeClose.CurrentValue
		MinAcceptOrderBeforeClose.ViewCustomAttributes = ""
		...
		' DayOfWeek
		DayOfWeek.LinkCustomAttributes = ""
		DayOfWeek.HrefValue = ""
		DayOfWeek.TooltipValue = ""

		' Hour_From
		Hour_From.LinkCustomAttributes = ""
		Hour_From.HrefValue = ""
		Hour_From.TooltipValue = ""

		' Hour_To
		Hour_To.LinkCustomAttributes = ""
		Hour_To.HrefValue = ""
		Hour_To.TooltipValue = ""
		...
		' delivery
		delivery.LinkCustomAttributes = ""
		delivery.HrefValue = ""
		delivery.TooltipValue = ""

		' collection
		collection.LinkCustomAttributes = ""
		collection.HrefValue = ""
		collection.TooltipValue = ""

		' MinAcceptOrderBeforeClose
		MinAcceptOrderBeforeClose.LinkCustomAttributes = ""
		MinAcceptOrderBeforeClose.HrefValue = ""
		MinAcceptOrderBeforeClose.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' DayOfWeek
		DayOfWeek.EditAttrs.UpdateAttribute "class", "form-control"
		DayOfWeek.EditCustomAttributes = ""
		DayOfWeek.EditValue = DayOfWeek.CurrentValue
		DayOfWeek.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(DayOfWeek.FldCaption))

		' Hour_From
		Hour_From.EditAttrs.UpdateAttribute "class", "form-control"
		Hour_From.EditCustomAttributes = ""
		Hour_From.EditValue = ew_FormatDateTime(Hour_From.CurrentValue, 99)
		Hour_From.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Hour_From.FldCaption))

		' Hour_To
		Hour_To.EditAttrs.UpdateAttribute "class", "form-control"
		Hour_To.EditCustomAttributes = ""
		Hour_To.EditValue = ew_FormatDateTime(Hour_To.CurrentValue, 99)
		Hour_To.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Hour_To.FldCaption))
		...
		' delivery
		delivery.EditAttrs.UpdateAttribute "class", "form-control"
		delivery.EditCustomAttributes = ""
		delivery.EditValue = delivery.CurrentValue
		delivery.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(delivery.FldCaption))

		' collection
		collection.EditAttrs.UpdateAttribute "class", "form-control"
		collection.EditCustomAttributes = ""
		collection.EditValue = collection.CurrentValue
		collection.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(collection.FldCaption))

		' MinAcceptOrderBeforeClose
		MinAcceptOrderBeforeClose.EditAttrs.UpdateAttribute "class", "form-control"
		MinAcceptOrderBeforeClose.EditCustomAttributes = ""
		MinAcceptOrderBeforeClose.EditValue = MinAcceptOrderBeforeClose.CurrentValue
		MinAcceptOrderBeforeClose.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(MinAcceptOrderBeforeClose.FldCaption))
		If MinAcceptOrderBeforeClose.EditValue&"" <> "" And IsNumeric(MinAcceptOrderBeforeClose.EditValue) Then MinAcceptOrderBeforeClose.EditValue = ew_FormatNumber2(MinAcceptOrderBeforeClose.EditValue, -2)
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("DayOfWeek", DayOfWeek.ExportValue(Export))
					Call XmlDoc.AddField("Hour_From", Hour_From.ExportValue(Export))
					Call XmlDoc.AddField("Hour_To", Hour_To.ExportValue(Export))
					Call XmlDoc.AddField("IdBusinessDetail", IdBusinessDetail.ExportValue(Export))
					Call XmlDoc.AddField("delivery", delivery.ExportValue(Export))
					Call XmlDoc.AddField("collection", collection.ExportValue(Export))
					Call XmlDoc.AddField("MinAcceptOrderBeforeClose", MinAcceptOrderBeforeClose.ExportValue(Export))
				Else
					Call XmlDoc.AddField("ID", ID.ExportValue(Export))
					Call XmlDoc.AddField("DayOfWeek", DayOfWeek.ExportValue(Export))
					Call XmlDoc.AddField("Hour_From", Hour_From.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If DayOfWeek.Exportable Then Call Doc.ExportCaption(DayOfWeek)
					If Hour_From.Exportable Then Call Doc.ExportCaption(Hour_From)
					If Hour_To.Exportable Then Call Doc.ExportCaption(Hour_To)
					If IdBusinessDetail.Exportable Then Call Doc.ExportCaption(IdBusinessDetail)
					If delivery.Exportable Then Call Doc.ExportCaption(delivery)
					If collection.Exportable Then Call Doc.ExportCaption(collection)
					If MinAcceptOrderBeforeClose.Exportable Then Call Doc.ExportCaption(MinAcceptOrderBeforeClose)
				Else
					If ID.Exportable Then Call Doc.ExportCaption(ID)
					If DayOfWeek.Exportable Then Call Doc.ExportCaption(DayOfWeek)
					If Hour_From.Exportable Then Call Doc.ExportCaption(Hour_From)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If DayOfWeek.Exportable Then Call Doc.ExportField(DayOfWeek)
						If Hour_From.Exportable Then Call Doc.ExportField(Hour_From)
						If Hour_To.Exportable Then Call Doc.ExportField(Hour_To)
						If IdBusinessDetail.Exportable Then Call Doc.ExportField(IdBusinessDetail)
						If delivery.Exportable Then Call Doc.ExportField(delivery)
						If collection.Exportable Then Call Doc.ExportField(collection)
						If MinAcceptOrderBeforeClose.Exportable Then Call Doc.ExportField(MinAcceptOrderBeforeClose)
					Else
						If ID.Exportable Then Call Doc.ExportField(ID)
						If DayOfWeek.Exportable Then Call Doc.ExportField(DayOfWeek)
						If Hour_From.Exportable Then Call Doc.ExportField(Hour_From)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("OpeningTimes", "OpeningTimes", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get DayOfWeek()
		If Not IsObject(m_DayOfWeek) Then
			Set m_DayOfWeek = NewFldObj("OpeningTimes", "OpeningTimes", "x_DayOfWeek", "DayOfWeek", "[DayOfWeek]", "CAST([DayOfWeek] AS NVARCHAR)", 3, 0, "[DayOfWeek]", False, False, FALSE, "FORMATTED TEXT")
			m_DayOfWeek.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set DayOfWeek = m_DayOfWeek
	End Property

	' Field Hour_From
	Private m_Hour_From

	Public Property Get Hour_From()
		If Not IsObject(m_Hour_From) Then
			Set m_Hour_From = NewFldObj("OpeningTimes", "OpeningTimes", "x_Hour_From", "Hour_From", "[Hour_From]", "(STR(YEAR([Hour_From]),4,0) + '/' + REPLACE(STR(MONTH([Hour_From]),2,0),' ','0') + '/' + REPLACE(STR(DAY([Hour_From]),2,0),' ','0'))", 145, 0, "[Hour_From]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Hour_From = m_Hour_From
	End Property

	' Field Hour_To
	Private m_Hour_To

	Public Property Get Hour_To()
		If Not IsObject(m_Hour_To) Then
			Set m_Hour_To = NewFldObj("OpeningTimes", "OpeningTimes", "x_Hour_To", "Hour_To", "[Hour_To]", "(STR(YEAR([Hour_To]),4,0) + '/' + REPLACE(STR(MONTH([Hour_To]),2,0),' ','0') + '/' + REPLACE(STR(DAY([Hour_To]),2,0),' ','0'))", 145, 0, "[Hour_To]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Hour_To = m_Hour_To
	End Property
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("OpeningTimes", "OpeningTimes", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get delivery()
		If Not IsObject(m_delivery) Then
			Set m_delivery = NewFldObj("OpeningTimes", "OpeningTimes", "x_delivery", "delivery", "[delivery]", "[delivery]", 202, 0, "[delivery]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set delivery = m_delivery
	End Property
	...
	Public Property Get collection()
		If Not IsObject(m_collection) Then
			Set m_collection = NewFldObj("OpeningTimes", "OpeningTimes", "x_collection", "collection", "[collection]", "[collection]", 202, 0, "[collection]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set collection = m_collection
	End Property

	' Field MinAcceptOrderBeforeClose
	Private m_MinAcceptOrderBeforeClose

	Public Property Get MinAcceptOrderBeforeClose()
		If Not IsObject(m_MinAcceptOrderBeforeClose) Then
			Set m_MinAcceptOrderBeforeClose = NewFldObj("OpeningTimes", "OpeningTimes", "x_MinAcceptOrderBeforeClose", "MinAcceptOrderBeforeClose", "[MinAcceptOrderBeforeClose]", "CAST([MinAcceptOrderBeforeClose] AS NVARCHAR)", 131, 0, "[MinAcceptOrderBeforeClose]", False, False, FALSE, "FORMATTED TEXT")
			m_MinAcceptOrderBeforeClose.FldDefaultErrMsg = Language.Phrase("IncorrectFloat")
		End If
		Set MinAcceptOrderBeforeClose = m_MinAcceptOrderBeforeClose
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_DayOfWeek) Then Set m_DayOfWeek = Nothing
		If IsObject(m_Hour_From) Then Set m_Hour_From = Nothing
		If IsObject(m_Hour_To) Then Set m_Hour_To = Nothing
		If IsObject(m_IdBusinessDetail) Then Set m_IdBusinessDetail = Nothing
		If IsObject(m_delivery) Then Set m_delivery = Nothing
		If IsObject(m_collection) Then Set m_collection = Nothing
		If IsObject(m_MinAcceptOrderBeforeClose) Then Set m_MinAcceptOrderBeforeClose = Nothing
