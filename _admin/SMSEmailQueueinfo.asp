...
' ASPMaker configuration for Table SMSEmailQueue
Dim SMSEmailQueue

' Define table class
Class cSMSEmailQueue
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "ToEmailAddress", ToEmailAddress)
		Call ew_SetArObj(Fields, "PhoneNumber", PhoneNumber)
		Call ew_SetArObj(Fields, "Content", Content)
		Call ew_SetArObj(Fields, "SendTime", SendTime)
		Call ew_SetArObj(Fields, "IsSent", IsSent)
		Call ew_SetArObj(Fields, "PlanSendDate", PlanSendDate)
		Call ew_SetArObj(Fields, "SendType", SendType)
		Call ew_SetArObj(Fields, "BusinessDetailID", BusinessDetailID)
	End Sub
	...
	Public Property Get HighlightName()
		HighlightName = "SMSEmailQueue_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[SMSEmailQueue]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "SMSEmailQueuelist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "SMSEmailQueuelist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("SMSEmailQueueview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("SMSEmailQueueview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "SMSEmailQueueadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("SMSEmailQueueedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("SMSEmailQueueadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("SMSEmailQueuedelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		ID.DbValue = RsRow("ID")
		ToEmailAddress.DbValue = RsRow("ToEmailAddress")
		PhoneNumber.DbValue = RsRow("PhoneNumber")
		Content.DbValue = RsRow("Content")
		SendTime.DbValue = RsRow("SendTime")
		IsSent.DbValue = RsRow("IsSent")
		PlanSendDate.DbValue = RsRow("PlanSendDate")
		SendType.DbValue = RsRow("SendType")
		BusinessDetailID.DbValue = ew_Conv(RsRow("BusinessDetailID"), 131)
	End Sub
	...
	Sub RenderListRow()
		...
		' ToEmailAddress
		ToEmailAddress.ViewValue = ToEmailAddress.CurrentValue
		ToEmailAddress.ViewCustomAttributes = ""
		...
		' Content
		Content.ViewValue = Content.CurrentValue
		Content.ViewCustomAttributes = ""

		' SendTime
		SendTime.ViewValue = SendTime.CurrentValue
		SendTime.ViewCustomAttributes = ""

		' IsSent
		IsSent.ViewValue = IsSent.CurrentValue
		IsSent.ViewCustomAttributes = ""

		' PlanSendDate
		PlanSendDate.ViewValue = PlanSendDate.CurrentValue
		PlanSendDate.ViewCustomAttributes = ""

		' SendType
		SendType.ViewValue = SendType.CurrentValue
		SendType.ViewCustomAttributes = ""

		' BusinessDetailID
		BusinessDetailID.ViewValue = BusinessDetailID.CurrentValue
		BusinessDetailID.ViewCustomAttributes = ""
		...
		' ToEmailAddress
		ToEmailAddress.LinkCustomAttributes = ""
		ToEmailAddress.HrefValue = ""
		ToEmailAddress.TooltipValue = ""
		...
		' Content
		Content.LinkCustomAttributes = ""
		Content.HrefValue = ""
		Content.TooltipValue = ""

		' SendTime
		SendTime.LinkCustomAttributes = ""
		SendTime.HrefValue = ""
		SendTime.TooltipValue = ""

		' IsSent
		IsSent.LinkCustomAttributes = ""
		IsSent.HrefValue = ""
		IsSent.TooltipValue = ""

		' PlanSendDate
		PlanSendDate.LinkCustomAttributes = ""
		PlanSendDate.HrefValue = ""
		PlanSendDate.TooltipValue = ""

		' SendType
		SendType.LinkCustomAttributes = ""
		SendType.HrefValue = ""
		SendType.TooltipValue = ""

		' BusinessDetailID
		BusinessDetailID.LinkCustomAttributes = ""
		BusinessDetailID.HrefValue = ""
		BusinessDetailID.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' ToEmailAddress
		ToEmailAddress.EditAttrs.UpdateAttribute "class", "form-control"
		ToEmailAddress.EditCustomAttributes = ""
		ToEmailAddress.EditValue = ToEmailAddress.CurrentValue
		ToEmailAddress.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(ToEmailAddress.FldCaption))
		...
		' Content
		Content.EditAttrs.UpdateAttribute "class", "form-control"
		Content.EditCustomAttributes = ""
		Content.EditValue = Content.CurrentValue
		Content.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Content.FldCaption))

		' SendTime
		SendTime.EditAttrs.UpdateAttribute "class", "form-control"
		SendTime.EditCustomAttributes = ""
		SendTime.EditValue = SendTime.CurrentValue
		SendTime.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(SendTime.FldCaption))

		' IsSent
		IsSent.EditAttrs.UpdateAttribute "class", "form-control"
		IsSent.EditCustomAttributes = ""
		IsSent.EditValue = IsSent.CurrentValue
		IsSent.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(IsSent.FldCaption))

		' PlanSendDate
		PlanSendDate.EditAttrs.UpdateAttribute "class", "form-control"
		PlanSendDate.EditCustomAttributes = ""
		PlanSendDate.EditValue = PlanSendDate.CurrentValue
		PlanSendDate.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(PlanSendDate.FldCaption))

		' SendType
		SendType.EditAttrs.UpdateAttribute "class", "form-control"
		SendType.EditCustomAttributes = ""
		SendType.EditValue = SendType.CurrentValue
		SendType.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(SendType.FldCaption))

		' BusinessDetailID
		BusinessDetailID.EditAttrs.UpdateAttribute "class", "form-control"
		BusinessDetailID.EditCustomAttributes = ""
		BusinessDetailID.EditValue = BusinessDetailID.CurrentValue
		BusinessDetailID.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(BusinessDetailID.FldCaption))
		If BusinessDetailID.EditValue&"" <> "" And IsNumeric(BusinessDetailID.EditValue) Then BusinessDetailID.EditValue = ew_FormatNumber2(BusinessDetailID.EditValue, -2)
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("ToEmailAddress", ToEmailAddress.ExportValue(Export))
					Call XmlDoc.AddField("PhoneNumber", PhoneNumber.ExportValue(Export))
					Call XmlDoc.AddField("Content", Content.ExportValue(Export))
					Call XmlDoc.AddField("SendTime", SendTime.ExportValue(Export))
					Call XmlDoc.AddField("IsSent", IsSent.ExportValue(Export))
					Call XmlDoc.AddField("PlanSendDate", PlanSendDate.ExportValue(Export))
					Call XmlDoc.AddField("SendType", SendType.ExportValue(Export))
					Call XmlDoc.AddField("BusinessDetailID", BusinessDetailID.ExportValue(Export))
				Else
					Call XmlDoc.AddField("ID", ID.ExportValue(Export))
					Call XmlDoc.AddField("ToEmailAddress", ToEmailAddress.ExportValue(Export))
					Call XmlDoc.AddField("PhoneNumber", PhoneNumber.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If ToEmailAddress.Exportable Then Call Doc.ExportCaption(ToEmailAddress)
					If PhoneNumber.Exportable Then Call Doc.ExportCaption(PhoneNumber)
					If Content.Exportable Then Call Doc.ExportCaption(Content)
					If SendTime.Exportable Then Call Doc.ExportCaption(SendTime)
					If IsSent.Exportable Then Call Doc.ExportCaption(IsSent)
					If PlanSendDate.Exportable Then Call Doc.ExportCaption(PlanSendDate)
					If SendType.Exportable Then Call Doc.ExportCaption(SendType)
					If BusinessDetailID.Exportable Then Call Doc.ExportCaption(BusinessDetailID)
				Else
					If ID.Exportable Then Call Doc.ExportCaption(ID)
					If ToEmailAddress.Exportable Then Call Doc.ExportCaption(ToEmailAddress)
					If PhoneNumber.Exportable Then Call Doc.ExportCaption(PhoneNumber)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If ToEmailAddress.Exportable Then Call Doc.ExportField(ToEmailAddress)
						If PhoneNumber.Exportable Then Call Doc.ExportField(PhoneNumber)
						If Content.Exportable Then Call Doc.ExportField(Content)
						If SendTime.Exportable Then Call Doc.ExportField(SendTime)
						If IsSent.Exportable Then Call Doc.ExportField(IsSent)
						If PlanSendDate.Exportable Then Call Doc.ExportField(PlanSendDate)
						If SendType.Exportable Then Call Doc.ExportField(SendType)
						If BusinessDetailID.Exportable Then Call Doc.ExportField(BusinessDetailID)
					Else
						If ID.Exportable Then Call Doc.ExportField(ID)
						If ToEmailAddress.Exportable Then Call Doc.ExportField(ToEmailAddress)
						If PhoneNumber.Exportable Then Call Doc.ExportField(PhoneNumber)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_ToEmailAddress

	Public Property Get ToEmailAddress()
		If Not IsObject(m_ToEmailAddress) Then
			Set m_ToEmailAddress = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_ToEmailAddress", "ToEmailAddress", "[ToEmailAddress]", "[ToEmailAddress]", 202, 0, "[ToEmailAddress]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set ToEmailAddress = m_ToEmailAddress
	End Property
	...
	Public Property Get PhoneNumber()
		If Not IsObject(m_PhoneNumber) Then
			Set m_PhoneNumber = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_PhoneNumber", "PhoneNumber", "[PhoneNumber]", "[PhoneNumber]", 202, 0, "[PhoneNumber]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Content()
		If Not IsObject(m_Content) Then
			Set m_Content = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_Content", "Content", "[Content]", "[Content]", 202, 0, "[Content]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get SendTime()
		If Not IsObject(m_SendTime) Then
			Set m_SendTime = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_SendTime", "SendTime", "[SendTime]", "(STR(YEAR([SendTime]),4,0) + '/' + REPLACE(STR(MONTH([SendTime]),2,0),' ','0') + '/' + REPLACE(STR(DAY([SendTime]),2,0),' ','0'))", 135, 9, "[SendTime]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set SendTime = m_SendTime
	End Property

	' Field IsSent
	Private m_IsSent

	Public Property Get IsSent()
		If Not IsObject(m_IsSent) Then
			Set m_IsSent = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_IsSent", "IsSent", "[IsSent]", "CAST([IsSent] AS NVARCHAR)", 3, 0, "[IsSent]", False, False, FALSE, "FORMATTED TEXT")
			m_IsSent.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set IsSent = m_IsSent
	End Property

	' Field PlanSendDate
	Private m_PlanSendDate

	Public Property Get PlanSendDate()
		If Not IsObject(m_PlanSendDate) Then
			Set m_PlanSendDate = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_PlanSendDate", "PlanSendDate", "[PlanSendDate]", "(STR(YEAR([PlanSendDate]),4,0) + '/' + REPLACE(STR(MONTH([PlanSendDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([PlanSendDate]),2,0),' ','0'))", 135, 9, "[PlanSendDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set PlanSendDate = m_PlanSendDate
	End Property

	' Field SendType
	Private m_SendType

	Public Property Get SendType()
		If Not IsObject(m_SendType) Then
			Set m_SendType = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_SendType", "SendType", "[SendType]", "[SendType]", 202, 0, "[SendType]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set SendType = m_SendType
	End Property

	' Field BusinessDetailID
	Private m_BusinessDetailID

	Public Property Get BusinessDetailID()
		If Not IsObject(m_BusinessDetailID) Then
			Set m_BusinessDetailID = NewFldObj("SMSEmailQueue", "SMSEmailQueue", "x_BusinessDetailID", "BusinessDetailID", "[BusinessDetailID]", "CAST([BusinessDetailID] AS NVARCHAR)", 131, 0, "[BusinessDetailID]", False, False, FALSE, "FORMATTED TEXT")
			m_BusinessDetailID.FldDefaultErrMsg = Language.Phrase("IncorrectFloat")
		End If
		Set BusinessDetailID = m_BusinessDetailID
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_ToEmailAddress) Then Set m_ToEmailAddress = Nothing
		If IsObject(m_PhoneNumber) Then Set m_PhoneNumber = Nothing
		If IsObject(m_Content) Then Set m_Content = Nothing
		If IsObject(m_SendTime) Then Set m_SendTime = Nothing
		If IsObject(m_IsSent) Then Set m_IsSent = Nothing
		If IsObject(m_PlanSendDate) Then Set m_PlanSendDate = Nothing
		If IsObject(m_SendType) Then Set m_SendType = Nothing
		If IsObject(m_BusinessDetailID) Then Set m_BusinessDetailID = Nothing
