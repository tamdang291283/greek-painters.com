...
' Define page object
Dim vouchercodes_edit
Set vouchercodes_edit = New cvouchercodes_edit
Set Page = vouchercodes_edit

' Page init processing
vouchercodes_edit.Page_Init()

' Page main processing
vouchercodes_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
vouchercodes_edit.Page_Render()
%>
<!--#include file="header.asp"-->
<script type="text/javascript">
// Page object
var vouchercodes_edit = new ew_Page("vouchercodes_edit");
vouchercodes_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = vouchercodes_edit.PageID; // For backward compatibility
// Form object
var fvouchercodesedit = new ew_Form("fvouchercodesedit");
// Validate form
fvouchercodesedit.Validate = function() {
...
fvouchercodesedit.Form_CustomValidate = 
...
fvouchercodesedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fvouchercodesedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% vouchercodes_edit.ShowPageHeader() %>
<% vouchercodes_edit.ShowMessage %>
<form name="fvouchercodesedit" id="fvouchercodesedit" class="form-horizontal ewForm ewEditForm" action="<%= ew_CurrentPage %>" method="post">
<% If vouchercodes_edit.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= vouchercodes_edit.Token %>">
<% End If %>
<input type="hidden" name="a_table" id="a_table" value="vouchercodes">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<div>
<% If vouchercodes.ID.Visible Then ' ID %>
	<div id="r_ID" class="form-group">
		<label id="elh_vouchercodes_ID" class="col-sm-2 control-label ewLabel"><%= vouchercodes.ID.FldCaption %></label>
		<div class="col-sm-10"><div<%= vouchercodes.ID.CellAttributes %>>
<span id="el_vouchercodes_ID">
<span<%= vouchercodes.ID.ViewAttributes %>>
<p class="form-control-static"><%= vouchercodes.ID.EditValue %></p>
</span>
</span>
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<%= Server.HTMLEncode(vouchercodes.ID.CurrentValue&"") %>">
<%= vouchercodes.ID.CustomMsg %></div></div>
	</div>
<% End If %>
...
<script type="text/javascript">
fvouchercodesedit.Init();
</script>
<%
vouchercodes_edit.ShowPageFooter()
...
Class cvouchercodes_edit
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			vouchercodes.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			vouchercodes.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If vouchercodes.ID.CurrentValue = "" Then Call Page_Terminate("vouchercodeslist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				vouchercodes.CurrentAction = "" ' Form error, reset action
		...
		Select Case vouchercodes.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				vouchercodes.SendEmail = True ' Send email on update success
		...
		' Render the record
		vouchercodes.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Sub RenderRow()
		...
		ElseIf vouchercodes.RowType = EW_ROWTYPE_EDIT Then ' Edit row
			...
			vouchercodes.ID.EditValue = vouchercodes.ID.CurrentValue
			vouchercodes.ID.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			' Field vouchercode
			Call vouchercodes.vouchercode.SetDbValue(Rs, vouchercodes.vouchercode.CurrentValue, Null, vouchercodes.vouchercode.ReadOnly)

			' Field vouchercodediscount
			Call vouchercodes.vouchercodediscount.SetDbValue(Rs, vouchercodes.vouchercodediscount.CurrentValue, Null, vouchercodes.vouchercodediscount.ReadOnly)

			' Field vouchertype
			Call vouchercodes.vouchertype.SetDbValue(Rs, vouchercodes.vouchertype.CurrentValue, Null, vouchercodes.vouchertype.ReadOnly)

			' Field startdate
			Call vouchercodes.startdate.SetDbValue(Rs, vouchercodes.startdate.CurrentValue, Null, vouchercodes.startdate.ReadOnly)

			' Field enddate
			Call vouchercodes.enddate.SetDbValue(Rs, vouchercodes.enddate.CurrentValue, Null, vouchercodes.enddate.ReadOnly)

			' Field IdBusinessDetail
			Call vouchercodes.IdBusinessDetail.SetDbValue(Rs, vouchercodes.IdBusinessDetail.CurrentValue, Null, vouchercodes.IdBusinessDetail.ReadOnly)

			' Field MinimumAmount
			Call vouchercodes.MinimumAmount.SetDbValue(Rs, vouchercodes.MinimumAmount.CurrentValue, Null, vouchercodes.MinimumAmount.ReadOnly)

			' Field MenuItemID
			Call vouchercodes.MenuItemID.SetDbValue(Rs, vouchercodes.MenuItemID.CurrentValue, Null, vouchercodes.MenuItemID.ReadOnly)

			' Field VoucherMainType
			Call vouchercodes.VoucherMainType.SetDbValue(Rs, vouchercodes.VoucherMainType.CurrentValue, Null, vouchercodes.VoucherMainType.ReadOnly)
