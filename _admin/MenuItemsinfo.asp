...
' ASPMaker configuration for Table MenuItems
Dim MenuItems
...
Class cMenuItems
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "Code", Code)
		Call ew_SetArObj(Fields, "Name", Name)
		Call ew_SetArObj(Fields, "Description", Description)
		Call ew_SetArObj(Fields, "Vegetarian", Vegetarian)
		Call ew_SetArObj(Fields, "Spicyness", Spicyness)
		Call ew_SetArObj(Fields, "Price", Price)
		Call ew_SetArObj(Fields, "IdMenuCategory", IdMenuCategory)
		Call ew_SetArObj(Fields, "IdBusinessDetail", IdBusinessDetail)
		Call ew_SetArObj(Fields, "Photo", Photo)
		Call ew_SetArObj(Fields, "allowtoppings", allowtoppings)
		Call ew_SetArObj(Fields, "dishpropertygroupid", dishpropertygroupid)
		Call ew_SetArObj(Fields, "hidedish", hidedish)
	...
	Public Property Get HighlightName()
		HighlightName = "MenuItems_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[MenuItems]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "MenuItemslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "MenuItemslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("MenuItemsview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("MenuItemsview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "MenuItemsadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("MenuItemsedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("MenuItemsadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("MenuItemsdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		Id.DbValue = RsRow("Id")
		Code.DbValue = RsRow("Code")
		Name.DbValue = RsRow("Name")
		Description.DbValue = RsRow("Description")
		Vegetarian.DbValue = RsRow("Vegetarian")
		Spicyness.DbValue = RsRow("Spicyness")
		Price.DbValue = ew_Conv(RsRow("Price"), 131)
		IdMenuCategory.DbValue = RsRow("IdMenuCategory")
		IdBusinessDetail.DbValue = RsRow("IdBusinessDetail")
		Photo.DbValue = RsRow("Photo")
		allowtoppings.DbValue = RsRow("allowtoppings")
		dishpropertygroupid.DbValue = RsRow("dishpropertygroupid")
		hidedish.DbValue = ew_IIf(RsRow("hidedish"), "1", "0")
	...
	Sub RenderListRow()
		...
		' Code
		Code.ViewValue = Code.CurrentValue
		...
		' Vegetarian
		Vegetarian.ViewValue = Vegetarian.CurrentValue
		Vegetarian.ViewCustomAttributes = ""

		' Spicyness
		Spicyness.ViewValue = Spicyness.CurrentValue
		Spicyness.ViewCustomAttributes = ""
		...
		' IdMenuCategory
		IdMenuCategory.ViewValue = IdMenuCategory.CurrentValue
		IdMenuCategory.ViewCustomAttributes = ""
		...
		' Photo
		Photo.ViewValue = Photo.CurrentValue
		Photo.ViewCustomAttributes = ""

		' allowtoppings
		allowtoppings.ViewValue = allowtoppings.CurrentValue
		allowtoppings.ViewCustomAttributes = ""
		...
		' hidedish
		If ew_ConvertToBool(hidedish.CurrentValue) Then
			hidedish.ViewValue = ew_IIf(hidedish.FldTagCaption(1) <> "", hidedish.FldTagCaption(1), "Yes")
		Else
			hidedish.ViewValue = ew_IIf(hidedish.FldTagCaption(2) <> "", hidedish.FldTagCaption(2), "No")
		End If
		hidedish.ViewCustomAttributes = ""
		...
		' Vegetarian
		Vegetarian.LinkCustomAttributes = ""
		Vegetarian.HrefValue = ""
		Vegetarian.TooltipValue = ""

		' Spicyness
		Spicyness.LinkCustomAttributes = ""
		Spicyness.HrefValue = ""
		Spicyness.TooltipValue = ""
		...
		' IdMenuCategory
		IdMenuCategory.LinkCustomAttributes = ""
		IdMenuCategory.HrefValue = ""
		IdMenuCategory.TooltipValue = ""
		...
		' Photo
		Photo.LinkCustomAttributes = ""
		Photo.HrefValue = ""
		Photo.TooltipValue = ""

		' allowtoppings
		allowtoppings.LinkCustomAttributes = ""
		allowtoppings.HrefValue = ""
		allowtoppings.TooltipValue = ""
		...
		' hidedish
		hidedish.LinkCustomAttributes = ""
		hidedish.HrefValue = ""
		hidedish.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' Code
		Code.EditAttrs.UpdateAttribute "class", "form-control"
		Code.EditCustomAttributes = ""
		Code.EditValue = Code.CurrentValue
		Code.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Code.FldCaption))
		...
		' Description
		Description.EditAttrs.UpdateAttribute "class", "form-control"
		Description.EditCustomAttributes = ""
		Description.EditValue = Description.CurrentValue
		Description.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Description.FldCaption))

		' Vegetarian
		Vegetarian.EditAttrs.UpdateAttribute "class", "form-control"
		Vegetarian.EditCustomAttributes = ""
		Vegetarian.EditValue = Vegetarian.CurrentValue
		Vegetarian.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Vegetarian.FldCaption))

		' Spicyness
		Spicyness.EditAttrs.UpdateAttribute "class", "form-control"
		Spicyness.EditCustomAttributes = ""
		Spicyness.EditValue = Spicyness.CurrentValue
		Spicyness.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Spicyness.FldCaption))
		...
		' IdMenuCategory
		IdMenuCategory.EditAttrs.UpdateAttribute "class", "form-control"
		IdMenuCategory.EditCustomAttributes = ""
		IdMenuCategory.EditValue = IdMenuCategory.CurrentValue
		IdMenuCategory.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(IdMenuCategory.FldCaption))
		...
		' Photo
		Photo.EditAttrs.UpdateAttribute "class", "form-control"
		Photo.EditCustomAttributes = ""
		Photo.EditValue = Photo.CurrentValue
		Photo.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(Photo.FldCaption))

		' allowtoppings
		allowtoppings.EditAttrs.UpdateAttribute "class", "form-control"
		allowtoppings.EditCustomAttributes = ""
		allowtoppings.EditValue = allowtoppings.CurrentValue
		allowtoppings.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(allowtoppings.FldCaption))
		...
		' hidedish
		hidedish.EditCustomAttributes = ""
		Redim arwrk(1, 1)
		arwrk(0, 0) = hidedish.FldTagValue(1)
		arwrk(1, 0) = ew_IIf(hidedish.FldTagCaption(1) <> "", hidedish.FldTagCaption(1), hidedish.FldTagValue(1))
		arwrk(0, 1) = hidedish.FldTagValue(2)
		arwrk(1, 1) = ew_IIf(hidedish.FldTagCaption(2) <> "", hidedish.FldTagCaption(2), hidedish.FldTagValue(2))
		hidedish.EditValue = arwrk
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("Code", Code.ExportValue(Export))
					Call XmlDoc.AddField("Name", Name.ExportValue(Export))
					Call XmlDoc.AddField("Description", Description.ExportValue(Export))
					Call XmlDoc.AddField("Vegetarian", Vegetarian.ExportValue(Export))
					Call XmlDoc.AddField("Spicyness", Spicyness.ExportValue(Export))
					Call XmlDoc.AddField("Price", Price.ExportValue(Export))
					Call XmlDoc.AddField("IdMenuCategory", IdMenuCategory.ExportValue(Export))
					Call XmlDoc.AddField("IdBusinessDetail", IdBusinessDetail.ExportValue(Export))
					Call XmlDoc.AddField("Photo", Photo.ExportValue(Export))
					Call XmlDoc.AddField("allowtoppings", allowtoppings.ExportValue(Export))
					Call XmlDoc.AddField("dishpropertygroupid", dishpropertygroupid.ExportValue(Export))
					Call XmlDoc.AddField("hidedish", hidedish.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If Code.Exportable Then Call Doc.ExportCaption(Code)
					If Name.Exportable Then Call Doc.ExportCaption(Name)
					If Description.Exportable Then Call Doc.ExportCaption(Description)
					If Vegetarian.Exportable Then Call Doc.ExportCaption(Vegetarian)
					If Spicyness.Exportable Then Call Doc.ExportCaption(Spicyness)
					If Price.Exportable Then Call Doc.ExportCaption(Price)
					If IdMenuCategory.Exportable Then Call Doc.ExportCaption(IdMenuCategory)
					If IdBusinessDetail.Exportable Then Call Doc.ExportCaption(IdBusinessDetail)
					If Photo.Exportable Then Call Doc.ExportCaption(Photo)
					If allowtoppings.Exportable Then Call Doc.ExportCaption(allowtoppings)
					If dishpropertygroupid.Exportable Then Call Doc.ExportCaption(dishpropertygroupid)
					If hidedish.Exportable Then Call Doc.ExportCaption(hidedish)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If Code.Exportable Then Call Doc.ExportField(Code)
						If Name.Exportable Then Call Doc.ExportField(Name)
						If Description.Exportable Then Call Doc.ExportField(Description)
						If Vegetarian.Exportable Then Call Doc.ExportField(Vegetarian)
						If Spicyness.Exportable Then Call Doc.ExportField(Spicyness)
						If Price.Exportable Then Call Doc.ExportField(Price)
						If IdMenuCategory.Exportable Then Call Doc.ExportField(IdMenuCategory)
						If IdBusinessDetail.Exportable Then Call Doc.ExportField(IdBusinessDetail)
						If Photo.Exportable Then Call Doc.ExportField(Photo)
						If allowtoppings.Exportable Then Call Doc.ExportField(allowtoppings)
						If dishpropertygroupid.Exportable Then Call Doc.ExportField(dishpropertygroupid)
						If hidedish.Exportable Then Call Doc.ExportField(hidedish)
...
'			End If
	...
	Public Property Get Id()
		If Not IsObject(m_Id) Then
			Set m_Id = NewFldObj("MenuItems", "MenuItems", "x_Id", "Id", "[Id]", "CAST([Id] AS NVARCHAR)", 3, 0, "[Id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Code()
		If Not IsObject(m_Code) Then
			Set m_Code = NewFldObj("MenuItems", "MenuItems", "x_Code", "Code", "[Code]", "CAST([Code] AS NVARCHAR)", 3, 0, "[Code]", False, False, FALSE, "FORMATTED TEXT")
			m_Code.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set Code = m_Code
	End Property
	...
	Public Property Get Name()
		If Not IsObject(m_Name) Then
			Set m_Name = NewFldObj("MenuItems", "MenuItems", "x_Name", "Name", "[Name]", "[Name]", 202, 0, "[Name]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Name = m_Name
	End Property
	...
	Public Property Get Description()
		If Not IsObject(m_Description) Then
			Set m_Description = NewFldObj("MenuItems", "MenuItems", "x_Description", "Description", "[Description]", "[Description]", 203, 0, "[Description]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Description = m_Description
	End Property

	' Field Vegetarian
	Private m_Vegetarian

	Public Property Get Vegetarian()
		If Not IsObject(m_Vegetarian) Then
			Set m_Vegetarian = NewFldObj("MenuItems", "MenuItems", "x_Vegetarian", "Vegetarian", "[Vegetarian]", "CAST([Vegetarian] AS NVARCHAR)", 3, 0, "[Vegetarian]", False, False, FALSE, "FORMATTED TEXT")
			m_Vegetarian.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set Vegetarian = m_Vegetarian
	End Property

	' Field Spicyness
	Private m_Spicyness

	Public Property Get Spicyness()
		If Not IsObject(m_Spicyness) Then
			Set m_Spicyness = NewFldObj("MenuItems", "MenuItems", "x_Spicyness", "Spicyness", "[Spicyness]", "CAST([Spicyness] AS NVARCHAR)", 2, 0, "[Spicyness]", False, False, FALSE, "FORMATTED TEXT")
			m_Spicyness.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set Spicyness = m_Spicyness
	End Property
	...
	Public Property Get Price()
		If Not IsObject(m_Price) Then
			Set m_Price = NewFldObj("MenuItems", "MenuItems", "x_Price", "Price", "[Price]", "CAST([Price] AS NVARCHAR)", 131, 0, "[Price]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_IdMenuCategory

	Public Property Get IdMenuCategory()
		If Not IsObject(m_IdMenuCategory) Then
			Set m_IdMenuCategory = NewFldObj("MenuItems", "MenuItems", "x_IdMenuCategory", "IdMenuCategory", "[IdMenuCategory]", "CAST([IdMenuCategory] AS NVARCHAR)", 3, 0, "[IdMenuCategory]", False, False, FALSE, "FORMATTED TEXT")
			m_IdMenuCategory.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set IdMenuCategory = m_IdMenuCategory
	End Property
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("MenuItems", "MenuItems", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Photo()
		If Not IsObject(m_Photo) Then
			Set m_Photo = NewFldObj("MenuItems", "MenuItems", "x_Photo", "Photo", "[Photo]", "[Photo]", 202, 0, "[Photo]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Photo = m_Photo
	End Property

	' Field allowtoppings
	Private m_allowtoppings

	Public Property Get allowtoppings()
		If Not IsObject(m_allowtoppings) Then
			Set m_allowtoppings = NewFldObj("MenuItems", "MenuItems", "x_allowtoppings", "allowtoppings", "[allowtoppings]", "CAST([allowtoppings] AS NVARCHAR)", 3, 0, "[allowtoppings]", False, False, FALSE, "FORMATTED TEXT")
			m_allowtoppings.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set allowtoppings = m_allowtoppings
	End Property
	...
	Public Property Get dishpropertygroupid()
		If Not IsObject(m_dishpropertygroupid) Then
			Set m_dishpropertygroupid = NewFldObj("MenuItems", "MenuItems", "x_dishpropertygroupid", "dishpropertygroupid", "[dishpropertygroupid]", "[dishpropertygroupid]", 202, 0, "[dishpropertygroupid]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get hidedish()
		If Not IsObject(m_hidedish) Then
			Set m_hidedish = NewFldObj("MenuItems", "MenuItems", "x_hidedish", "hidedish", "[hidedish]", "[hidedish]", 11, 0, "[hidedish]", False, False, FALSE, "FORMATTED TEXT")
			m_hidedish.FldDataType = EW_DATATYPE_BOOLEAN
		End If
		Set hidedish = m_hidedish
	End Property
	...
	Public Property Get PrintingName()
		If Not IsObject(m_PrintingName) Then
			Set m_PrintingName = NewFldObj("MenuItems", "MenuItems", "x_PrintingName", "PrintingName", "[PrintingName]", "[PrintingName]", 202, 0, "[PrintingName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get i_displaySort()
		If Not IsObject(m_i_displaySort) Then
			Set m_i_displaySort = NewFldObj("MenuItems", "MenuItems", "x_i_displaySort", "i_displaySort", "[i_displaySort]", "CAST([i_displaySort] AS NVARCHAR)", 3, 0, "[i_displaySort]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_Code) Then Set m_Code = Nothing
		If IsObject(m_Name) Then Set m_Name = Nothing
		If IsObject(m_Description) Then Set m_Description = Nothing
		If IsObject(m_Vegetarian) Then Set m_Vegetarian = Nothing
		If IsObject(m_Spicyness) Then Set m_Spicyness = Nothing
		If IsObject(m_Price) Then Set m_Price = Nothing
		If IsObject(m_IdMenuCategory) Then Set m_IdMenuCategory = Nothing
		If IsObject(m_IdBusinessDetail) Then Set m_IdBusinessDetail = Nothing
		If IsObject(m_Photo) Then Set m_Photo = Nothing
		If IsObject(m_allowtoppings) Then Set m_allowtoppings = Nothing
		If IsObject(m_dishpropertygroupid) Then Set m_dishpropertygroupid = Nothing
		If IsObject(m_hidedish) Then Set m_hidedish = Nothing
