...
' ASPMaker configuration for Table MenuDishpropertiesGroups
Dim MenuDishpropertiesGroups

' Define table class
Class cMenuDishpropertiesGroups
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "dishpropertygroup", dishpropertygroup)
		Call ew_SetArObj(Fields, "IdBusinessDetail", IdBusinessDetail)
		Call ew_SetArObj(Fields, "dishpropertypricetype", dishpropertypricetype)
		Call ew_SetArObj(Fields, "dishpropertyrequired", dishpropertyrequired)
	...
	Public Property Get TableVar()
		TableVar = "MenuDishpropertiesGroups"
	End Property
	...
	Public Property Get HighlightName()
		HighlightName = "MenuDishpropertiesGroups_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[MenuDishpropertiesGroups]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "MenuDishpropertiesGroupslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "MenuDishpropertiesGroupslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("MenuDishpropertiesGroupsview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("MenuDishpropertiesGroupsview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "MenuDishpropertiesGroupsadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("MenuDishpropertiesGroupsedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("MenuDishpropertiesGroupsadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("MenuDishpropertiesGroupsdelete.asp", UrlParm(""))
	End Function
	...
	Function UrlParm(parm)
		If UseTokenInUrl Then
			UrlParm = "t=MenuDishpropertiesGroups"
		Else
			UrlParm = ""
		End If
		If parm <> "" Then
	...
	Public Sub LoadListRowValues(RsRow)
		ID.DbValue = RsRow("ID")
		dishpropertygroup.DbValue = RsRow("dishpropertygroup")
		IdBusinessDetail.DbValue = RsRow("IdBusinessDetail")
		dishpropertypricetype.DbValue = RsRow("dishpropertypricetype")
		dishpropertyrequired.DbValue = RsRow("dishpropertyrequired")
	...
	Sub RenderListRow()
		...
		' dishpropertygroup
		dishpropertygroup.ViewValue = dishpropertygroup.CurrentValue
		dishpropertygroup.ViewCustomAttributes = ""
		...
		' dishpropertypricetype
		dishpropertypricetype.ViewValue = dishpropertypricetype.CurrentValue
		dishpropertypricetype.ViewCustomAttributes = ""

		' dishpropertyrequired
		dishpropertyrequired.ViewValue = dishpropertyrequired.CurrentValue
		dishpropertyrequired.ViewCustomAttributes = ""
		...
		' dishpropertygroup
		dishpropertygroup.LinkCustomAttributes = ""
		dishpropertygroup.HrefValue = ""
		dishpropertygroup.TooltipValue = ""
		...
		' dishpropertypricetype
		dishpropertypricetype.LinkCustomAttributes = ""
		dishpropertypricetype.HrefValue = ""
		dishpropertypricetype.TooltipValue = ""

		' dishpropertyrequired
		dishpropertyrequired.LinkCustomAttributes = ""
		dishpropertyrequired.HrefValue = ""
		dishpropertyrequired.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' dishpropertygroup
		dishpropertygroup.EditAttrs.UpdateAttribute "class", "form-control"
		dishpropertygroup.EditCustomAttributes = ""
		dishpropertygroup.EditValue = dishpropertygroup.CurrentValue
		dishpropertygroup.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(dishpropertygroup.FldCaption))
		...
		' dishpropertypricetype
		dishpropertypricetype.EditAttrs.UpdateAttribute "class", "form-control"
		dishpropertypricetype.EditCustomAttributes = ""
		dishpropertypricetype.EditValue = dishpropertypricetype.CurrentValue
		dishpropertypricetype.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(dishpropertypricetype.FldCaption))

		' dishpropertyrequired
		dishpropertyrequired.EditAttrs.UpdateAttribute "class", "form-control"
		dishpropertyrequired.EditCustomAttributes = ""
		dishpropertyrequired.EditValue = dishpropertyrequired.CurrentValue
		dishpropertyrequired.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(dishpropertyrequired.FldCaption))
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("dishpropertygroup", dishpropertygroup.ExportValue(Export))
					Call XmlDoc.AddField("IdBusinessDetail", IdBusinessDetail.ExportValue(Export))
					Call XmlDoc.AddField("dishpropertypricetype", dishpropertypricetype.ExportValue(Export))
					Call XmlDoc.AddField("dishpropertyrequired", dishpropertyrequired.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If dishpropertygroup.Exportable Then Call Doc.ExportCaption(dishpropertygroup)
					If IdBusinessDetail.Exportable Then Call Doc.ExportCaption(IdBusinessDetail)
					If dishpropertypricetype.Exportable Then Call Doc.ExportCaption(dishpropertypricetype)
					If dishpropertyrequired.Exportable Then Call Doc.ExportCaption(dishpropertyrequired)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If dishpropertygroup.Exportable Then Call Doc.ExportField(dishpropertygroup)
						If IdBusinessDetail.Exportable Then Call Doc.ExportField(IdBusinessDetail)
						If dishpropertypricetype.Exportable Then Call Doc.ExportField(dishpropertypricetype)
						If dishpropertyrequired.Exportable Then Call Doc.ExportField(dishpropertyrequired)
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_dishpropertygroup

	Public Property Get dishpropertygroup()
		If Not IsObject(m_dishpropertygroup) Then
			Set m_dishpropertygroup = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_dishpropertygroup", "dishpropertygroup", "[dishpropertygroup]", "[dishpropertygroup]", 202, 0, "[dishpropertygroup]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set dishpropertygroup = m_dishpropertygroup
	End Property
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_dishpropertypricetype

	Public Property Get dishpropertypricetype()
		If Not IsObject(m_dishpropertypricetype) Then
			Set m_dishpropertypricetype = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_dishpropertypricetype", "dishpropertypricetype", "[dishpropertypricetype]", "[dishpropertypricetype]", 202, 0, "[dishpropertypricetype]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set dishpropertypricetype = m_dishpropertypricetype
	End Property

	' Field dishpropertyrequired
	Private m_dishpropertyrequired

	Public Property Get dishpropertyrequired()
		If Not IsObject(m_dishpropertyrequired) Then
			Set m_dishpropertyrequired = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_dishpropertyrequired", "dishpropertyrequired", "[dishpropertyrequired]", "CAST([dishpropertyrequired] AS NVARCHAR)", 3, 0, "[dishpropertyrequired]", False, False, FALSE, "FORMATTED TEXT")
			m_dishpropertyrequired.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set dishpropertyrequired = m_dishpropertyrequired
	End Property
	...
	Public Property Get printingname()
		If Not IsObject(m_printingname) Then
			Set m_printingname = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_printingname", "printingname", "[printingname]", "[printingname]", 202, 0, "[printingname]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get i_displaySort()
		If Not IsObject(m_i_displaySort) Then
			Set m_i_displaySort = NewFldObj("MenuDishpropertiesGroups", "MenuDishpropertiesGroups", "x_i_displaySort", "i_displaySort", "[i_displaySort]", "CAST([i_displaySort] AS NVARCHAR)", 3, 0, "[i_displaySort]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_dishpropertygroup) Then Set m_dishpropertygroup = Nothing
		If IsObject(m_IdBusinessDetail) Then Set m_IdBusinessDetail = Nothing
		If IsObject(m_dishpropertypricetype) Then Set m_dishpropertypricetype = Nothing
		If IsObject(m_dishpropertyrequired) Then Set m_dishpropertyrequired = Nothing
