...
' Define page object
Dim OrdersLocal_add
Set OrdersLocal_add = New cOrdersLocal_add
Set Page = OrdersLocal_add

' Page init processing
OrdersLocal_add.Page_Init()

' Page main processing
OrdersLocal_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
OrdersLocal_add.Page_Render()
%>
<!--#include file="header.asp"-->
<script type="text/javascript">
// Page object
var OrdersLocal_add = new ew_Page("OrdersLocal_add");
OrdersLocal_add.PageID = "add"; // Page ID
var EW_PAGE_ID = OrdersLocal_add.PageID; // For backward compatibility
// Form object
var fOrdersLocaladd = new ew_Form("fOrdersLocaladd");
// Validate form
fOrdersLocaladd.Validate = function() {
...
fOrdersLocaladd.Form_CustomValidate = 
...
fOrdersLocaladd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fOrdersLocaladd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% OrdersLocal_add.ShowPageHeader() %>
<% OrdersLocal_add.ShowMessage %>
<form name="fOrdersLocaladd" id="fOrdersLocaladd" class="form-horizontal ewForm ewAddForm" action="<%= ew_CurrentPage() %>" method="post">
<% If OrdersLocal_add.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= OrdersLocal_add.Token %>">
<% End If %>
...
<script type="text/javascript">
fOrdersLocaladd.Init();
</script>
<%
OrdersLocal_add.ShowPageFooter()
...
Class cOrdersLocal_add
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			OrdersLocal.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("ID").Count > 0 Then
				...
				Call OrdersLocal.SetKey("ID", OrdersLocal.ID.CurrentValue) ' Set up key
			Else
				Call OrdersLocal.SetKey("ID", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
				OrdersLocal.CurrentAction = "C" ' Copy Record
			Else
				OrdersLocal.CurrentAction = "I" ' Display Blank Record
		...
		Select Case OrdersLocal.CurrentAction
			...
			Case "A" ' Add new record
				OrdersLocal.SendEmail = True ' Send email on add success
				If AddRow(OldRecordset) Then ' Add successful
					...
					If ew_GetPageName(sReturnUrl) = "OrdersLocalview.asp" Then sReturnUrl = OrdersLocal.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		OrdersLocal.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Function LoadDefaultValues()
		...
		OrdersLocal.CreationDate.OldValue = OrdersLocal.CreationDate.CurrentValue
		OrdersLocal.OrderDate.CurrentValue = Null
		OrdersLocal.OrderDate.OldValue = OrdersLocal.OrderDate.CurrentValue
		OrdersLocal.DeliveryType.CurrentValue = Null
		OrdersLocal.DeliveryType.OldValue = OrdersLocal.DeliveryType.CurrentValue
		OrdersLocal.DeliveryTime.CurrentValue = Null
		OrdersLocal.DeliveryTime.OldValue = OrdersLocal.DeliveryTime.CurrentValue
		OrdersLocal.PaymentType.CurrentValue = Null
		OrdersLocal.PaymentType.OldValue = OrdersLocal.PaymentType.CurrentValue
		OrdersLocal.SubTotal.CurrentValue = Null
		OrdersLocal.SubTotal.OldValue = OrdersLocal.SubTotal.CurrentValue
		OrdersLocal.ShippingFee.CurrentValue = Null
		OrdersLocal.ShippingFee.OldValue = OrdersLocal.ShippingFee.CurrentValue
		OrdersLocal.OrderTotal.CurrentValue = Null
		OrdersLocal.OrderTotal.OldValue = OrdersLocal.OrderTotal.CurrentValue
		OrdersLocal.IdBusinessDetail.CurrentValue = Null
		OrdersLocal.IdBusinessDetail.OldValue = OrdersLocal.IdBusinessDetail.CurrentValue
		OrdersLocal.SessionId.CurrentValue = Null
		OrdersLocal.SessionId.OldValue = OrdersLocal.SessionId.CurrentValue
		OrdersLocal.FirstName.CurrentValue = Null
		OrdersLocal.FirstName.OldValue = OrdersLocal.FirstName.CurrentValue
		OrdersLocal.LastName.CurrentValue = Null
		OrdersLocal.LastName.OldValue = OrdersLocal.LastName.CurrentValue
		OrdersLocal.zEmail.CurrentValue = Null
		OrdersLocal.zEmail.OldValue = OrdersLocal.zEmail.CurrentValue
		OrdersLocal.Phone.CurrentValue = Null
		OrdersLocal.Phone.OldValue = OrdersLocal.Phone.CurrentValue
		OrdersLocal.Address.CurrentValue = Null
		OrdersLocal.Address.OldValue = OrdersLocal.Address.CurrentValue
		OrdersLocal.PostalCode.CurrentValue = Null
		OrdersLocal.PostalCode.OldValue = OrdersLocal.PostalCode.CurrentValue
		OrdersLocal.Notes.CurrentValue = Null
		OrdersLocal.Notes.OldValue = OrdersLocal.Notes.CurrentValue
		OrdersLocal.ttest.CurrentValue = Null
		OrdersLocal.ttest.OldValue = OrdersLocal.ttest.CurrentValue
		OrdersLocal.cancelleddate.CurrentValue = Null
		OrdersLocal.cancelleddate.OldValue = OrdersLocal.cancelleddate.CurrentValue
		OrdersLocal.cancelledby.CurrentValue = Null
		OrdersLocal.cancelledby.OldValue = OrdersLocal.cancelledby.CurrentValue
		OrdersLocal.cancelledreason.CurrentValue = Null
		OrdersLocal.cancelledreason.OldValue = OrdersLocal.cancelledreason.CurrentValue
		OrdersLocal.acknowledgeddate.CurrentValue = Null
		OrdersLocal.acknowledgeddate.OldValue = OrdersLocal.acknowledgeddate.CurrentValue
		OrdersLocal.delivereddate.CurrentValue = Null
		OrdersLocal.delivereddate.OldValue = OrdersLocal.delivereddate.CurrentValue
		OrdersLocal.cancelled.CurrentValue = Null
		OrdersLocal.cancelled.OldValue = OrdersLocal.cancelled.CurrentValue
		OrdersLocal.acknowledged.CurrentValue = Null
		OrdersLocal.acknowledged.OldValue = OrdersLocal.acknowledged.CurrentValue
		OrdersLocal.outfordelivery.CurrentValue = Null
		OrdersLocal.outfordelivery.OldValue = OrdersLocal.outfordelivery.CurrentValue
		OrdersLocal.vouchercodediscount.CurrentValue = Null
		OrdersLocal.vouchercodediscount.OldValue = OrdersLocal.vouchercodediscount.CurrentValue
		OrdersLocal.vouchercode.CurrentValue = Null
		OrdersLocal.vouchercode.OldValue = OrdersLocal.vouchercode.CurrentValue
		OrdersLocal.printed.CurrentValue = Null
		OrdersLocal.printed.OldValue = OrdersLocal.printed.CurrentValue
		OrdersLocal.deliverydistance.CurrentValue = Null
		OrdersLocal.deliverydistance.OldValue = OrdersLocal.deliverydistance.CurrentValue
		OrdersLocal.asaporder.CurrentValue = Null
		OrdersLocal.asaporder.OldValue = OrdersLocal.asaporder.CurrentValue
		OrdersLocal.DeliveryLat.CurrentValue = Null
		OrdersLocal.DeliveryLat.OldValue = OrdersLocal.DeliveryLat.CurrentValue
		OrdersLocal.DeliveryLng.CurrentValue = Null
		OrdersLocal.DeliveryLng.OldValue = OrdersLocal.DeliveryLng.CurrentValue
		OrdersLocal.ServiceCharge.CurrentValue = Null
		OrdersLocal.ServiceCharge.OldValue = OrdersLocal.ServiceCharge.CurrentValue
		OrdersLocal.PaymentSurcharge.CurrentValue = Null
		OrdersLocal.PaymentSurcharge.OldValue = OrdersLocal.PaymentSurcharge.CurrentValue
		OrdersLocal.Tax_Rate.CurrentValue = Null
		OrdersLocal.Tax_Rate.OldValue = OrdersLocal.Tax_Rate.CurrentValue
		OrdersLocal.Tax_Amount.CurrentValue = Null
		OrdersLocal.Tax_Amount.OldValue = OrdersLocal.Tax_Amount.CurrentValue
		OrdersLocal.Tip_Rate.CurrentValue = Null
		OrdersLocal.Tip_Rate.OldValue = OrdersLocal.Tip_Rate.CurrentValue
		OrdersLocal.Tip_Amount.CurrentValue = Null
		OrdersLocal.Tip_Amount.OldValue = OrdersLocal.Tip_Amount.CurrentValue
		OrdersLocal.Payment_status.CurrentValue = Null
		OrdersLocal.Payment_status.OldValue = OrdersLocal.Payment_status.CurrentValue
	End Function
	...
	Sub RenderRow()
		...
		ElseIf OrdersLocal.RowType = EW_ROWTYPE_ADD Then ' Add row
	...
	Function AddRow(RsOld)
		...
		' Field CreationDate
		Call OrdersLocal.CreationDate.SetDbValue(Rs, OrdersLocal.CreationDate.CurrentValue, Null, False)

		' Field OrderDate
		Call OrdersLocal.OrderDate.SetDbValue(Rs, OrdersLocal.OrderDate.CurrentValue, Null, False)

		' Field DeliveryType
		Call OrdersLocal.DeliveryType.SetDbValue(Rs, OrdersLocal.DeliveryType.CurrentValue, Null, False)

		' Field DeliveryTime
		Call OrdersLocal.DeliveryTime.SetDbValue(Rs, OrdersLocal.DeliveryTime.CurrentValue, Null, False)

		' Field PaymentType
		Call OrdersLocal.PaymentType.SetDbValue(Rs, OrdersLocal.PaymentType.CurrentValue, Null, False)

		' Field SubTotal
		Call OrdersLocal.SubTotal.SetDbValue(Rs, OrdersLocal.SubTotal.CurrentValue, Null, False)

		' Field ShippingFee
		Call OrdersLocal.ShippingFee.SetDbValue(Rs, OrdersLocal.ShippingFee.CurrentValue, Null, False)

		' Field OrderTotal
		Call OrdersLocal.OrderTotal.SetDbValue(Rs, OrdersLocal.OrderTotal.CurrentValue, Null, False)

		' Field IdBusinessDetail
		Call OrdersLocal.IdBusinessDetail.SetDbValue(Rs, OrdersLocal.IdBusinessDetail.CurrentValue, Null, False)

		' Field SessionId
		Call OrdersLocal.SessionId.SetDbValue(Rs, OrdersLocal.SessionId.CurrentValue, Null, False)

		' Field FirstName
		Call OrdersLocal.FirstName.SetDbValue(Rs, OrdersLocal.FirstName.CurrentValue, Null, False)

		' Field LastName
		Call OrdersLocal.LastName.SetDbValue(Rs, OrdersLocal.LastName.CurrentValue, Null, False)

		' Field Email
		Call OrdersLocal.zEmail.SetDbValue(Rs, OrdersLocal.zEmail.CurrentValue, Null, False)

		' Field Phone
		Call OrdersLocal.Phone.SetDbValue(Rs, OrdersLocal.Phone.CurrentValue, Null, False)

		' Field Address
		Call OrdersLocal.Address.SetDbValue(Rs, OrdersLocal.Address.CurrentValue, Null, False)

		' Field PostalCode
		Call OrdersLocal.PostalCode.SetDbValue(Rs, OrdersLocal.PostalCode.CurrentValue, Null, False)

		' Field Notes
		Call OrdersLocal.Notes.SetDbValue(Rs, OrdersLocal.Notes.CurrentValue, Null, False)

		' Field ttest
		Call OrdersLocal.ttest.SetDbValue(Rs, OrdersLocal.ttest.CurrentValue, Null, False)

		' Field cancelleddate
		Call OrdersLocal.cancelleddate.SetDbValue(Rs, OrdersLocal.cancelleddate.CurrentValue, Null, False)

		' Field cancelledby
		Call OrdersLocal.cancelledby.SetDbValue(Rs, OrdersLocal.cancelledby.CurrentValue, Null, False)

		' Field cancelledreason
		Call OrdersLocal.cancelledreason.SetDbValue(Rs, OrdersLocal.cancelledreason.CurrentValue, Null, False)

		' Field acknowledgeddate
		Call OrdersLocal.acknowledgeddate.SetDbValue(Rs, OrdersLocal.acknowledgeddate.CurrentValue, Null, False)

		' Field delivereddate
		Call OrdersLocal.delivereddate.SetDbValue(Rs, OrdersLocal.delivereddate.CurrentValue, Null, False)

		' Field cancelled
		Call OrdersLocal.cancelled.SetDbValue(Rs, OrdersLocal.cancelled.CurrentValue, Null, False)

		' Field acknowledged
		Call OrdersLocal.acknowledged.SetDbValue(Rs, OrdersLocal.acknowledged.CurrentValue, Null, False)

		' Field outfordelivery
		Call OrdersLocal.outfordelivery.SetDbValue(Rs, OrdersLocal.outfordelivery.CurrentValue, Null, False)

		' Field vouchercodediscount
		Call OrdersLocal.vouchercodediscount.SetDbValue(Rs, OrdersLocal.vouchercodediscount.CurrentValue, Null, False)

		' Field vouchercode
		Call OrdersLocal.vouchercode.SetDbValue(Rs, OrdersLocal.vouchercode.CurrentValue, Null, False)

		' Field printed
		Call OrdersLocal.printed.SetDbValue(Rs, OrdersLocal.printed.CurrentValue, Null, False)

		' Field deliverydistance
		Call OrdersLocal.deliverydistance.SetDbValue(Rs, OrdersLocal.deliverydistance.CurrentValue, Null, False)

		' Field asaporder
		Call OrdersLocal.asaporder.SetDbValue(Rs, OrdersLocal.asaporder.CurrentValue, Null, False)

		' Field DeliveryLat
		Call OrdersLocal.DeliveryLat.SetDbValue(Rs, OrdersLocal.DeliveryLat.CurrentValue, Null, False)

		' Field DeliveryLng
		Call OrdersLocal.DeliveryLng.SetDbValue(Rs, OrdersLocal.DeliveryLng.CurrentValue, Null, False)

		' Field ServiceCharge
		Call OrdersLocal.ServiceCharge.SetDbValue(Rs, OrdersLocal.ServiceCharge.CurrentValue, Null, False)

		' Field PaymentSurcharge
		Call OrdersLocal.PaymentSurcharge.SetDbValue(Rs, OrdersLocal.PaymentSurcharge.CurrentValue, Null, False)

		' Field Tax_Rate
		Call OrdersLocal.Tax_Rate.SetDbValue(Rs, OrdersLocal.Tax_Rate.CurrentValue, Null, False)

		' Field Tax_Amount
		Call OrdersLocal.Tax_Amount.SetDbValue(Rs, OrdersLocal.Tax_Amount.CurrentValue, Null, False)

		' Field Tip_Rate
		Call OrdersLocal.Tip_Rate.SetDbValue(Rs, OrdersLocal.Tip_Rate.CurrentValue, Null, False)

		' Field Tip_Amount
		Call OrdersLocal.Tip_Amount.SetDbValue(Rs, OrdersLocal.Tip_Amount.CurrentValue, Null, False)

		' Field Payment_status
		Call OrdersLocal.Payment_status.SetDbValue(Rs, OrdersLocal.Payment_status.CurrentValue, Null, False)
		...
		bInsertRow = OrdersLocal.Row_Inserting(RsOld, Rs)
		If bInsertRow Then
		...
		Set Rs = Nothing
		If AddRow Then
			OrdersLocal.ID.DbValue = RsNew("ID")
		End If
		If AddRow Then

			' Call Row Inserted event
			Call OrdersLocal.Row_Inserted(RsOld, RsNew)
		End If
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(OrdersLocal.CurrentAction = "C", "Copy", "Add")
