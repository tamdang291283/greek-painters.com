...
' Define page object
Dim MenuDishproperties_view
Set MenuDishproperties_view = New cMenuDishproperties_view
Set Page = MenuDishproperties_view

' Page init processing
MenuDishproperties_view.Page_Init()

' Page main processing
MenuDishproperties_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
MenuDishproperties_view.Page_Render()
%>
<!--#include file="header.asp"-->
<% If MenuDishproperties.Export = "" Then %>
<script type="text/javascript">
// Page object
var MenuDishproperties_view = new ew_Page("MenuDishproperties_view");
MenuDishproperties_view.PageID = "view"; // Page ID
var EW_PAGE_ID = MenuDishproperties_view.PageID; // For backward compatibility
// Form object
var fMenuDishpropertiesview = new ew_Form("fMenuDishpropertiesview");
// Form_CustomValidate event
fMenuDishpropertiesview.Form_CustomValidate = 
...
fMenuDishpropertiesview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fMenuDishpropertiesview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% End If %>
<%
	MenuDishproperties_view.ExportOptions.Render "body", "", "", "", "", ""
	MenuDishproperties_view.ActionOptions.Render "body", "", "", "", "", ""
	MenuDishproperties_view.DetailOptions.Render "body", "", "", "", "", ""
%>
<% If MenuDishproperties.Export = "" Then %>
...
<% End If %>
<% MenuDishproperties_view.ShowPageHeader() %>
<% MenuDishproperties_view.ShowMessage %>
<% If MenuDishproperties.Export = "" Then %>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<%= ew_CurrentPage %>">
<% If Not IsObject(MenuDishproperties_view.Pager) Then Set MenuDishproperties_view.Pager = ew_NewPrevNextPager(MenuDishproperties_view.StartRec, MenuDishproperties_view.DisplayRecs, MenuDishproperties_view.TotalRecs) %>
<% If MenuDishproperties_view.Pager.RecordCount > 0 Then %>
<div class="ewPager">
<span><%= Language.Phrase("Page") %>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<% If MenuDishproperties_view.Pager.FirstButton.Enabled Then %>
	<a class="btn btn-default btn-sm" title="<%= Language.Phrase("PagerFirst") %>" href="<%= MenuDishproperties_view.PageUrl %>start=<%= MenuDishproperties_view.Pager.FirstButton.Start %>"><span class="icon-first ewIcon"></span></a>
	<% Else %>
	<a class="btn btn-default btn-sm disabled" title="<%= Language.Phrase("PagerFirst") %>"><span class="icon-first ewIcon"></span></a>
	<% End If %>
<!--previous page button-->
	<% If MenuDishproperties_view.Pager.PrevButton.Enabled Then %>
	<a class="btn btn-default btn-sm" title="<%= Language.Phrase("PagerPrevious") %>" href="<%= MenuDishproperties_view.PageUrl %>start=<%= MenuDishproperties_view.Pager.PrevButton.Start %>"><span class="icon-prev ewIcon"></span></a>
	<% Else %>
	<a class="btn btn-default btn-sm disabled" title="<%= Language.Phrase("PagerPrevious") %>"><span class="icon-prev ewIcon"></span></a>
	<% End If %>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<%= EW_TABLE_PAGE_NO %>" value="<%= MenuDishproperties_view.Pager.CurrentPage %>">
<div class="input-group-btn">
<!--next page button-->
	<% If MenuDishproperties_view.Pager.NextButton.Enabled Then %>
	<a class="btn btn-default btn-sm" title="<%= Language.Phrase("PagerNext") %>" href="<%= MenuDishproperties_view.PageUrl %>start=<%= MenuDishproperties_view.Pager.NextButton.Start %>"><span class="icon-next ewIcon"></span></a>
	<% Else %>
	<a class="btn btn-default btn-sm disabled" title="<%= Language.Phrase("PagerNext") %>"><span class="icon-next ewIcon"></span></a>
	<% End If %>
<!--last page button-->
	<% If MenuDishproperties_view.Pager.LastButton.Enabled Then %>
	<a class="btn btn-default btn-sm" title="<%= Language.Phrase("PagerLast") %>" href="<%= MenuDishproperties_view.PageUrl %>start=<%= MenuDishproperties_view.Pager.LastButton.Start %>"><span class="icon-last ewIcon"></span></a>
	<% Else %>
...
<span>&nbsp;<%= Language.Phrase("of") %>&nbsp;<%= MenuDishproperties_view.Pager.PageCount %></span>
</div>
<% End If %>
<div class="clearfix"></div>
</form>
<% End If %>
<form name="fMenuDishpropertiesview" id="fMenuDishpropertiesview" class="form-inline ewForm ewViewForm" action="<%= ew_CurrentPage %>" method="post">
<% If MenuDishproperties_view.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= MenuDishproperties_view.Token %>">
<% End If %>
<input type="hidden" name="t" value="MenuDishproperties">
<table class="table table-bordered table-striped ewViewTable">
<% If MenuDishproperties.ID.Visible Then ' ID %>
	<tr id="r_ID">
		<td><span id="elh_MenuDishproperties_ID"><%= MenuDishproperties.ID.FldCaption %></span></td>
		<td<%= MenuDishproperties.ID.CellAttributes %>>
<span id="el_MenuDishproperties_ID" class="form-group">
<span<%= MenuDishproperties.ID.ViewAttributes %>>
<%= MenuDishproperties.ID.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.dishproperty.Visible Then ' dishproperty %>
	<tr id="r_dishproperty">
		<td><span id="elh_MenuDishproperties_dishproperty"><%= MenuDishproperties.dishproperty.FldCaption %></span></td>
		<td<%= MenuDishproperties.dishproperty.CellAttributes %>>
<span id="el_MenuDishproperties_dishproperty" class="form-group">
<span<%= MenuDishproperties.dishproperty.ViewAttributes %>>
<%= MenuDishproperties.dishproperty.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.dishpropertyprice.Visible Then ' dishpropertyprice %>
	<tr id="r_dishpropertyprice">
		<td><span id="elh_MenuDishproperties_dishpropertyprice"><%= MenuDishproperties.dishpropertyprice.FldCaption %></span></td>
		<td<%= MenuDishproperties.dishpropertyprice.CellAttributes %>>
<span id="el_MenuDishproperties_dishpropertyprice" class="form-group">
<span<%= MenuDishproperties.dishpropertyprice.ViewAttributes %>>
<%= MenuDishproperties.dishpropertyprice.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.IdBusinessDetail.Visible Then ' IdBusinessDetail %>
	<tr id="r_IdBusinessDetail">
		<td><span id="elh_MenuDishproperties_IdBusinessDetail"><%= MenuDishproperties.IdBusinessDetail.FldCaption %></span></td>
		<td<%= MenuDishproperties.IdBusinessDetail.CellAttributes %>>
<span id="el_MenuDishproperties_IdBusinessDetail" class="form-group">
<span<%= MenuDishproperties.IdBusinessDetail.ViewAttributes %>>
<%= MenuDishproperties.IdBusinessDetail.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.dishpropertygroupid.Visible Then ' dishpropertygroupid %>
	<tr id="r_dishpropertygroupid">
		<td><span id="elh_MenuDishproperties_dishpropertygroupid"><%= MenuDishproperties.dishpropertygroupid.FldCaption %></span></td>
		<td<%= MenuDishproperties.dishpropertygroupid.CellAttributes %>>
<span id="el_MenuDishproperties_dishpropertygroupid" class="form-group">
<span<%= MenuDishproperties.dishpropertygroupid.ViewAttributes %>>
<%= MenuDishproperties.dishpropertygroupid.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.printingname.Visible Then ' printingname %>
	<tr id="r_printingname">
		<td><span id="elh_MenuDishproperties_printingname"><%= MenuDishproperties.printingname.FldCaption %></span></td>
		<td<%= MenuDishproperties.printingname.CellAttributes %>>
<span id="el_MenuDishproperties_printingname" class="form-group">
<span<%= MenuDishproperties.printingname.ViewAttributes %>>
<%= MenuDishproperties.printingname.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.i_displaySort.Visible Then ' i_displaySort %>
	<tr id="r_i_displaySort">
		<td><span id="elh_MenuDishproperties_i_displaySort"><%= MenuDishproperties.i_displaySort.FldCaption %></span></td>
		<td<%= MenuDishproperties.i_displaySort.CellAttributes %>>
<span id="el_MenuDishproperties_i_displaySort" class="form-group">
<span<%= MenuDishproperties.i_displaySort.ViewAttributes %>>
<%= MenuDishproperties.i_displaySort.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<% If MenuDishproperties.Export <> "" Then %>
<script type="text/javascript">
ew_ApplyTemplate("body", "", "MenuDishpropertiesview", "<%= MenuDishproperties.CustomExport %>");
</script>
<% End If %>
<script type="text/javascript">
fMenuDishpropertiesview.Init();
</script>
<%
MenuDishproperties_view.ShowPageFooter()
...
' Drop page object
Set MenuDishproperties_view = Nothing
%>
<%
...
' Page Class
'
Class cMenuDishproperties_view
	...
	Public Property Get PageObjName()
		PageObjName = "MenuDishproperties_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			ElseIf Request.Form("ID").Count > 0 Then
				MenuDishproperties.ID.FormValue = Request.Form("ID")
			Else
				bLoadCurrentRecord = True
			End If

			' Get action
			MenuDishproperties.CurrentAction = "I" ' Display form
			Select Case MenuDishproperties.CurrentAction
				Case "I" ' Get a record to display
					...
					If TotalRecs <= 0 Then ' No record found
						...
						End If
						sReturnUrl = "MenuDishpropertieslist.asp"
					...
					Else ' Match key values
						Do While Not Recordset.Eof
							If CStr(MenuDishproperties.ID.CurrentValue&"") = CStr(Recordset("ID")&"") Then
								MenuDishproperties.StartRecordNumber = StartRec ' Save record position
								bMatchRecord = True
								Exit Do
							Else
								StartRec = StartRec + 1
					...
					If Not bMatchRecord Then
						If SuccessMessage = "" And FailureMessage = "" Then
							FailureMessage = Language.Phrase("NoRecord") ' Set no record message
						End If
						sReturnUrl = "MenuDishpropertieslist.asp" ' No matching record, return to list
					Else
						Call LoadRowValues(Recordset) ' Load row values
					End If
			End Select
		Else
			sReturnUrl = "MenuDishpropertieslist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		MenuDishproperties.RowType = EW_ROWTYPE_VIEW
