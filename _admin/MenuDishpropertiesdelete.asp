...
' Define page object
Dim MenuDishproperties_delete
Set MenuDishproperties_delete = New cMenuDishproperties_delete
Set Page = MenuDishproperties_delete

' Page init processing
MenuDishproperties_delete.Page_Init()

' Page main processing
MenuDishproperties_delete.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
MenuDishproperties_delete.Page_Render()
%>
<!--#include file="header.asp"-->
<script type="text/javascript">
// Page object
var MenuDishproperties_delete = new ew_Page("MenuDishproperties_delete");
MenuDishproperties_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = MenuDishproperties_delete.PageID; // For backward compatibility
// Form object
var fMenuDishpropertiesdelete = new ew_Form("fMenuDishpropertiesdelete");
// Form_CustomValidate event
fMenuDishpropertiesdelete.Form_CustomValidate = 
...
fMenuDishpropertiesdelete.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fMenuDishpropertiesdelete.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
Set MenuDishproperties_delete.Recordset = MenuDishproperties_delete.LoadRecordset()
MenuDishproperties_delete.TotalRecs = MenuDishproperties_delete.Recordset.RecordCount ' Get record count
If MenuDishproperties_delete.TotalRecs <= 0 Then ' No record found, exit
	MenuDishproperties_delete.Recordset.Close
	Set MenuDishproperties_delete.Recordset = Nothing
	Call MenuDishproperties_delete.Page_Terminate("MenuDishpropertieslist.asp") ' Return to list
End If
%>
<div class="ewToolbar">
...
<% MenuDishproperties_delete.ShowPageHeader() %>
<% MenuDishproperties_delete.ShowMessage %>
<form name="fMenuDishpropertiesdelete" id="fMenuDishpropertiesdelete" class="form-inline ewForm ewDeleteForm" action="<%= ew_CurrentPage() %>" method="post">
<% If MenuDishproperties_delete.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= MenuDishproperties_delete.Token %>">
<% End If %>
<input type="hidden" name="t" value="MenuDishproperties">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<% For i = 0 to UBound(MenuDishproperties_delete.RecKeys) %>
<input type="hidden" name="key_m" id="key_m" value="<%= ew_HtmlEncode(ew_GetKeyValue(MenuDishproperties_delete.RecKeys(i))) %>">
<% Next %>
<div class="ewGrid">
...
<% If MenuDishproperties.ID.Visible Then ' ID %>
		<th><span id="elh_MenuDishproperties_ID" class="MenuDishproperties_ID"><%= MenuDishproperties.ID.FldCaption %></span></th>
<% End If %>
<% If MenuDishproperties.dishproperty.Visible Then ' dishproperty %>
		<th><span id="elh_MenuDishproperties_dishproperty" class="MenuDishproperties_dishproperty"><%= MenuDishproperties.dishproperty.FldCaption %></span></th>
<% End If %>
<% If MenuDishproperties.dishpropertyprice.Visible Then ' dishpropertyprice %>
		<th><span id="elh_MenuDishproperties_dishpropertyprice" class="MenuDishproperties_dishpropertyprice"><%= MenuDishproperties.dishpropertyprice.FldCaption %></span></th>
<% End If %>
<% If MenuDishproperties.IdBusinessDetail.Visible Then ' IdBusinessDetail %>
		<th><span id="elh_MenuDishproperties_IdBusinessDetail" class="MenuDishproperties_IdBusinessDetail"><%= MenuDishproperties.IdBusinessDetail.FldCaption %></span></th>
<% End If %>
<% If MenuDishproperties.dishpropertygroupid.Visible Then ' dishpropertygroupid %>
		<th><span id="elh_MenuDishproperties_dishpropertygroupid" class="MenuDishproperties_dishpropertygroupid"><%= MenuDishproperties.dishpropertygroupid.FldCaption %></span></th>
<% End If %>
<% If MenuDishproperties.printingname.Visible Then ' printingname %>
		<th><span id="elh_MenuDishproperties_printingname" class="MenuDishproperties_printingname"><%= MenuDishproperties.printingname.FldCaption %></span></th>
<% End If %>
<% If MenuDishproperties.i_displaySort.Visible Then ' i_displaySort %>
		<th><span id="elh_MenuDishproperties_i_displaySort" class="MenuDishproperties_i_displaySort"><%= MenuDishproperties.i_displaySort.FldCaption %></span></th>
<% End If %>
	</tr>
	</thead>
	<tbody>
<%
MenuDishproperties_delete.RecCnt = 0
MenuDishproperties_delete.RowCnt = 0
Do While (Not MenuDishproperties_delete.Recordset.Eof)
	MenuDishproperties_delete.RecCnt = MenuDishproperties_delete.RecCnt + 1
	MenuDishproperties_delete.RowCnt = MenuDishproperties_delete.RowCnt + 1

	' Set row properties
	Call MenuDishproperties.ResetAttrs()
	MenuDishproperties.RowType = EW_ROWTYPE_VIEW ' view

	' Get the field contents
	Call MenuDishproperties_delete.LoadRowValues(MenuDishproperties_delete.Recordset)

	' Render row
	Call MenuDishproperties_delete.RenderRow()
%>
	<tr<%= MenuDishproperties.RowAttributes %>>
<% If MenuDishproperties.ID.Visible Then ' ID %>
		<td<%= MenuDishproperties.ID.CellAttributes %>>
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_ID" class="form-group MenuDishproperties_ID">
...
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_dishproperty" class="form-group MenuDishproperties_dishproperty">
...
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_dishpropertyprice" class="form-group MenuDishproperties_dishpropertyprice">
...
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_IdBusinessDetail" class="form-group MenuDishproperties_IdBusinessDetail">
...
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_dishpropertygroupid" class="form-group MenuDishproperties_dishpropertygroupid">
...
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_printingname" class="form-group MenuDishproperties_printingname">
...
<span id="el<%= MenuDishproperties_delete.RowCnt %>_MenuDishproperties_i_displaySort" class="form-group MenuDishproperties_i_displaySort">
...
<%
	MenuDishproperties_delete.Recordset.MoveNext
Loop
MenuDishproperties_delete.Recordset.Close
Set MenuDishproperties_delete.Recordset = Nothing
%>
...
<script type="text/javascript">
fMenuDishpropertiesdelete.Init();
</script>
<%
MenuDishproperties_delete.ShowPageFooter()
...
' Drop page object
Set MenuDishproperties_delete = Nothing
%>
<%
...
' Page Class
'
Class cMenuDishproperties_delete
	...
	Public Property Get PageObjName()
		PageObjName = "MenuDishproperties_delete"
	End Property
	...
	Sub Page_Main()
		...
		If sFilter = "" Then
			Call Page_Terminate("MenuDishpropertieslist.asp") ' Prevent SQL injection, return to list
		End If

		' Set up filter (Sql Where Clause) and get Return Sql
		' Sql constructor in MenuDishproperties class, MenuDishpropertiesinfo.asp

		MenuDishproperties.CurrentFilter = sFilter

		' Get action
		If Request.Form("a_delete").Count > 0 Then
			MenuDishproperties.CurrentAction = Request.Form("a_delete")
		Else
			MenuDishproperties.CurrentAction = "D"	' Delete record directly
		End If
		Select Case MenuDishproperties.CurrentAction
			Case "D" ' Delete
				MenuDishproperties.SendEmail = True ' Send email on delete success
	...
	Function DeleteRows()
		...
		If DeleteRows Then
			...
			Do While Not RsDelete.Eof
				DeleteRows = MenuDishproperties.Row_Deleting(RsDelete)
		...
		If DeleteRows Then
			...
			Do While Not RsOld.Eof
				Call MenuDishproperties.Row_Deleted(RsOld)
				RsOld.MoveNext
			Loop
		End If
		RsOld.Close
