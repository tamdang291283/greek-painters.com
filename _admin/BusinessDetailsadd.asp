...
' Define page object
Dim BusinessDetails_add
Set BusinessDetails_add = New cBusinessDetails_add
Set Page = BusinessDetails_add

' Page init processing
BusinessDetails_add.Page_Init()

' Page main processing
BusinessDetails_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Render event
BusinessDetails_add.Page_Render()
%>
<!--#include file="header.asp"-->
<script type="text/javascript">
// Page object
var BusinessDetails_add = new ew_Page("BusinessDetails_add");
BusinessDetails_add.PageID = "add"; // Page ID
var EW_PAGE_ID = BusinessDetails_add.PageID; // For backward compatibility
// Form object
var fBusinessDetailsadd = new ew_Form("fBusinessDetailsadd");
// Validate form
fBusinessDetailsadd.Validate = function() {
...
fBusinessDetailsadd.Form_CustomValidate = 
...
fBusinessDetailsadd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fBusinessDetailsadd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% BusinessDetails_add.ShowPageHeader() %>
<% BusinessDetails_add.ShowMessage %>
<form name="fBusinessDetailsadd" id="fBusinessDetailsadd" class="form-horizontal ewForm ewAddForm" action="<%= ew_CurrentPage() %>" method="post">
<% If BusinessDetails_add.CheckToken Then %>
<input type="hidden" name="<%= EW_TOKEN_NAME %>" value="<%= BusinessDetails_add.Token %>">
<% End If %>
...
<script type="text/javascript">
fBusinessDetailsadd.Init();
</script>
<%
BusinessDetails_add.ShowPageFooter()
...
' Drop page object
Set BusinessDetails_add = Nothing
%>
<%
...
Class cBusinessDetails_add
	...
	Public Property Get PageObjName()
		PageObjName = "BusinessDetails_add"
	End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			BusinessDetails.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("ID").Count > 0 Then
				...
				Call BusinessDetails.SetKey("ID", BusinessDetails.ID.CurrentValue) ' Set up key
			Else
				Call BusinessDetails.SetKey("ID", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
				BusinessDetails.CurrentAction = "C" ' Copy Record
			Else
				BusinessDetails.CurrentAction = "I" ' Display Blank Record
		...
		Select Case BusinessDetails.CurrentAction
			...
			Case "A" ' Add new record
				BusinessDetails.SendEmail = True ' Send email on add success
				If AddRow(OldRecordset) Then ' Add successful
					...
					If ew_GetPageName(sReturnUrl) = "BusinessDetailsview.asp" Then sReturnUrl = BusinessDetails.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		BusinessDetails.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Function LoadDefaultValues()
		...
		BusinessDetails.Name.OldValue = BusinessDetails.Name.CurrentValue
		BusinessDetails.Address.CurrentValue = Null
		BusinessDetails.Address.OldValue = BusinessDetails.Address.CurrentValue
		BusinessDetails.PostalCode.CurrentValue = Null
		BusinessDetails.PostalCode.OldValue = BusinessDetails.PostalCode.CurrentValue
		BusinessDetails.FoodType.CurrentValue = Null
		BusinessDetails.FoodType.OldValue = BusinessDetails.FoodType.CurrentValue
		BusinessDetails.DeliveryMinAmount.CurrentValue = Null
		BusinessDetails.DeliveryMinAmount.OldValue = BusinessDetails.DeliveryMinAmount.CurrentValue
		BusinessDetails.DeliveryMaxDistance.CurrentValue = Null
		BusinessDetails.DeliveryMaxDistance.OldValue = BusinessDetails.DeliveryMaxDistance.CurrentValue
		BusinessDetails.DeliveryFreeDistance.CurrentValue = Null
		BusinessDetails.DeliveryFreeDistance.OldValue = BusinessDetails.DeliveryFreeDistance.CurrentValue
		BusinessDetails.AverageDeliveryTime.CurrentValue = Null
		BusinessDetails.AverageDeliveryTime.OldValue = BusinessDetails.AverageDeliveryTime.CurrentValue
		BusinessDetails.AverageCollectionTime.CurrentValue = Null
		BusinessDetails.AverageCollectionTime.OldValue = BusinessDetails.AverageCollectionTime.CurrentValue
		BusinessDetails.DeliveryFee.CurrentValue = Null
		BusinessDetails.DeliveryFee.OldValue = BusinessDetails.DeliveryFee.CurrentValue
		BusinessDetails.ImgUrl.CurrentValue = Null
		BusinessDetails.ImgUrl.OldValue = BusinessDetails.ImgUrl.CurrentValue
		BusinessDetails.Telephone.CurrentValue = Null
		BusinessDetails.Telephone.OldValue = BusinessDetails.Telephone.CurrentValue
		BusinessDetails.zEmail.CurrentValue = Null
		BusinessDetails.zEmail.OldValue = BusinessDetails.zEmail.CurrentValue
		BusinessDetails.pswd.CurrentValue = Null
		BusinessDetails.pswd.OldValue = BusinessDetails.pswd.CurrentValue
		BusinessDetails.businessclosed.CurrentValue = Null
		BusinessDetails.businessclosed.OldValue = BusinessDetails.businessclosed.CurrentValue
		BusinessDetails.announcement.CurrentValue = Null
		BusinessDetails.announcement.OldValue = BusinessDetails.announcement.CurrentValue
		BusinessDetails.css.CurrentValue = Null
		BusinessDetails.css.OldValue = BusinessDetails.css.CurrentValue
		BusinessDetails.SMTP_AUTENTICATE.CurrentValue = Null
		BusinessDetails.SMTP_AUTENTICATE.OldValue = BusinessDetails.SMTP_AUTENTICATE.CurrentValue
		BusinessDetails.MAIL_FROM.CurrentValue = Null
		BusinessDetails.MAIL_FROM.OldValue = BusinessDetails.MAIL_FROM.CurrentValue
		BusinessDetails.PAYPAL_URL.CurrentValue = Null
		BusinessDetails.PAYPAL_URL.OldValue = BusinessDetails.PAYPAL_URL.CurrentValue
		BusinessDetails.PAYPAL_PDT.CurrentValue = Null
		BusinessDetails.PAYPAL_PDT.OldValue = BusinessDetails.PAYPAL_PDT.CurrentValue
		BusinessDetails.SMTP_PASSWORD.CurrentValue = Null
		BusinessDetails.SMTP_PASSWORD.OldValue = BusinessDetails.SMTP_PASSWORD.CurrentValue
		BusinessDetails.GMAP_API_KEY.CurrentValue = Null
		BusinessDetails.GMAP_API_KEY.OldValue = BusinessDetails.GMAP_API_KEY.CurrentValue
		BusinessDetails.SMTP_USERNAME.CurrentValue = Null
		BusinessDetails.SMTP_USERNAME.OldValue = BusinessDetails.SMTP_USERNAME.CurrentValue
		BusinessDetails.SMTP_USESSL.CurrentValue = Null
		BusinessDetails.SMTP_USESSL.OldValue = BusinessDetails.SMTP_USESSL.CurrentValue
		BusinessDetails.MAIL_SUBJECT.CurrentValue = Null
		BusinessDetails.MAIL_SUBJECT.OldValue = BusinessDetails.MAIL_SUBJECT.CurrentValue
		BusinessDetails.CURRENCYSYMBOL.CurrentValue = Null
		BusinessDetails.CURRENCYSYMBOL.OldValue = BusinessDetails.CURRENCYSYMBOL.CurrentValue
		BusinessDetails.SMTP_SERVER.CurrentValue = Null
		BusinessDetails.SMTP_SERVER.OldValue = BusinessDetails.SMTP_SERVER.CurrentValue
		BusinessDetails.CREDITCARDSURCHARGE.CurrentValue = Null
		BusinessDetails.CREDITCARDSURCHARGE.OldValue = BusinessDetails.CREDITCARDSURCHARGE.CurrentValue
		BusinessDetails.SMTP_PORT.CurrentValue = Null
		BusinessDetails.SMTP_PORT.OldValue = BusinessDetails.SMTP_PORT.CurrentValue
		BusinessDetails.STICK_MENU.CurrentValue = Null
		BusinessDetails.STICK_MENU.OldValue = BusinessDetails.STICK_MENU.CurrentValue
		BusinessDetails.MAIL_CUSTOMER_SUBJECT.CurrentValue = Null
		BusinessDetails.MAIL_CUSTOMER_SUBJECT.OldValue = BusinessDetails.MAIL_CUSTOMER_SUBJECT.CurrentValue
		BusinessDetails.CONFIRMATION_EMAIL_ADDRESS.CurrentValue = Null
		BusinessDetails.CONFIRMATION_EMAIL_ADDRESS.OldValue = BusinessDetails.CONFIRMATION_EMAIL_ADDRESS.CurrentValue
		BusinessDetails.SEND_ORDERS_TO_PRINTER.CurrentValue = Null
		BusinessDetails.SEND_ORDERS_TO_PRINTER.OldValue = BusinessDetails.SEND_ORDERS_TO_PRINTER.CurrentValue
		BusinessDetails.timezone.CurrentValue = Null
		BusinessDetails.timezone.OldValue = BusinessDetails.timezone.CurrentValue
		BusinessDetails.PAYPAL_ADDR.CurrentValue = Null
		BusinessDetails.PAYPAL_ADDR.OldValue = BusinessDetails.PAYPAL_ADDR.CurrentValue
		BusinessDetails.nochex.CurrentValue = Null
		BusinessDetails.nochex.OldValue = BusinessDetails.nochex.CurrentValue
		BusinessDetails.nochexmerchantid.CurrentValue = Null
		BusinessDetails.nochexmerchantid.OldValue = BusinessDetails.nochexmerchantid.CurrentValue
		BusinessDetails.paypal.CurrentValue = Null
		BusinessDetails.paypal.OldValue = BusinessDetails.paypal.CurrentValue
		BusinessDetails.IBT_API_KEY.CurrentValue = Null
		BusinessDetails.IBT_API_KEY.OldValue = BusinessDetails.IBT_API_KEY.CurrentValue
		BusinessDetails.IBP_API_PASSWORD.CurrentValue = Null
		BusinessDetails.IBP_API_PASSWORD.OldValue = BusinessDetails.IBP_API_PASSWORD.CurrentValue
		BusinessDetails.disable_delivery.CurrentValue = Null
		BusinessDetails.disable_delivery.OldValue = BusinessDetails.disable_delivery.CurrentValue
		BusinessDetails.disable_collection.CurrentValue = Null
		BusinessDetails.disable_collection.OldValue = BusinessDetails.disable_collection.CurrentValue
		BusinessDetails.worldpay.CurrentValue = Null
		BusinessDetails.worldpay.OldValue = BusinessDetails.worldpay.CurrentValue
		BusinessDetails.worldpaymerchantid.CurrentValue = Null
		BusinessDetails.worldpaymerchantid.OldValue = BusinessDetails.worldpaymerchantid.CurrentValue
		BusinessDetails.backtohometext.CurrentValue = Null
		BusinessDetails.backtohometext.OldValue = BusinessDetails.backtohometext.CurrentValue
		BusinessDetails.closedtext.CurrentValue = Null
		BusinessDetails.closedtext.OldValue = BusinessDetails.closedtext.CurrentValue
		BusinessDetails.DeliveryChargeOverrideByOrderValue.CurrentValue = Null
		BusinessDetails.DeliveryChargeOverrideByOrderValue.OldValue = BusinessDetails.DeliveryChargeOverrideByOrderValue.CurrentValue
		BusinessDetails.individualpostcodes.CurrentValue = Null
		BusinessDetails.individualpostcodes.OldValue = BusinessDetails.individualpostcodes.CurrentValue
		BusinessDetails.individualpostcodeschecking.CurrentValue = Null
		BusinessDetails.individualpostcodeschecking.OldValue = BusinessDetails.individualpostcodeschecking.CurrentValue
		BusinessDetails.longitude.CurrentValue = Null
		BusinessDetails.longitude.OldValue = BusinessDetails.longitude.CurrentValue
		BusinessDetails.latitude.CurrentValue = Null
		BusinessDetails.latitude.OldValue = BusinessDetails.latitude.CurrentValue
		BusinessDetails.googleecommercetracking.CurrentValue = Null
		BusinessDetails.googleecommercetracking.OldValue = BusinessDetails.googleecommercetracking.CurrentValue
		BusinessDetails.googleecommercetrackingcode.CurrentValue = Null
		BusinessDetails.googleecommercetrackingcode.OldValue = BusinessDetails.googleecommercetrackingcode.CurrentValue
		BusinessDetails.bringg.CurrentValue = Null
		BusinessDetails.bringg.OldValue = BusinessDetails.bringg.CurrentValue
		BusinessDetails.bringgurl.CurrentValue = Null
		BusinessDetails.bringgurl.OldValue = BusinessDetails.bringgurl.CurrentValue
		BusinessDetails.bringgcompanyid.CurrentValue = Null
		BusinessDetails.bringgcompanyid.OldValue = BusinessDetails.bringgcompanyid.CurrentValue
		BusinessDetails.orderonlywhenopen.CurrentValue = Null
		BusinessDetails.orderonlywhenopen.OldValue = BusinessDetails.orderonlywhenopen.CurrentValue
		BusinessDetails.disablelaterdelivery.CurrentValue = Null
		BusinessDetails.disablelaterdelivery.OldValue = BusinessDetails.disablelaterdelivery.CurrentValue
		BusinessDetails.menupagetext.CurrentValue = Null
		BusinessDetails.menupagetext.OldValue = BusinessDetails.menupagetext.CurrentValue
		BusinessDetails.ordertodayonly.CurrentValue = Null
		BusinessDetails.ordertodayonly.OldValue = BusinessDetails.ordertodayonly.CurrentValue
		BusinessDetails.mileskm.CurrentValue = Null
		BusinessDetails.mileskm.OldValue = BusinessDetails.mileskm.CurrentValue
		BusinessDetails.worldpaylive.CurrentValue = Null
		BusinessDetails.worldpaylive.OldValue = BusinessDetails.worldpaylive.CurrentValue
		BusinessDetails.worldpayinstallationid.CurrentValue = Null
		BusinessDetails.worldpayinstallationid.OldValue = BusinessDetails.worldpayinstallationid.CurrentValue
		BusinessDetails.DistanceCalMethod.CurrentValue = Null
		BusinessDetails.DistanceCalMethod.OldValue = BusinessDetails.DistanceCalMethod.CurrentValue
		BusinessDetails.PrinterIDList.CurrentValue = Null
		BusinessDetails.PrinterIDList.OldValue = BusinessDetails.PrinterIDList.CurrentValue
		BusinessDetails.EpsonJSPrinterURL.CurrentValue = Null
		BusinessDetails.EpsonJSPrinterURL.OldValue = BusinessDetails.EpsonJSPrinterURL.CurrentValue
		BusinessDetails.SMSEnable.CurrentValue = Null
		BusinessDetails.SMSEnable.OldValue = BusinessDetails.SMSEnable.CurrentValue
		BusinessDetails.SMSOnDelivery.CurrentValue = Null
		BusinessDetails.SMSOnDelivery.OldValue = BusinessDetails.SMSOnDelivery.CurrentValue
		BusinessDetails.SMSSupplierDomain.CurrentValue = Null
		BusinessDetails.SMSSupplierDomain.OldValue = BusinessDetails.SMSSupplierDomain.CurrentValue
		BusinessDetails.SMSOnOrder.CurrentValue = Null
		BusinessDetails.SMSOnOrder.OldValue = BusinessDetails.SMSOnOrder.CurrentValue
		BusinessDetails.SMSOnOrderAfterMin.CurrentValue = Null
		BusinessDetails.SMSOnOrderAfterMin.OldValue = BusinessDetails.SMSOnOrderAfterMin.CurrentValue
		BusinessDetails.SMSOnOrderContent.CurrentValue = Null
		BusinessDetails.SMSOnOrderContent.OldValue = BusinessDetails.SMSOnOrderContent.CurrentValue
		BusinessDetails.DefaultSMSCountryCode.CurrentValue = Null
		BusinessDetails.DefaultSMSCountryCode.OldValue = BusinessDetails.DefaultSMSCountryCode.CurrentValue
		BusinessDetails.MinimumAmountForCardPayment.CurrentValue = Null
		BusinessDetails.MinimumAmountForCardPayment.OldValue = BusinessDetails.MinimumAmountForCardPayment.CurrentValue
		BusinessDetails.FavIconUrl.CurrentValue = Null
		BusinessDetails.FavIconUrl.OldValue = BusinessDetails.FavIconUrl.CurrentValue
		BusinessDetails.AddToHomeScreenURL.CurrentValue = Null
		BusinessDetails.AddToHomeScreenURL.OldValue = BusinessDetails.AddToHomeScreenURL.CurrentValue
		BusinessDetails.SMSOnAcknowledgement.CurrentValue = Null
		BusinessDetails.SMSOnAcknowledgement.OldValue = BusinessDetails.SMSOnAcknowledgement.CurrentValue
		BusinessDetails.LocalPrinterURL.CurrentValue = Null
		BusinessDetails.LocalPrinterURL.OldValue = BusinessDetails.LocalPrinterURL.CurrentValue
		BusinessDetails.ShowRestaurantDetailOnReceipt.CurrentValue = Null
		BusinessDetails.ShowRestaurantDetailOnReceipt.OldValue = BusinessDetails.ShowRestaurantDetailOnReceipt.CurrentValue
		BusinessDetails.PrinterFontSizeRatio.CurrentValue = Null
		BusinessDetails.PrinterFontSizeRatio.OldValue = BusinessDetails.PrinterFontSizeRatio.CurrentValue
		BusinessDetails.ServiceChargePercentage.CurrentValue = Null
		BusinessDetails.ServiceChargePercentage.OldValue = BusinessDetails.ServiceChargePercentage.CurrentValue
		BusinessDetails.InRestaurantServiceChargeOnly.CurrentValue = Null
		BusinessDetails.InRestaurantServiceChargeOnly.OldValue = BusinessDetails.InRestaurantServiceChargeOnly.CurrentValue
		BusinessDetails.IsDualReceiptPrinting.CurrentValue = Null
		BusinessDetails.IsDualReceiptPrinting.OldValue = BusinessDetails.IsDualReceiptPrinting.CurrentValue
		BusinessDetails.PrintingFontSize.CurrentValue = Null
		BusinessDetails.PrintingFontSize.OldValue = BusinessDetails.PrintingFontSize.CurrentValue
		BusinessDetails.InRestaurantEpsonPrinterIDList.CurrentValue = Null
		BusinessDetails.InRestaurantEpsonPrinterIDList.OldValue = BusinessDetails.InRestaurantEpsonPrinterIDList.CurrentValue
		BusinessDetails.BlockIPEmailList.CurrentValue = Null
		BusinessDetails.BlockIPEmailList.OldValue = BusinessDetails.BlockIPEmailList.CurrentValue
		BusinessDetails.inmenuannouncement.CurrentValue = Null
		BusinessDetails.inmenuannouncement.OldValue = BusinessDetails.inmenuannouncement.CurrentValue
		BusinessDetails.RePrintReceiptWays.CurrentValue = Null
		BusinessDetails.RePrintReceiptWays.OldValue = BusinessDetails.RePrintReceiptWays.CurrentValue
		BusinessDetails.printingtype.CurrentValue = Null
		BusinessDetails.printingtype.OldValue = BusinessDetails.printingtype.CurrentValue
		BusinessDetails.Stripe_Key_Secret.CurrentValue = Null
		BusinessDetails.Stripe_Key_Secret.OldValue = BusinessDetails.Stripe_Key_Secret.CurrentValue
		BusinessDetails.Stripe.CurrentValue = Null
		BusinessDetails.Stripe.OldValue = BusinessDetails.Stripe.CurrentValue
		BusinessDetails.Stripe_Api_Key.CurrentValue = Null
		BusinessDetails.Stripe_Api_Key.OldValue = BusinessDetails.Stripe_Api_Key.CurrentValue
		BusinessDetails.EnableBooking.CurrentValue = Null
		BusinessDetails.EnableBooking.OldValue = BusinessDetails.EnableBooking.CurrentValue
		BusinessDetails.URL_Facebook.CurrentValue = Null
		BusinessDetails.URL_Facebook.OldValue = BusinessDetails.URL_Facebook.CurrentValue
		BusinessDetails.URL_Twitter.CurrentValue = Null
		BusinessDetails.URL_Twitter.OldValue = BusinessDetails.URL_Twitter.CurrentValue
		BusinessDetails.URL_Google.CurrentValue = Null
		BusinessDetails.URL_Google.OldValue = BusinessDetails.URL_Google.CurrentValue
		BusinessDetails.URL_Intagram.CurrentValue = Null
		BusinessDetails.URL_Intagram.OldValue = BusinessDetails.URL_Intagram.CurrentValue
		BusinessDetails.URL_YouTube.CurrentValue = Null
		BusinessDetails.URL_YouTube.OldValue = BusinessDetails.URL_YouTube.CurrentValue
		BusinessDetails.URL_Tripadvisor.CurrentValue = Null
		BusinessDetails.URL_Tripadvisor.OldValue = BusinessDetails.URL_Tripadvisor.CurrentValue
		BusinessDetails.URL_Special_Offer.CurrentValue = Null
		BusinessDetails.URL_Special_Offer.OldValue = BusinessDetails.URL_Special_Offer.CurrentValue
		BusinessDetails.URL_Linkin.CurrentValue = Null
		BusinessDetails.URL_Linkin.OldValue = BusinessDetails.URL_Linkin.CurrentValue
		BusinessDetails.Currency_PAYPAL.CurrentValue = Null
		BusinessDetails.Currency_PAYPAL.OldValue = BusinessDetails.Currency_PAYPAL.CurrentValue
		BusinessDetails.Currency_STRIPE.CurrentValue = Null
		BusinessDetails.Currency_STRIPE.OldValue = BusinessDetails.Currency_STRIPE.CurrentValue
		BusinessDetails.Currency_WOLRDPAY.CurrentValue = Null
		BusinessDetails.Currency_WOLRDPAY.OldValue = BusinessDetails.Currency_WOLRDPAY.CurrentValue
		BusinessDetails.Tip_percent.CurrentValue = Null
		BusinessDetails.Tip_percent.OldValue = BusinessDetails.Tip_percent.CurrentValue
		BusinessDetails.Tax_Percent.CurrentValue = Null
		BusinessDetails.Tax_Percent.OldValue = BusinessDetails.Tax_Percent.CurrentValue
		BusinessDetails.InRestaurantTaxChargeOnly.CurrentValue = Null
		BusinessDetails.InRestaurantTaxChargeOnly.OldValue = BusinessDetails.InRestaurantTaxChargeOnly.CurrentValue
		BusinessDetails.InRestaurantTipChargeOnly.CurrentValue = Null
		BusinessDetails.InRestaurantTipChargeOnly.OldValue = BusinessDetails.InRestaurantTipChargeOnly.CurrentValue
		BusinessDetails.isCheckCapcha.CurrentValue = Null
		BusinessDetails.isCheckCapcha.OldValue = BusinessDetails.isCheckCapcha.CurrentValue
		BusinessDetails.Close_StartDate.CurrentValue = Null
		BusinessDetails.Close_StartDate.OldValue = BusinessDetails.Close_StartDate.CurrentValue
		BusinessDetails.Close_EndDate.CurrentValue = Null
		BusinessDetails.Close_EndDate.OldValue = BusinessDetails.Close_EndDate.CurrentValue
		BusinessDetails.Stripe_Country.CurrentValue = Null
		BusinessDetails.Stripe_Country.OldValue = BusinessDetails.Stripe_Country.CurrentValue
		BusinessDetails.enable_StripePaymentButton.CurrentValue = Null
		BusinessDetails.enable_StripePaymentButton.OldValue = BusinessDetails.enable_StripePaymentButton.CurrentValue
		BusinessDetails.enable_CashPayment.CurrentValue = Null
		BusinessDetails.enable_CashPayment.OldValue = BusinessDetails.enable_CashPayment.CurrentValue
		BusinessDetails.DeliveryMile.CurrentValue = Null
		BusinessDetails.DeliveryMile.OldValue = BusinessDetails.DeliveryMile.CurrentValue
		BusinessDetails.Mon_Delivery.CurrentValue = Null
		BusinessDetails.Mon_Delivery.OldValue = BusinessDetails.Mon_Delivery.CurrentValue
		BusinessDetails.Mon_Collection.CurrentValue = Null
		BusinessDetails.Mon_Collection.OldValue = BusinessDetails.Mon_Collection.CurrentValue
		BusinessDetails.Tue_Delivery.CurrentValue = Null
		BusinessDetails.Tue_Delivery.OldValue = BusinessDetails.Tue_Delivery.CurrentValue
		BusinessDetails.Tue_Collection.CurrentValue = Null
		BusinessDetails.Tue_Collection.OldValue = BusinessDetails.Tue_Collection.CurrentValue
		BusinessDetails.Wed_Delivery.CurrentValue = Null
		BusinessDetails.Wed_Delivery.OldValue = BusinessDetails.Wed_Delivery.CurrentValue
		BusinessDetails.Wed_Collection.CurrentValue = Null
		BusinessDetails.Wed_Collection.OldValue = BusinessDetails.Wed_Collection.CurrentValue
		BusinessDetails.Thu_Delivery.CurrentValue = Null
		BusinessDetails.Thu_Delivery.OldValue = BusinessDetails.Thu_Delivery.CurrentValue
		BusinessDetails.Thu_Collection.CurrentValue = Null
		BusinessDetails.Thu_Collection.OldValue = BusinessDetails.Thu_Collection.CurrentValue
		BusinessDetails.Fri_Delivery.CurrentValue = Null
		BusinessDetails.Fri_Delivery.OldValue = BusinessDetails.Fri_Delivery.CurrentValue
		BusinessDetails.Fri_Collection.CurrentValue = Null
		BusinessDetails.Fri_Collection.OldValue = BusinessDetails.Fri_Collection.CurrentValue
		BusinessDetails.Sat_Delivery.CurrentValue = Null
		BusinessDetails.Sat_Delivery.OldValue = BusinessDetails.Sat_Delivery.CurrentValue
		BusinessDetails.Sat_Collection.CurrentValue = Null
		BusinessDetails.Sat_Collection.OldValue = BusinessDetails.Sat_Collection.CurrentValue
		BusinessDetails.Sun_Delivery.CurrentValue = Null
		BusinessDetails.Sun_Delivery.OldValue = BusinessDetails.Sun_Delivery.CurrentValue
		BusinessDetails.Sun_Collection.CurrentValue = Null
		BusinessDetails.Sun_Collection.OldValue = BusinessDetails.Sun_Collection.CurrentValue
		BusinessDetails.EnableUrlRewrite.CurrentValue = Null
		BusinessDetails.EnableUrlRewrite.OldValue = BusinessDetails.EnableUrlRewrite.CurrentValue
		BusinessDetails.DeliveryCostUpTo.CurrentValue = Null
		BusinessDetails.DeliveryCostUpTo.OldValue = BusinessDetails.DeliveryCostUpTo.CurrentValue
		BusinessDetails.DeliveryUptoMile.CurrentValue = Null
		BusinessDetails.DeliveryUptoMile.OldValue = BusinessDetails.DeliveryUptoMile.CurrentValue
		BusinessDetails.Show_Ordernumner_printer.CurrentValue = Null
		BusinessDetails.Show_Ordernumner_printer.OldValue = BusinessDetails.Show_Ordernumner_printer.CurrentValue
		BusinessDetails.Show_Ordernumner_Receipt.CurrentValue = Null
		BusinessDetails.Show_Ordernumner_Receipt.OldValue = BusinessDetails.Show_Ordernumner_Receipt.CurrentValue
		BusinessDetails.Show_Ordernumner_Dashboard.CurrentValue = Null
		BusinessDetails.Show_Ordernumner_Dashboard.OldValue = BusinessDetails.Show_Ordernumner_Dashboard.CurrentValue
	End Function
	...
	Sub RenderRow()
		...
		ElseIf BusinessDetails.RowType = EW_ROWTYPE_ADD Then ' Add row
	...
	Function AddRow(RsOld)
		...
		' Field Name
		Call BusinessDetails.Name.SetDbValue(Rs, BusinessDetails.Name.CurrentValue, Null, False)

		' Field Address
		Call BusinessDetails.Address.SetDbValue(Rs, BusinessDetails.Address.CurrentValue, Null, False)

		' Field PostalCode
		Call BusinessDetails.PostalCode.SetDbValue(Rs, BusinessDetails.PostalCode.CurrentValue, Null, False)

		' Field FoodType
		Call BusinessDetails.FoodType.SetDbValue(Rs, BusinessDetails.FoodType.CurrentValue, Null, False)

		' Field DeliveryMinAmount
		Call BusinessDetails.DeliveryMinAmount.SetDbValue(Rs, BusinessDetails.DeliveryMinAmount.CurrentValue, Null, False)

		' Field DeliveryMaxDistance
		Call BusinessDetails.DeliveryMaxDistance.SetDbValue(Rs, BusinessDetails.DeliveryMaxDistance.CurrentValue, Null, False)

		' Field DeliveryFreeDistance
		Call BusinessDetails.DeliveryFreeDistance.SetDbValue(Rs, BusinessDetails.DeliveryFreeDistance.CurrentValue, Null, False)

		' Field AverageDeliveryTime
		Call BusinessDetails.AverageDeliveryTime.SetDbValue(Rs, BusinessDetails.AverageDeliveryTime.CurrentValue, Null, False)

		' Field AverageCollectionTime
		Call BusinessDetails.AverageCollectionTime.SetDbValue(Rs, BusinessDetails.AverageCollectionTime.CurrentValue, Null, False)

		' Field DeliveryFee
		Call BusinessDetails.DeliveryFee.SetDbValue(Rs, BusinessDetails.DeliveryFee.CurrentValue, Null, False)

		' Field ImgUrl
		Call BusinessDetails.ImgUrl.SetDbValue(Rs, BusinessDetails.ImgUrl.CurrentValue, Null, False)

		' Field Telephone
		Call BusinessDetails.Telephone.SetDbValue(Rs, BusinessDetails.Telephone.CurrentValue, Null, False)

		' Field Email
		Call BusinessDetails.zEmail.SetDbValue(Rs, BusinessDetails.zEmail.CurrentValue, Null, False)

		' Field pswd
		Call BusinessDetails.pswd.SetDbValue(Rs, BusinessDetails.pswd.CurrentValue, Null, False)

		' Field businessclosed
		Call BusinessDetails.businessclosed.SetDbValue(Rs, BusinessDetails.businessclosed.CurrentValue, Null, False)

		' Field announcement
		Call BusinessDetails.announcement.SetDbValue(Rs, BusinessDetails.announcement.CurrentValue, Null, False)

		' Field css
		Call BusinessDetails.css.SetDbValue(Rs, BusinessDetails.css.CurrentValue, Null, False)

		' Field SMTP_AUTENTICATE
		Call BusinessDetails.SMTP_AUTENTICATE.SetDbValue(Rs, BusinessDetails.SMTP_AUTENTICATE.CurrentValue, Null, False)

		' Field MAIL_FROM
		Call BusinessDetails.MAIL_FROM.SetDbValue(Rs, BusinessDetails.MAIL_FROM.CurrentValue, Null, False)

		' Field PAYPAL_URL
		Call BusinessDetails.PAYPAL_URL.SetDbValue(Rs, BusinessDetails.PAYPAL_URL.CurrentValue, Null, False)

		' Field PAYPAL_PDT
		Call BusinessDetails.PAYPAL_PDT.SetDbValue(Rs, BusinessDetails.PAYPAL_PDT.CurrentValue, Null, False)

		' Field SMTP_PASSWORD
		Call BusinessDetails.SMTP_PASSWORD.SetDbValue(Rs, BusinessDetails.SMTP_PASSWORD.CurrentValue, Null, False)

		' Field GMAP_API_KEY
		Call BusinessDetails.GMAP_API_KEY.SetDbValue(Rs, BusinessDetails.GMAP_API_KEY.CurrentValue, Null, False)

		' Field SMTP_USERNAME
		Call BusinessDetails.SMTP_USERNAME.SetDbValue(Rs, BusinessDetails.SMTP_USERNAME.CurrentValue, Null, False)

		' Field SMTP_USESSL
		Call BusinessDetails.SMTP_USESSL.SetDbValue(Rs, BusinessDetails.SMTP_USESSL.CurrentValue, Null, False)

		' Field MAIL_SUBJECT
		Call BusinessDetails.MAIL_SUBJECT.SetDbValue(Rs, BusinessDetails.MAIL_SUBJECT.CurrentValue, Null, False)

		' Field CURRENCYSYMBOL
		Call BusinessDetails.CURRENCYSYMBOL.SetDbValue(Rs, BusinessDetails.CURRENCYSYMBOL.CurrentValue, Null, False)

		' Field SMTP_SERVER
		Call BusinessDetails.SMTP_SERVER.SetDbValue(Rs, BusinessDetails.SMTP_SERVER.CurrentValue, Null, False)

		' Field CREDITCARDSURCHARGE
		Call BusinessDetails.CREDITCARDSURCHARGE.SetDbValue(Rs, BusinessDetails.CREDITCARDSURCHARGE.CurrentValue, Null, False)

		' Field SMTP_PORT
		Call BusinessDetails.SMTP_PORT.SetDbValue(Rs, BusinessDetails.SMTP_PORT.CurrentValue, Null, False)

		' Field STICK_MENU
		Call BusinessDetails.STICK_MENU.SetDbValue(Rs, BusinessDetails.STICK_MENU.CurrentValue, Null, False)

		' Field MAIL_CUSTOMER_SUBJECT
		Call BusinessDetails.MAIL_CUSTOMER_SUBJECT.SetDbValue(Rs, BusinessDetails.MAIL_CUSTOMER_SUBJECT.CurrentValue, Null, False)

		' Field CONFIRMATION_EMAIL_ADDRESS
		Call BusinessDetails.CONFIRMATION_EMAIL_ADDRESS.SetDbValue(Rs, BusinessDetails.CONFIRMATION_EMAIL_ADDRESS.CurrentValue, Null, False)

		' Field SEND_ORDERS_TO_PRINTER
		Call BusinessDetails.SEND_ORDERS_TO_PRINTER.SetDbValue(Rs, BusinessDetails.SEND_ORDERS_TO_PRINTER.CurrentValue, Null, False)

		' Field timezone
		Call BusinessDetails.timezone.SetDbValue(Rs, BusinessDetails.timezone.CurrentValue, Null, False)

		' Field PAYPAL_ADDR
		Call BusinessDetails.PAYPAL_ADDR.SetDbValue(Rs, BusinessDetails.PAYPAL_ADDR.CurrentValue, Null, False)

		' Field nochex
		Call BusinessDetails.nochex.SetDbValue(Rs, BusinessDetails.nochex.CurrentValue, Null, False)

		' Field nochexmerchantid
		Call BusinessDetails.nochexmerchantid.SetDbValue(Rs, BusinessDetails.nochexmerchantid.CurrentValue, Null, False)

		' Field paypal
		Call BusinessDetails.paypal.SetDbValue(Rs, BusinessDetails.paypal.CurrentValue, Null, False)

		' Field IBT_API_KEY
		Call BusinessDetails.IBT_API_KEY.SetDbValue(Rs, BusinessDetails.IBT_API_KEY.CurrentValue, Null, False)

		' Field IBP_API_PASSWORD
		Call BusinessDetails.IBP_API_PASSWORD.SetDbValue(Rs, BusinessDetails.IBP_API_PASSWORD.CurrentValue, Null, False)

		' Field disable_delivery
		Call BusinessDetails.disable_delivery.SetDbValue(Rs, BusinessDetails.disable_delivery.CurrentValue, Null, False)

		' Field disable_collection
		Call BusinessDetails.disable_collection.SetDbValue(Rs, BusinessDetails.disable_collection.CurrentValue, Null, False)

		' Field worldpay
		Call BusinessDetails.worldpay.SetDbValue(Rs, BusinessDetails.worldpay.CurrentValue, Null, False)

		' Field worldpaymerchantid
		Call BusinessDetails.worldpaymerchantid.SetDbValue(Rs, BusinessDetails.worldpaymerchantid.CurrentValue, Null, False)

		' Field backtohometext
		Call BusinessDetails.backtohometext.SetDbValue(Rs, BusinessDetails.backtohometext.CurrentValue, Null, False)

		' Field closedtext
		Call BusinessDetails.closedtext.SetDbValue(Rs, BusinessDetails.closedtext.CurrentValue, Null, False)

		' Field DeliveryChargeOverrideByOrderValue
		Call BusinessDetails.DeliveryChargeOverrideByOrderValue.SetDbValue(Rs, BusinessDetails.DeliveryChargeOverrideByOrderValue.CurrentValue, Null, False)

		' Field individualpostcodes
		Call BusinessDetails.individualpostcodes.SetDbValue(Rs, BusinessDetails.individualpostcodes.CurrentValue, Null, False)

		' Field individualpostcodeschecking
		Call BusinessDetails.individualpostcodeschecking.SetDbValue(Rs, BusinessDetails.individualpostcodeschecking.CurrentValue, Null, False)

		' Field longitude
		Call BusinessDetails.longitude.SetDbValue(Rs, BusinessDetails.longitude.CurrentValue, Null, False)

		' Field latitude
		Call BusinessDetails.latitude.SetDbValue(Rs, BusinessDetails.latitude.CurrentValue, Null, False)

		' Field googleecommercetracking
		Call BusinessDetails.googleecommercetracking.SetDbValue(Rs, BusinessDetails.googleecommercetracking.CurrentValue, Null, False)

		' Field googleecommercetrackingcode
		Call BusinessDetails.googleecommercetrackingcode.SetDbValue(Rs, BusinessDetails.googleecommercetrackingcode.CurrentValue, Null, False)

		' Field bringg
		Call BusinessDetails.bringg.SetDbValue(Rs, BusinessDetails.bringg.CurrentValue, Null, False)

		' Field bringgurl
		Call BusinessDetails.bringgurl.SetDbValue(Rs, BusinessDetails.bringgurl.CurrentValue, Null, False)

		' Field bringgcompanyid
		Call BusinessDetails.bringgcompanyid.SetDbValue(Rs, BusinessDetails.bringgcompanyid.CurrentValue, Null, False)

		' Field orderonlywhenopen
		Call BusinessDetails.orderonlywhenopen.SetDbValue(Rs, BusinessDetails.orderonlywhenopen.CurrentValue, Null, False)

		' Field disablelaterdelivery
		Call BusinessDetails.disablelaterdelivery.SetDbValue(Rs, BusinessDetails.disablelaterdelivery.CurrentValue, Null, False)

		' Field menupagetext
		Call BusinessDetails.menupagetext.SetDbValue(Rs, BusinessDetails.menupagetext.CurrentValue, Null, False)

		' Field ordertodayonly
		Call BusinessDetails.ordertodayonly.SetDbValue(Rs, BusinessDetails.ordertodayonly.CurrentValue, Null, False)

		' Field mileskm
		Call BusinessDetails.mileskm.SetDbValue(Rs, BusinessDetails.mileskm.CurrentValue, Null, False)

		' Field worldpaylive
		Call BusinessDetails.worldpaylive.SetDbValue(Rs, BusinessDetails.worldpaylive.CurrentValue, Null, False)

		' Field worldpayinstallationid
		Call BusinessDetails.worldpayinstallationid.SetDbValue(Rs, BusinessDetails.worldpayinstallationid.CurrentValue, Null, False)

		' Field DistanceCalMethod
		Call BusinessDetails.DistanceCalMethod.SetDbValue(Rs, BusinessDetails.DistanceCalMethod.CurrentValue, Null, False)

		' Field PrinterIDList
		Call BusinessDetails.PrinterIDList.SetDbValue(Rs, BusinessDetails.PrinterIDList.CurrentValue, Null, False)

		' Field EpsonJSPrinterURL
		Call BusinessDetails.EpsonJSPrinterURL.SetDbValue(Rs, BusinessDetails.EpsonJSPrinterURL.CurrentValue, Null, False)

		' Field SMSEnable
		Call BusinessDetails.SMSEnable.SetDbValue(Rs, BusinessDetails.SMSEnable.CurrentValue, Null, False)

		' Field SMSOnDelivery
		Call BusinessDetails.SMSOnDelivery.SetDbValue(Rs, BusinessDetails.SMSOnDelivery.CurrentValue, Null, False)

		' Field SMSSupplierDomain
		Call BusinessDetails.SMSSupplierDomain.SetDbValue(Rs, BusinessDetails.SMSSupplierDomain.CurrentValue, Null, False)

		' Field SMSOnOrder
		Call BusinessDetails.SMSOnOrder.SetDbValue(Rs, BusinessDetails.SMSOnOrder.CurrentValue, Null, False)

		' Field SMSOnOrderAfterMin
		Call BusinessDetails.SMSOnOrderAfterMin.SetDbValue(Rs, BusinessDetails.SMSOnOrderAfterMin.CurrentValue, Null, False)

		' Field SMSOnOrderContent
		Call BusinessDetails.SMSOnOrderContent.SetDbValue(Rs, BusinessDetails.SMSOnOrderContent.CurrentValue, Null, False)

		' Field DefaultSMSCountryCode
		Call BusinessDetails.DefaultSMSCountryCode.SetDbValue(Rs, BusinessDetails.DefaultSMSCountryCode.CurrentValue, Null, False)

		' Field MinimumAmountForCardPayment
		Call BusinessDetails.MinimumAmountForCardPayment.SetDbValue(Rs, BusinessDetails.MinimumAmountForCardPayment.CurrentValue, Null, False)

		' Field FavIconUrl
		Call BusinessDetails.FavIconUrl.SetDbValue(Rs, BusinessDetails.FavIconUrl.CurrentValue, Null, False)

		' Field AddToHomeScreenURL
		Call BusinessDetails.AddToHomeScreenURL.SetDbValue(Rs, BusinessDetails.AddToHomeScreenURL.CurrentValue, Null, False)

		' Field SMSOnAcknowledgement
		Call BusinessDetails.SMSOnAcknowledgement.SetDbValue(Rs, BusinessDetails.SMSOnAcknowledgement.CurrentValue, Null, False)

		' Field LocalPrinterURL
		Call BusinessDetails.LocalPrinterURL.SetDbValue(Rs, BusinessDetails.LocalPrinterURL.CurrentValue, Null, False)

		' Field ShowRestaurantDetailOnReceipt
		Call BusinessDetails.ShowRestaurantDetailOnReceipt.SetDbValue(Rs, BusinessDetails.ShowRestaurantDetailOnReceipt.CurrentValue, Null, False)

		' Field PrinterFontSizeRatio
		Call BusinessDetails.PrinterFontSizeRatio.SetDbValue(Rs, BusinessDetails.PrinterFontSizeRatio.CurrentValue, Null, False)

		' Field ServiceChargePercentage
		Call BusinessDetails.ServiceChargePercentage.SetDbValue(Rs, BusinessDetails.ServiceChargePercentage.CurrentValue, Null, False)

		' Field InRestaurantServiceChargeOnly
		Call BusinessDetails.InRestaurantServiceChargeOnly.SetDbValue(Rs, BusinessDetails.InRestaurantServiceChargeOnly.CurrentValue, Null, False)

		' Field IsDualReceiptPrinting
		Call BusinessDetails.IsDualReceiptPrinting.SetDbValue(Rs, BusinessDetails.IsDualReceiptPrinting.CurrentValue, Null, False)

		' Field PrintingFontSize
		Call BusinessDetails.PrintingFontSize.SetDbValue(Rs, BusinessDetails.PrintingFontSize.CurrentValue, Null, False)

		' Field InRestaurantEpsonPrinterIDList
		Call BusinessDetails.InRestaurantEpsonPrinterIDList.SetDbValue(Rs, BusinessDetails.InRestaurantEpsonPrinterIDList.CurrentValue, Null, False)

		' Field BlockIPEmailList
		Call BusinessDetails.BlockIPEmailList.SetDbValue(Rs, BusinessDetails.BlockIPEmailList.CurrentValue, Null, False)

		' Field inmenuannouncement
		Call BusinessDetails.inmenuannouncement.SetDbValue(Rs, BusinessDetails.inmenuannouncement.CurrentValue, Null, False)

		' Field RePrintReceiptWays
		Call BusinessDetails.RePrintReceiptWays.SetDbValue(Rs, BusinessDetails.RePrintReceiptWays.CurrentValue, Null, False)

		' Field printingtype
		Call BusinessDetails.printingtype.SetDbValue(Rs, BusinessDetails.printingtype.CurrentValue, Null, False)

		' Field Stripe_Key_Secret
		Call BusinessDetails.Stripe_Key_Secret.SetDbValue(Rs, BusinessDetails.Stripe_Key_Secret.CurrentValue, Null, False)

		' Field Stripe
		Call BusinessDetails.Stripe.SetDbValue(Rs, BusinessDetails.Stripe.CurrentValue, Null, False)

		' Field Stripe_Api_Key
		Call BusinessDetails.Stripe_Api_Key.SetDbValue(Rs, BusinessDetails.Stripe_Api_Key.CurrentValue, Null, False)

		' Field EnableBooking
		Call BusinessDetails.EnableBooking.SetDbValue(Rs, BusinessDetails.EnableBooking.CurrentValue, Null, False)

		' Field URL_Facebook
		Call BusinessDetails.URL_Facebook.SetDbValue(Rs, BusinessDetails.URL_Facebook.CurrentValue, Null, False)

		' Field URL_Twitter
		Call BusinessDetails.URL_Twitter.SetDbValue(Rs, BusinessDetails.URL_Twitter.CurrentValue, Null, False)

		' Field URL_Google
		Call BusinessDetails.URL_Google.SetDbValue(Rs, BusinessDetails.URL_Google.CurrentValue, Null, False)

		' Field URL_Intagram
		Call BusinessDetails.URL_Intagram.SetDbValue(Rs, BusinessDetails.URL_Intagram.CurrentValue, Null, False)

		' Field URL_YouTube
		Call BusinessDetails.URL_YouTube.SetDbValue(Rs, BusinessDetails.URL_YouTube.CurrentValue, Null, False)

		' Field URL_Tripadvisor
		Call BusinessDetails.URL_Tripadvisor.SetDbValue(Rs, BusinessDetails.URL_Tripadvisor.CurrentValue, Null, False)

		' Field URL_Special_Offer
		Call BusinessDetails.URL_Special_Offer.SetDbValue(Rs, BusinessDetails.URL_Special_Offer.CurrentValue, Null, False)

		' Field URL_Linkin
		Call BusinessDetails.URL_Linkin.SetDbValue(Rs, BusinessDetails.URL_Linkin.CurrentValue, Null, False)

		' Field Currency_PAYPAL
		Call BusinessDetails.Currency_PAYPAL.SetDbValue(Rs, BusinessDetails.Currency_PAYPAL.CurrentValue, Null, False)

		' Field Currency_STRIPE
		Call BusinessDetails.Currency_STRIPE.SetDbValue(Rs, BusinessDetails.Currency_STRIPE.CurrentValue, Null, False)

		' Field Currency_WOLRDPAY
		Call BusinessDetails.Currency_WOLRDPAY.SetDbValue(Rs, BusinessDetails.Currency_WOLRDPAY.CurrentValue, Null, False)

		' Field Tip_percent
		Call BusinessDetails.Tip_percent.SetDbValue(Rs, BusinessDetails.Tip_percent.CurrentValue, Null, False)

		' Field Tax_Percent
		Call BusinessDetails.Tax_Percent.SetDbValue(Rs, BusinessDetails.Tax_Percent.CurrentValue, Null, False)

		' Field InRestaurantTaxChargeOnly
		Call BusinessDetails.InRestaurantTaxChargeOnly.SetDbValue(Rs, BusinessDetails.InRestaurantTaxChargeOnly.CurrentValue, Null, False)

		' Field InRestaurantTipChargeOnly
		Call BusinessDetails.InRestaurantTipChargeOnly.SetDbValue(Rs, BusinessDetails.InRestaurantTipChargeOnly.CurrentValue, Null, False)

		' Field isCheckCapcha
		Call BusinessDetails.isCheckCapcha.SetDbValue(Rs, BusinessDetails.isCheckCapcha.CurrentValue, Null, False)

		' Field Close_StartDate
		Call BusinessDetails.Close_StartDate.SetDbValue(Rs, BusinessDetails.Close_StartDate.CurrentValue, Null, False)

		' Field Close_EndDate
		Call BusinessDetails.Close_EndDate.SetDbValue(Rs, BusinessDetails.Close_EndDate.CurrentValue, Null, False)

		' Field Stripe_Country
		Call BusinessDetails.Stripe_Country.SetDbValue(Rs, BusinessDetails.Stripe_Country.CurrentValue, Null, False)

		' Field enable_StripePaymentButton
		Call BusinessDetails.enable_StripePaymentButton.SetDbValue(Rs, BusinessDetails.enable_StripePaymentButton.CurrentValue, Null, False)

		' Field enable_CashPayment
		Call BusinessDetails.enable_CashPayment.SetDbValue(Rs, BusinessDetails.enable_CashPayment.CurrentValue, Null, False)

		' Field DeliveryMile
		Call BusinessDetails.DeliveryMile.SetDbValue(Rs, BusinessDetails.DeliveryMile.CurrentValue, Null, False)

		' Field Mon_Delivery
		Call BusinessDetails.Mon_Delivery.SetDbValue(Rs, BusinessDetails.Mon_Delivery.CurrentValue, Null, False)

		' Field Mon_Collection
		Call BusinessDetails.Mon_Collection.SetDbValue(Rs, BusinessDetails.Mon_Collection.CurrentValue, Null, False)

		' Field Tue_Delivery
		Call BusinessDetails.Tue_Delivery.SetDbValue(Rs, BusinessDetails.Tue_Delivery.CurrentValue, Null, False)

		' Field Tue_Collection
		Call BusinessDetails.Tue_Collection.SetDbValue(Rs, BusinessDetails.Tue_Collection.CurrentValue, Null, False)

		' Field Wed_Delivery
		Call BusinessDetails.Wed_Delivery.SetDbValue(Rs, BusinessDetails.Wed_Delivery.CurrentValue, Null, False)

		' Field Wed_Collection
		Call BusinessDetails.Wed_Collection.SetDbValue(Rs, BusinessDetails.Wed_Collection.CurrentValue, Null, False)

		' Field Thu_Delivery
		Call BusinessDetails.Thu_Delivery.SetDbValue(Rs, BusinessDetails.Thu_Delivery.CurrentValue, Null, False)

		' Field Thu_Collection
		Call BusinessDetails.Thu_Collection.SetDbValue(Rs, BusinessDetails.Thu_Collection.CurrentValue, Null, False)

		' Field Fri_Delivery
		Call BusinessDetails.Fri_Delivery.SetDbValue(Rs, BusinessDetails.Fri_Delivery.CurrentValue, Null, False)

		' Field Fri_Collection
		Call BusinessDetails.Fri_Collection.SetDbValue(Rs, BusinessDetails.Fri_Collection.CurrentValue, Null, False)

		' Field Sat_Delivery
		Call BusinessDetails.Sat_Delivery.SetDbValue(Rs, BusinessDetails.Sat_Delivery.CurrentValue, Null, False)

		' Field Sat_Collection
		Call BusinessDetails.Sat_Collection.SetDbValue(Rs, BusinessDetails.Sat_Collection.CurrentValue, Null, False)

		' Field Sun_Delivery
		Call BusinessDetails.Sun_Delivery.SetDbValue(Rs, BusinessDetails.Sun_Delivery.CurrentValue, Null, False)

		' Field Sun_Collection
		Call BusinessDetails.Sun_Collection.SetDbValue(Rs, BusinessDetails.Sun_Collection.CurrentValue, Null, False)

		' Field EnableUrlRewrite
		Call BusinessDetails.EnableUrlRewrite.SetDbValue(Rs, BusinessDetails.EnableUrlRewrite.CurrentValue, Null, False)

		' Field DeliveryCostUpTo
		Call BusinessDetails.DeliveryCostUpTo.SetDbValue(Rs, BusinessDetails.DeliveryCostUpTo.CurrentValue, Null, False)

		' Field DeliveryUptoMile
		Call BusinessDetails.DeliveryUptoMile.SetDbValue(Rs, BusinessDetails.DeliveryUptoMile.CurrentValue, Null, False)

		' Field Show_Ordernumner_printer
		Call BusinessDetails.Show_Ordernumner_printer.SetDbValue(Rs, BusinessDetails.Show_Ordernumner_printer.CurrentValue, Null, False)

		' Field Show_Ordernumner_Receipt
		Call BusinessDetails.Show_Ordernumner_Receipt.SetDbValue(Rs, BusinessDetails.Show_Ordernumner_Receipt.CurrentValue, Null, False)

		' Field Show_Ordernumner_Dashboard
		Call BusinessDetails.Show_Ordernumner_Dashboard.SetDbValue(Rs, BusinessDetails.Show_Ordernumner_Dashboard.CurrentValue, Null, False)
		...
		bInsertRow = BusinessDetails.Row_Inserting(RsOld, Rs)
		If bInsertRow Then
		...
		Set Rs = Nothing
		If AddRow Then
			BusinessDetails.ID.DbValue = RsNew("ID")
		End If
		If AddRow Then

			' Call Row Inserted event
			Call BusinessDetails.Row_Inserted(RsOld, RsNew)
		End If
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(BusinessDetails.CurrentAction = "C", "Copy", "Add")
