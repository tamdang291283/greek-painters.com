...
Class ck9kondop_FO2008_db
	...
	Private Sub Class_Initialize()
		...
		ConnectionString = "Provider=SQLNCLI11;Persist Security Info=False;Data Source=23.161.0.18,1433;Initial Catalog=k9kondop_FO2008;User Id=tam2008;Password=tam2008;DataTypeCompatibility=80"
		Schema = "dbo"
		StartQuote = "["
		EndQuote = "]"
		CursorLocation = 3
