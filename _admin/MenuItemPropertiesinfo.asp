...
' ASPMaker configuration for Table MenuItemProperties
Dim MenuItemProperties

' Define table class
Class cMenuItemProperties
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "IdMenuItem", IdMenuItem)
		Call ew_SetArObj(Fields, "allowtoppings", allowtoppings)
		Call ew_SetArObj(Fields, "dishpropertiesgroupid", dishpropertiesgroupid)
	...
	Public Property Get HighlightName()
		HighlightName = "MenuItemProperties_Highlight"
	End Property
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[MenuItemProperties]")
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "MenuItemPropertieslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "MenuItemPropertieslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("MenuItemPropertiesview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("MenuItemPropertiesview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "MenuItemPropertiesadd.asp?" & UrlParm(parm)
		Else
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("MenuItemPropertiesedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("MenuItemPropertiesadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("MenuItemPropertiesdelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		...
		IdMenuItem.DbValue = RsRow("IdMenuItem")
		allowtoppings.DbValue = RsRow("allowtoppings")
		dishpropertiesgroupid.DbValue = RsRow("dishpropertiesgroupid")
	...
	Sub RenderListRow()
		...
		' IdMenuItem
		IdMenuItem.ViewValue = IdMenuItem.CurrentValue
		IdMenuItem.ViewCustomAttributes = ""
		...
		' dishpropertiesgroupid
		dishpropertiesgroupid.ViewValue = dishpropertiesgroupid.CurrentValue
		dishpropertiesgroupid.ViewCustomAttributes = ""
		...
		' IdMenuItem
		IdMenuItem.LinkCustomAttributes = ""
		IdMenuItem.HrefValue = ""
		IdMenuItem.TooltipValue = ""
		...
		' dishpropertiesgroupid
		dishpropertiesgroupid.LinkCustomAttributes = ""
		dishpropertiesgroupid.HrefValue = ""
		dishpropertiesgroupid.TooltipValue = ""
	...
	Public Sub RenderEditRow()
		...
		' IdMenuItem
		IdMenuItem.EditAttrs.UpdateAttribute "class", "form-control"
		IdMenuItem.EditCustomAttributes = ""
		IdMenuItem.EditValue = IdMenuItem.CurrentValue
		IdMenuItem.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(IdMenuItem.FldCaption))
		...
		' dishpropertiesgroupid
		dishpropertiesgroupid.EditAttrs.UpdateAttribute "class", "form-control"
		dishpropertiesgroupid.EditCustomAttributes = ""
		dishpropertiesgroupid.EditValue = dishpropertiesgroupid.CurrentValue
		dishpropertiesgroupid.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(dishpropertiesgroupid.FldCaption))
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("IdMenuItem", IdMenuItem.ExportValue(Export))
					Call XmlDoc.AddField("allowtoppings", allowtoppings.ExportValue(Export))
					Call XmlDoc.AddField("dishpropertiesgroupid", dishpropertiesgroupid.ExportValue(Export))
		...
		If Not Doc.ExportCustom Then
			...
			If Doc.Horizontal Then ' Horizontal format, write header
				...
				If ExportPageType = "view" Then
					...
					If IdMenuItem.Exportable Then Call Doc.ExportCaption(IdMenuItem)
					If allowtoppings.Exportable Then Call Doc.ExportCaption(allowtoppings)
					If dishpropertiesgroupid.Exportable Then Call Doc.ExportCaption(dishpropertiesgroupid)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If Not Doc.ExportCustom Then
					...
					If ExportPageType = "view" Then
						...
						If IdMenuItem.Exportable Then Call Doc.ExportField(IdMenuItem)
						If allowtoppings.Exportable Then Call Doc.ExportField(allowtoppings)
						If dishpropertiesgroupid.Exportable Then Call Doc.ExportField(dishpropertiesgroupid)
...
'			End If
	...
	Public Property Get Id()
		If Not IsObject(m_Id) Then
			Set m_Id = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_Id", "Id", "[Id]", "CAST([Id] AS NVARCHAR)", 3, 0, "[Id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Name()
		If Not IsObject(m_Name) Then
			Set m_Name = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_Name", "Name", "[Name]", "[Name]", 202, 0, "[Name]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Name = m_Name
	End Property
	...
	Public Property Get Price()
		If Not IsObject(m_Price) Then
			Set m_Price = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_Price", "Price", "[Price]", "CAST([Price] AS NVARCHAR)", 131, 0, "[Price]", False, False, FALSE, "FORMATTED TEXT")
	...
	' Field IdMenuItem
	Private m_IdMenuItem

	Public Property Get IdMenuItem()
		If Not IsObject(m_IdMenuItem) Then
			Set m_IdMenuItem = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_IdMenuItem", "IdMenuItem", "[IdMenuItem]", "CAST([IdMenuItem] AS NVARCHAR)", 3, 0, "[IdMenuItem]", False, False, FALSE, "FORMATTED TEXT")
			m_IdMenuItem.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set IdMenuItem = m_IdMenuItem
	End Property
	...
	Public Property Get allowtoppings()
		If Not IsObject(m_allowtoppings) Then
			Set m_allowtoppings = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_allowtoppings", "allowtoppings", "[allowtoppings]", "CAST([allowtoppings] AS NVARCHAR)", 3, 0, "[allowtoppings]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_dishpropertiesgroupid

	Public Property Get dishpropertiesgroupid()
		If Not IsObject(m_dishpropertiesgroupid) Then
			Set m_dishpropertiesgroupid = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_dishpropertiesgroupid", "dishpropertiesgroupid", "[dishpropertiesgroupid]", "[dishpropertiesgroupid]", 202, 0, "[dishpropertiesgroupid]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set dishpropertiesgroupid = m_dishpropertiesgroupid
	End Property
	...
	Public Property Get printingname()
		If Not IsObject(m_printingname) Then
			Set m_printingname = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_printingname", "printingname", "[printingname]", "[printingname]", 202, 0, "[printingname]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get i_displaysort()
		If Not IsObject(m_i_displaysort) Then
			Set m_i_displaysort = NewFldObj("MenuItemProperties", "MenuItemProperties", "x_i_displaysort", "i_displaysort", "[i_displaysort]", "CAST([i_displaysort] AS NVARCHAR)", 3, 0, "[i_displaysort]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_IdMenuItem) Then Set m_IdMenuItem = Nothing
		If IsObject(m_allowtoppings) Then Set m_allowtoppings = Nothing
		If IsObject(m_dishpropertiesgroupid) Then Set m_dishpropertiesgroupid = Nothing
