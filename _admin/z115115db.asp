...
Class cz115115_db
	...
	Private Sub Class_Initialize()
		...
		ConnectionString = "Provider=SQLNCLI11;Persist Security Info=False;Data Source=23.161.0.18,1433;Initial Catalog=115115;User Id=suwen;Password=suwen321;DataTypeCompatibility=80"
		Schema = "dbo"
		StartQuote = "["
		EndQuote = "]"
		CursorLocation = 3
