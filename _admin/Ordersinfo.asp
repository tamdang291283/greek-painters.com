...
Class cOrders
	...
	Public Property Get SqlSelect()
		SqlSelect = ew_IIf(zSqlSelect & "" <> "", zSqlSelect, "SELECT * FROM [dbo].[Orders]")
	End Property
	...
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("Ordersview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("Ordersview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
	...
	Public Function AddUrl(parm)
		If parm <> "" Then
			AddUrl = "Ordersadd.asp?" & UrlParm(parm)
		Else
...
'			End If
	...
	Public Property Get ID()
		If Not IsObject(m_ID) Then
			Set m_ID = NewFldObj("Orders", "Orders", "x_ID", "ID", "[ID]", "CAST([ID] AS NVARCHAR)", 3, 0, "[ID]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get CreationDate()
		If Not IsObject(m_CreationDate) Then
			Set m_CreationDate = NewFldObj("Orders", "Orders", "x_CreationDate", "CreationDate", "[CreationDate]", "(STR(YEAR([CreationDate]),4,0) + '/' + REPLACE(STR(MONTH([CreationDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([CreationDate]),2,0),' ','0'))", 135, 9, "[CreationDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get OrderDate()
		If Not IsObject(m_OrderDate) Then
			Set m_OrderDate = NewFldObj("Orders", "Orders", "x_OrderDate", "OrderDate", "[OrderDate]", "(STR(YEAR([OrderDate]),4,0) + '/' + REPLACE(STR(MONTH([OrderDate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([OrderDate]),2,0),' ','0'))", 135, 9, "[OrderDate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryType()
		If Not IsObject(m_DeliveryType) Then
			Set m_DeliveryType = NewFldObj("Orders", "Orders", "x_DeliveryType", "DeliveryType", "[DeliveryType]", "[DeliveryType]", 202, 0, "[DeliveryType]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryTime()
		If Not IsObject(m_DeliveryTime) Then
			Set m_DeliveryTime = NewFldObj("Orders", "Orders", "x_DeliveryTime", "DeliveryTime", "[DeliveryTime]", "(STR(YEAR([DeliveryTime]),4,0) + '/' + REPLACE(STR(MONTH([DeliveryTime]),2,0),' ','0') + '/' + REPLACE(STR(DAY([DeliveryTime]),2,0),' ','0'))", 135, 9, "[DeliveryTime]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get PaymentType()
		If Not IsObject(m_PaymentType) Then
			Set m_PaymentType = NewFldObj("Orders", "Orders", "x_PaymentType", "PaymentType", "[PaymentType]", "[PaymentType]", 202, 0, "[PaymentType]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get SubTotal()
		If Not IsObject(m_SubTotal) Then
			Set m_SubTotal = NewFldObj("Orders", "Orders", "x_SubTotal", "SubTotal", "[SubTotal]", "CAST([SubTotal] AS NVARCHAR)", 6, 0, "[SubTotal]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get ShippingFee()
		If Not IsObject(m_ShippingFee) Then
			Set m_ShippingFee = NewFldObj("Orders", "Orders", "x_ShippingFee", "ShippingFee", "[ShippingFee]", "CAST([ShippingFee] AS NVARCHAR)", 6, 0, "[ShippingFee]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get OrderTotal()
		If Not IsObject(m_OrderTotal) Then
			Set m_OrderTotal = NewFldObj("Orders", "Orders", "x_OrderTotal", "OrderTotal", "[OrderTotal]", "CAST([OrderTotal] AS NVARCHAR)", 6, 0, "[OrderTotal]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get IdBusinessDetail()
		If Not IsObject(m_IdBusinessDetail) Then
			Set m_IdBusinessDetail = NewFldObj("Orders", "Orders", "x_IdBusinessDetail", "IdBusinessDetail", "[IdBusinessDetail]", "CAST([IdBusinessDetail] AS NVARCHAR)", 3, 0, "[IdBusinessDetail]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get SessionId()
		If Not IsObject(m_SessionId) Then
			Set m_SessionId = NewFldObj("Orders", "Orders", "x_SessionId", "SessionId", "[SessionId]", "[SessionId]", 202, 0, "[SessionId]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get FirstName()
		If Not IsObject(m_FirstName) Then
			Set m_FirstName = NewFldObj("Orders", "Orders", "x_FirstName", "FirstName", "[FirstName]", "[FirstName]", 202, 0, "[FirstName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get LastName()
		If Not IsObject(m_LastName) Then
			Set m_LastName = NewFldObj("Orders", "Orders", "x_LastName", "LastName", "[LastName]", "[LastName]", 202, 0, "[LastName]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get zEmail()
		If Not IsObject(m_zEmail) Then
			Set m_zEmail = NewFldObj("Orders", "Orders", "x_zEmail", "Email", "[Email]", "[Email]", 202, 0, "[Email]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set zEmail = m_zEmail
	End Property
	...
	Public Property Get Phone()
		If Not IsObject(m_Phone) Then
			Set m_Phone = NewFldObj("Orders", "Orders", "x_Phone", "Phone", "[Phone]", "[Phone]", 202, 0, "[Phone]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Phone = m_Phone
	End Property
	...
	Public Property Get Address()
		If Not IsObject(m_Address) Then
			Set m_Address = NewFldObj("Orders", "Orders", "x_Address", "Address", "[Address]", "[Address]", 202, 0, "[Address]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get PostalCode()
		If Not IsObject(m_PostalCode) Then
			Set m_PostalCode = NewFldObj("Orders", "Orders", "x_PostalCode", "PostalCode", "[PostalCode]", "[PostalCode]", 202, 0, "[PostalCode]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Notes()
		If Not IsObject(m_Notes) Then
			Set m_Notes = NewFldObj("Orders", "Orders", "x_Notes", "Notes", "[Notes]", "[Notes]", 203, 0, "[Notes]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set Notes = m_Notes
	End Property
	...
	Public Property Get ttest()
		If Not IsObject(m_ttest) Then
			Set m_ttest = NewFldObj("Orders", "Orders", "x_ttest", "ttest", "[ttest]", "[ttest]", 202, 0, "[ttest]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set ttest = m_ttest
	End Property
	...
	Public Property Get cancelleddate()
		If Not IsObject(m_cancelleddate) Then
			Set m_cancelleddate = NewFldObj("Orders", "Orders", "x_cancelleddate", "cancelleddate", "[cancelleddate]", "(STR(YEAR([cancelleddate]),4,0) + '/' + REPLACE(STR(MONTH([cancelleddate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([cancelleddate]),2,0),' ','0'))", 135, 9, "[cancelleddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelledby()
		If Not IsObject(m_cancelledby) Then
			Set m_cancelledby = NewFldObj("Orders", "Orders", "x_cancelledby", "cancelledby", "[cancelledby]", "[cancelledby]", 202, 0, "[cancelledby]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelledreason()
		If Not IsObject(m_cancelledreason) Then
			Set m_cancelledreason = NewFldObj("Orders", "Orders", "x_cancelledreason", "cancelledreason", "[cancelledreason]", "[cancelledreason]", 202, 0, "[cancelledreason]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get acknowledgeddate()
		If Not IsObject(m_acknowledgeddate) Then
			Set m_acknowledgeddate = NewFldObj("Orders", "Orders", "x_acknowledgeddate", "acknowledgeddate", "[acknowledgeddate]", "(STR(YEAR([acknowledgeddate]),4,0) + '/' + REPLACE(STR(MONTH([acknowledgeddate]),2,0),' ','0') + '/' + REPLACE(STR(DAY([acknowledgeddate]),2,0),' ','0'))", 135, 9, "[acknowledgeddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get delivereddate()
		If Not IsObject(m_delivereddate) Then
			Set m_delivereddate = NewFldObj("Orders", "Orders", "x_delivereddate", "delivereddate", "[delivereddate]", "[delivereddate]", 202, 0, "[delivereddate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get cancelled()
		If Not IsObject(m_cancelled) Then
			Set m_cancelled = NewFldObj("Orders", "Orders", "x_cancelled", "cancelled", "[cancelled]", "CAST([cancelled] AS NVARCHAR)", 3, 0, "[cancelled]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get acknowledged()
		If Not IsObject(m_acknowledged) Then
			Set m_acknowledged = NewFldObj("Orders", "Orders", "x_acknowledged", "acknowledged", "[acknowledged]", "CAST([acknowledged] AS NVARCHAR)", 3, 0, "[acknowledged]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get outfordelivery()
		If Not IsObject(m_outfordelivery) Then
			Set m_outfordelivery = NewFldObj("Orders", "Orders", "x_outfordelivery", "outfordelivery", "[outfordelivery]", "CAST([outfordelivery] AS NVARCHAR)", 3, 0, "[outfordelivery]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vouchercodediscount()
		If Not IsObject(m_vouchercodediscount) Then
			Set m_vouchercodediscount = NewFldObj("Orders", "Orders", "x_vouchercodediscount", "vouchercodediscount", "[vouchercodediscount]", "CAST([vouchercodediscount] AS NVARCHAR)", 3, 0, "[vouchercodediscount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vouchercode()
		If Not IsObject(m_vouchercode) Then
			Set m_vouchercode = NewFldObj("Orders", "Orders", "x_vouchercode", "vouchercode", "[vouchercode]", "[vouchercode]", 202, 0, "[vouchercode]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get printed()
		If Not IsObject(m_printed) Then
			Set m_printed = NewFldObj("Orders", "Orders", "x_printed", "printed", "[printed]", "CAST([printed] AS NVARCHAR)", 3, 0, "[printed]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get deliverydistance()
		If Not IsObject(m_deliverydistance) Then
			Set m_deliverydistance = NewFldObj("Orders", "Orders", "x_deliverydistance", "deliverydistance", "[deliverydistance]", "[deliverydistance]", 202, 0, "[deliverydistance]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get asaporder()
		If Not IsObject(m_asaporder) Then
			Set m_asaporder = NewFldObj("Orders", "Orders", "x_asaporder", "asaporder", "[asaporder]", "[asaporder]", 202, 0, "[asaporder]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryLat()
		If Not IsObject(m_DeliveryLat) Then
			Set m_DeliveryLat = NewFldObj("Orders", "Orders", "x_DeliveryLat", "DeliveryLat", "[DeliveryLat]", "[DeliveryLat]", 202, 0, "[DeliveryLat]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get DeliveryLng()
		If Not IsObject(m_DeliveryLng) Then
			Set m_DeliveryLng = NewFldObj("Orders", "Orders", "x_DeliveryLng", "DeliveryLng", "[DeliveryLng]", "[DeliveryLng]", 202, 0, "[DeliveryLng]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get ServiceCharge()
		If Not IsObject(m_ServiceCharge) Then
			Set m_ServiceCharge = NewFldObj("Orders", "Orders", "x_ServiceCharge", "ServiceCharge", "[ServiceCharge]", "CAST([ServiceCharge] AS NVARCHAR)", 6, 0, "[ServiceCharge]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get PaymentSurcharge()
		If Not IsObject(m_PaymentSurcharge) Then
			Set m_PaymentSurcharge = NewFldObj("Orders", "Orders", "x_PaymentSurcharge", "PaymentSurcharge", "[PaymentSurcharge]", "CAST([PaymentSurcharge] AS NVARCHAR)", 6, 0, "[PaymentSurcharge]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get FromIP()
		If Not IsObject(m_FromIP) Then
			Set m_FromIP = NewFldObj("Orders", "Orders", "x_FromIP", "FromIP", "[FromIP]", "[FromIP]", 202, 0, "[FromIP]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set FromIP = m_FromIP
	End Property
	...
	Public Property Get SentEmail()
		If Not IsObject(m_SentEmail) Then
			Set m_SentEmail = NewFldObj("Orders", "Orders", "x_SentEmail", "SentEmail", "[SentEmail]", "[SentEmail]", 202, 0, "[SentEmail]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Tax_Rate()
		If Not IsObject(m_Tax_Rate) Then
			Set m_Tax_Rate = NewFldObj("Orders", "Orders", "x_Tax_Rate", "Tax_Rate", "[Tax_Rate]", "CAST([Tax_Rate] AS NVARCHAR)", 3, 0, "[Tax_Rate]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tax_Amount()
		If Not IsObject(m_Tax_Amount) Then
			Set m_Tax_Amount = NewFldObj("Orders", "Orders", "x_Tax_Amount", "Tax_Amount", "[Tax_Amount]", "CAST([Tax_Amount] AS NVARCHAR)", 6, 0, "[Tax_Amount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Tip_Rate()
		If Not IsObject(m_Tip_Rate) Then
			Set m_Tip_Rate = NewFldObj("Orders", "Orders", "x_Tip_Rate", "Tip_Rate", "[Tip_Rate]", "[Tip_Rate]", 202, 0, "[Tip_Rate]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Tip_Amount()
		If Not IsObject(m_Tip_Amount) Then
			Set m_Tip_Amount = NewFldObj("Orders", "Orders", "x_Tip_Amount", "Tip_Amount", "[Tip_Amount]", "CAST([Tip_Amount] AS NVARCHAR)", 6, 0, "[Tip_Amount]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Card_Debit()
		If Not IsObject(m_Card_Debit) Then
			Set m_Card_Debit = NewFldObj("Orders", "Orders", "x_Card_Debit", "Card_Debit", "[Card_Debit]", "CAST([Card_Debit] AS NVARCHAR)", 3, 0, "[Card_Debit]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get Card_Credit()
		If Not IsObject(m_Card_Credit) Then
			Set m_Card_Credit = NewFldObj("Orders", "Orders", "x_Card_Credit", "Card_Credit", "[Card_Credit]", "CAST([Card_Credit] AS NVARCHAR)", 3, 0, "[Card_Credit]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get deliverydelay()
		If Not IsObject(m_deliverydelay) Then
			Set m_deliverydelay = NewFldObj("Orders", "Orders", "x_deliverydelay", "deliverydelay", "[deliverydelay]", "CAST([deliverydelay] AS NVARCHAR)", 3, 0, "[deliverydelay]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get collectiondelay()
		If Not IsObject(m_collectiondelay) Then
			Set m_collectiondelay = NewFldObj("Orders", "Orders", "x_collectiondelay", "collectiondelay", "[collectiondelay]", "CAST([collectiondelay] AS NVARCHAR)", 3, 0, "[collectiondelay]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get lng_report()
		If Not IsObject(m_lng_report) Then
			Set m_lng_report = NewFldObj("Orders", "Orders", "x_lng_report", "lng_report", "[lng_report]", "[lng_report]", 202, 0, "[lng_report]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get lat_report()
		If Not IsObject(m_lat_report) Then
			Set m_lat_report = NewFldObj("Orders", "Orders", "x_lat_report", "lat_report", "[lat_report]", "[lat_report]", 202, 0, "[lat_report]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get Payment_status()
		If Not IsObject(m_Payment_status) Then
			Set m_Payment_status = NewFldObj("Orders", "Orders", "x_Payment_status", "Payment_status", "[Payment_status]", "[Payment_status]", 202, 0, "[Payment_status]", False, False, FALSE, "FORMATTED TEXT")
		End If
