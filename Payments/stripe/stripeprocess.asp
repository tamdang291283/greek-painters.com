...
End Function
   ...
   ' objCon.Close
        ...
        WriteLog server.MapPath("Stripe-process.txt"),"Start stripeprocess.asp  OrderID =  " & OrderID & " " & result   
      if instr(result ,"""status"": ""succeeded""") > 0 then
           ...
           ' objCon.Open sConnString
            ...
            objRds.Open "SELECT * FROM [Orders] WHERE Id = " & OrderID, objCon, 1, 3 
